(function () {
  ...
  registerCharacters([work.character({
    ...
    sourceQuality: "entry",
    dimensions: dims({
      attack: ["楼宇级", "街区级｜投影宝具/UBW｜争议", "投影宝具与Broken Phantasm可高爆发，固有结界是条件峰值。"],
      defense: ["房屋级", "楼宇级｜投影防御/从者灵基", "从者灵基和投影防具支撑承伤。"],
      movement: ["音速", "超音速｜从者近战", "高速白刃与远程转换。"],
      reaction: ["音速", "超音速｜心眼/经验", "战斗经验和心眼支撑高速反应。"],
      vitality: ["楼宇级生命阈值", "楼宇级生命阈值｜从者灵基", "灵基承伤强但供魔和核心伤害仍关键。"],
      healing: ["中速自愈｜灵体/供魔", "快速自愈｜供魔充足", "恢复依赖供魔与灵基伤势。"],
      energy: ["楼宇级能量", "街区级能量｜UBW/投影储备｜争议", "资源来自魔力、投影知识和固有结界。"],
