(function () {
  ...
  registerCharacters([work.character({
    ...
    sourceQuality: "entry",
    dimensions: dims({
      attack: ["凡人级", "楼宇级｜投影/九命刃具｜路线峰值", "常态接近训练者，峰值依赖投影、Archer臂或路线条件。"],
      defense: ["凡人级", "墙体级｜强化/投影防御", "本体脆弱，靠强化、投影和从者支援周旋。"],
      ...
      energy: ["砖块级能量", "楼宇级能量｜投影/固有结界｜路线峰值", "魔术回路和投影资源有限，路线峰值差异大。"],
      energyRegen: ["缓慢回能", "中速回能｜外部供魔/路线条件", "需要休整、供魔或路线条件维持。"]
    }),
    notes: notes({
      penetration: "投影可复制武装性质和技巧，峰值偏单体穿透，不等同稳定大范围爆破。攻击速度：士郎要先完成投影，形成的刀剑随本人近战挥击，弓射或投出的投影武器离手后再按各自弹道判断。",
