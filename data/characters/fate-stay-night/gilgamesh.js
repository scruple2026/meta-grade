(function () {
  ...
  registerCharacters([work.character({
    ...
    sourceQuality: "entry",
    dimensions: dims({
      attack: ["楼宇级", "街区级｜王之财宝/Ea｜争议", "王之财宝可持续压制，Ea作为高风险条件峰值保守记录。"],
      defense: ["房屋级", "楼宇级｜宝具防护/黄金甲", "防御依赖宝具、距离和主动压制。"],
      movement: ["音速", "超音速｜从者机动/飞行宝具", "可用宝具和从者能力高速机动。"],
      reaction: ["音速", "超音速｜从者战/慢心波动", "基础反应很高，但慢心会显著影响发挥。"],
      vitality: ["楼宇级生命阈值", "楼宇级生命阈值｜从者灵基", "灵基承伤强但并非难杀型。"],
    ...
    notes: notes({
      penetration: "王之财宝以多宝具投射、属性克制和压制为主，Ea高风险峰值需单独标注。攻击速度：吉尔伽美什先开启王之财宝并选择射出宝具，宝具离门后各自飞行；齐射频率取决于门的展开与发射节奏，Ea另算。",
