(function () {
  ...
  registerCharacters([work.character({
    ...
    sourceQuality: "entry",
    dimensions: dims({
      attack: ["凡人级", "砖块级｜伪臣之书/道具", "本体战力低，威胁依赖Rider和道具。"],
      defense: ["凡人级", "凡人级", "本体防护低。"],
      movement: ["凡人速", "凡人速", "普通人速度。"],
      reaction: ["凡人速", "凡人速", "战斗反应低。"],
      vitality: ["凡人肉身", "凡人肉身", "普通人体。"],
      healing: ["无自愈", "无自愈", "没有自愈能力。"],
      energy: ["不适用｜无稳定魔术回路", "砖块级能量｜伪臣之书", "魔术资源主要来自外部系统。"],
      energyRegen: ["不适用", "缓慢回能｜外部供给", "依赖外部资源。"]
    }),
    notes: notes({
      penetration: "自身攻击低，主要依赖Rider、伪臣之书和场地陷阱。攻击速度：慎二本体缺少稳定战斗招式，临时工具按普通人的取用和挥动处理；伪臣之书用于控制Rider，Rider与场地陷阱的行动不属于慎二本人出手。",
