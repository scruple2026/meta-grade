(function () {
  ...
  registerCharacters([work.character({
    ...
    sourceQuality: "entry",
    dimensions: dims({
      attack: ["楼级", "街区级｜Excalibur/黑化峰值｜争议", "常规白刃战极强，宝具真名解放作为条件峰值。"],
      defense: ["楼级", "街区级｜魔力放出/黑化", "铠甲、对魔力和魔力放出提高承伤。"],
      movement: ["音速", "超音速｜魔力放出", "高速从者近战机动。"],
      reaction: ["音速", "超音速｜直感/从者战", "直感和剑术支撑高速应对。"],
      vitality: ["楼级生命阈值", "街区级生命阈值｜黑化/供魔", "从者灵基和供魔状态影响续战。"],
      healing: ["中速自愈｜灵体/供魔", "快速自愈｜供魔充足/黑化", "恢复依赖灵基、供魔和伤势性质。"],
      energy: ["楼级能量", "街区级能量｜圣剑/黑化供魔", "魔力与宝具资源强但非无限。"],
