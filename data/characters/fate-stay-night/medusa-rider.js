(function () {
  ...
  registerCharacters([work.character({
    ...
    sourceQuality: "entry",
    dimensions: dims({
      attack: ["楼宇级", "街区级｜Bellerophon｜争议", "锁链短剑与骑乘宝具可高爆发。"],
      defense: ["房屋级", "楼宇级｜从者灵基/骑乘", "灵基和机动提供防护。"],
      movement: ["音速", "超音速｜骑乘/天马", "骑乘宝具带来高速机动。"],
      reaction: ["音速", "超音速｜从者近战", "高速近战和机动反应。"],
      vitality: ["楼宇级生命阈值", "楼宇级生命阈值｜供魔充足", "供魔状态对实力影响大。"],
      healing: ["中速自愈｜灵体/供魔", "快速自愈｜供魔充足", "恢复依赖供魔。"],
      energy: ["楼宇级能量", "街区级能量｜Bellerophon/魔眼｜争议", "魔眼和骑乘宝具资源强。"],
