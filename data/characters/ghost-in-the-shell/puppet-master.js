(function () {
  ...
  registerCharacters([
    work.character({
      ...
      sourceQuality: "entry",
      dimensions: dims({
        attack: ["不适用｜网络黑客", "墙体级｜义体/操控间接杀伤｜条件", "傀儡师核心威胁是电子脑黑客和操控，不是自身拳脚输出。"],
        defense: ["不适用｜网络存在", "砖块级｜义体壳体", "物理壳体脆弱，网络存在方式与物理防御分开。"],
        ...
        energy: ["未知｜网络资源", "砖块级能量｜义体壳体/网络资源", "战斗资源主要是网络访问和被操控对象。"],
        energyRegen: ["未知", "未知｜网络资源", "缺少可量化回能资料。"]
      }),
      notes: notes({
        penetration: "通过电子脑黑客、记忆篡改、身份伪造和操控对象造成间接威胁。攻击速度：傀儡师的电子脑入侵需要建立网络接触并完成黑客操作，记忆篡改和对象操控是入侵后的效果；资料没有给出可换算为物理弹速的传播过程。",
