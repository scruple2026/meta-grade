(function () {
  ...
  registerCharacters([
    work.character({
      ...
      sourceQuality: "entry",
      dimensions: dims({
        attack: ["砖块级", "墙体级｜军用武器/义体力量", "常规输出来自枪械、爆破、义体力量和战术装备。"],
        defense: ["砖块级", "墙体级｜全身义体", "全身义体强于普通人，但仍可被重武器撕裂。"],
        ...
        energy: ["砖块级能量｜武器/义体", "墙体级能量｜九课装备", "总资源来自义体电源、枪械、装备和九课支援。"],
        energyRegen: ["缓慢回能｜维护", "缓慢回能｜补给/维修", "需要弹药、维护和义体维修。"]
      }),
      notes: notes({
        penetration: "枪械、爆破、义体力量、热光学迷彩潜入和电子脑黑客结合形成杀伤。攻击速度：草薙素子的枪击须瞄准和扣发，弹丸离膛后独立飞行；义体近战按肢体动作，爆破按引信，黑客入侵则按网络接触分别判断。",
