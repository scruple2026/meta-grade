(function () {
  ...
  registerCharacters([work.character({
    ...
    dimensions: dims({
        attack: ["砖块级｜双枪/弓箭", "墙体级｜爆炸物/重武器/机关遗物｜装备", "常态依赖枪械、弓箭和近战工具；峰值为任务装备或环境机关。"],
        defense: ["凡人级", "砖块级｜防具/规避/掩体", "本体为训练人类，生还主要靠规避、掩体和医疗资源。"],
        ...
        energy: ["凡人能量", "墙体级能量｜弹药/爆炸物/任务装备", "资源来自体力、弹药、爆炸物和工具，不等同本体能量池。"],
        energyRegen: ["无回能", "缓慢回能｜补给/换弹/休息", "依赖搜刮、补给、换弹和休息。"]
      }),
    notes: notes({
        penetration: "双枪、弓箭、爆炸物、绳索工具和环境机关能提供高于徒手的杀伤或破障能力。攻击速度：近身工具按挥用动作判断，枪弹和箭矢离手后各自飞行，爆炸物与环境机关还受布置、触发和引爆时机限制。",
