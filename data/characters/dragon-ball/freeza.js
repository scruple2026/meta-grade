(function () {
  ...
  registerCharacters([
    work.character({
      ...
      notes: notes({
        penetration: "死亡光束以细小高速气束贯穿要害，死亡球和行星破坏技提供明确行星级大范围输出；形态释放是战斗力解放，不等于特殊规则即死。攻击速度：指尖光束、气弹和能量波均是独立远程载体，近战则随弗利萨本体动作；大型能量球还有聚能与投放窗口。",
        resistance: "弗利萨能在太空、重伤和行星毁灭余波中存活，生命力极强；残躯生还不是高速再生，面对超赛级持续压制、气耗尽或被切碎后缺少外部修复会失去战斗力。",
        sensing: "依赖宇宙帝王级战斗经验、气感知和能量读数判断敌我强弱；傲慢会让他低估成长型对手。",
        tactics: "擅长分阶段释放力量、远程穿刺和行星威慑；情绪失控和体力下滑会让决策越来越直接。",
