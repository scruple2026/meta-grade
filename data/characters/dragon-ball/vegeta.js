(function () {
  ...
  registerCharacters([
    work.character({
      ...
      notes: notes({
        penetration: "伽力克炮、最终闪光、连续能量弹和魔人贝吉塔自爆提供高密度气功穿透与范围爆发；自爆是一次性牺牲峰值，不作为可反复使用的普通攻击。攻击速度：近战、连续气弹和蓄力炮各有不同节奏，最终闪光需聚能，自爆需决意与释放窗口，不能取最快动作代表全部。",
        resistance: "赛亚人体质、超赛形态和气防御提供高承伤，战斗意志极强；没有再生，精神控制、气耗尽、被吸收/封印和强制近身消耗会绕过单纯硬度优势。",
        sensing: "赛亚人气感知和高端战斗经验支持远距定位与能量判断；愤怒和自尊会影响情报使用。",
        tactics: "战斗分析和进攻路线强，擅长用气弹压制、变身和爆发打正面对决；自尊导致的硬拼会放大战术风险。",
