(function () {
  ...
  registerCharacters([
    work.character({
      ...
      notes: notes({
        penetration: "沙鲁可使用龟派气功、吸收、尾针、生物细胞复制能力和超级完全体气功，太阳系破坏宣称只作为争议峰值；吸收进化是成长/夺能机制，不等同每击高范围输出。攻击速度：近战连击随沙鲁本体接战，气弹与能量束离手后独立飞行；太阳拳等辅助技和蓄力终结技不能共用同一攻击速度。",
        resistance: "核心再生、那美克星细胞和赛亚人濒死强化让沙鲁难以通过普通肢体破坏杀死；核心被毁、完全湮灭、被更高气功压制或被迫自爆失败仍会终结他。",
        sensing: "赛亚人、那美克星与人造人细胞带来气感知、战斗经验和吸收目标判断；核心再生不提供额外索敌。",
        tactics: "学习能力和能力复用强，能用吸收进化、再生和复制招式制造优势；自负和游戏心态会放过关键结束窗口。",
