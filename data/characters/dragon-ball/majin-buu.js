  ...
  registerCharacters([
    work.character({
      ...
      notes: notes({
        ...
        resistance: "魔人身体可从粉碎、液化和碎片状态高速重组，常规打穿或撕裂很难终结；彻底湮灭、封印、精神分裂/净化、吸收反制和能量耗尽仍能成为处理手段。",
        sensing: "魔人体质和气感知支持高端战斗定位，不同形态的智性和感知稳定性差异很大。",
        tactics: "能力组合丰富，吸收、糖果光线和再生能制造非常规胜利条件；形态性格差异导致战术从狡猾到本能化不等。",
        special: "魔人再生、吸收、糖果光线、气功、形态变化。",
        weakness: "多形态性格和战术稳定性差异巨大；糖果光线、吸收和再生都可被强能量、封印或更高层级压制反制，胖布欧/恶布欧/纯粹布欧不应混成一个无条件最强状态。",
