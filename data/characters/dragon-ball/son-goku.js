(function () {
  ...
  registerCharacters([
    work.character({
      ...
      timelinePanels: [
        {
          ...
          dimensions: dims({
            ...
            healing: ["无自愈", "中速自愈｜仙豆/外部", "自身无稳定再生。"],
        ...
        },
        {
          ...
          dimensions: dims({
            ...
            healing: ["无自愈", "中速自愈｜仙豆/外部", "自身无稳定再生，常靠仙豆和治疗。"],
      ...
      notes: notes({
        penetration: "龟派气功、界王拳爆发、超赛形态和超赛3气功主打高密度能量束、近战气压制与终结型爆发；元气弹含外部募集能量，瞬间移动只改变位置和先手角度，不抬主破坏档。攻击速度：拳脚随悟空近身交锋，龟派气功离手后独立传播，元气弹还需长时间募集与蓄力；瞬间移动只改变起攻位置。",
