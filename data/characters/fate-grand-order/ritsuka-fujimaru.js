(function () {
  ...
  registerCharacters([
    work.character({
      ...
      dimensions: dims({
        attack: ["凡人级", "砖块级｜礼装/令咒支援", "本体不是正面输出者，峰值来自魔术礼装、令咒和从者指挥支援。"],
        defense: ["凡人级", "砖块级｜礼装/防护支援", "本体仍是人类御主，防护依赖礼装和从者。"],
        ...
        energy: ["凡人能量", "砖块级能量｜礼装/令咒资源", "个人魔力和礼装资源有限，真正战力来自召唤契约。"],
        energyRegen: ["中速回能", "中速回能｜休整/迦勒底支援", "按人类御主和迦勒底支援恢复。"]
      }),
      notes: notes({
        penetration: "自身攻击能力很低，主要通过令咒、魔术礼装和从者指挥制造战术效果。攻击速度：藤丸立香本体至多使用礼装进行有限施术，从者攻击要经过指挥或契约响应，不能记成本人的拳脚或弹体速度。",
