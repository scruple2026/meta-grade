(function () {
  ...
  registerCharacters([
    work.character({
      ...
      dimensions: dims({
        attack: ["楼级", "街区级｜盾击/灵基强化", "以盾击和近战支援为主，攻击不是主要强项。"],
        defense: ["楼级", "街区级｜防御宝具/盾", "Shielder灵基和宝具偏高防御与队友保护。"],
        movement: ["音速", "超音速｜从者机动", "具备从者级近战机动。"],
        reaction: ["音速", "超音速｜防御反应", "擅长用盾应对高速攻击与保护御主。"],
        vitality: ["楼级生命阈值", "街区级生命阈值｜亚从者灵基", "亚从者灵基显著高于普通人。"],
        healing: ["中速自愈｜灵基/医疗支援", "快速自愈｜迦勒底支援", "恢复依赖灵基、御主和迦勒底支援。"],
        energy: ["楼级能量", "街区级能量｜防御宝具", "魔力主要服务于防御宝具和护卫。"],
        energyRegen: ["中速回能", "快速回能｜御主/迦勒底支援", "供魔和迦勒底支援影响续航。"]
      }),
      notes: notes({
        penetration: "盾击和近战可压制普通敌人，但核心价值是防御与保护，不按大范围输出抬档。",
