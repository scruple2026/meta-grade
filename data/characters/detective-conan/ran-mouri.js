(function () {
  ...
  registerCharacters([work.character({
    ...
    dimensions: dims({
        attack: ["砖级｜空手道", "墙级｜空手道爆发/破物｜武术", "空手道打击显著强于普通人，但按近战破物保守记录。"],
        defense: ["凡人级", "砖级｜格斗防护/规避", "肉身仍是人类，防御主要来自格斗架势和闪避。"],
        ...
        energy: ["凡人能量", "砖级能量｜体力/格斗爆发", "资源来自体力和格斗爆发。"],
        energyRegen: ["无回能", "缓慢回能｜休息/补给", "依赖休息恢复。"]
      }),
    notes: notes({
        penetration: "空手道踢击和拳击对普通人、门板、器物等有高效近战杀伤。",
