(function () {
  ...
  registerCharacters([work.character({
    ...
    dimensions: dims({
        attack: ["凡人级", "砖块级｜柔道/配枪｜训练/装备", "常态普通成年人；峰值来自柔道、警察训练和枪械。"],
        ...
        energy: ["凡人能量", "砖块级能量｜配枪/体力", "资源来自体力、枪械和现场工具。"],
        energyRegen: ["无回能", "缓慢回能｜补给/休息", "依赖休息和补给。"]
      }),
    notes: notes({
        penetration: "柔道、拳脚和条件性的枪械射击表现可制伏普通犯人，枪械仅作为装备峰值。攻击速度：柔道与拳脚是受训成人的近战动作；使用枪械时，子弹离膛后明显快于毛利小五郎奔跑，实际射击仍受取枪与瞄准影响。",
