(function () {
  ...
  registerCharacters([
    work.character({
      ...
      timelinePanels: [
        ...
        },
        {
          ...
          dimensions: dims({
            ...
            movement: ["超星系团尺度超光速｜剧场版最终战｜争议", "可观测宇宙尺度超光速｜超螺旋宇宙｜争议", "覆盖超星系团到可观测宇宙尺度有限速度；异空间/演出性质很强，不写无限速。"],
            reaction: ["超星系团尺度超光速｜剧场版最终战｜争议", "可观测宇宙尺度超光速｜团队同步响应｜争议", "最终战响应跟随机体与团队同步，不把意志演出或空间设定升为无限反应。"],
      ...
      notes: notes({
        penetration: "螺旋力钻击、机体格斗和最终战能量投射以超大尺度穿透/对撞为主；星系级与超星系团级是有限覆盖样例，不等于无限杀伤。攻击速度：机体格斗和钻击依赖巨型机体接战，能量投射另有锁定与跨尺度传播；最终对撞画面不能自动换算弹速。",
