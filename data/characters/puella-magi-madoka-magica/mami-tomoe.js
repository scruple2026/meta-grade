(function () {
  ...
  registerCharacters([
    work.character({
      ...
      sourceQuality: "entry",
      dimensions: dims({
        attack: ["墙体级", "楼宇级｜火枪/终曲", "魔法火枪和Tiro Finale具高单体与区域压制。"],
        defense: ["墙体级", "楼宇级｜缎带/魔法防御", "缎带束缚和魔法防御支撑承伤。"],
        movement: ["亚音速", "亚音速", "魔法少女机动。"],
        reaction: ["亚音速", "亚音速｜经验", "资深魔法少女经验强。"],
        vitality: ["强化凡体", "精锐韧体｜灵魂宝石", "生命依赖灵魂宝石。"],
        healing: ["中速自愈｜魔力修复", "快速自愈｜魔力修复", "受魔力与污浊限制。"],
        energy: ["墙体级能量", "楼宇级能量｜火枪/缎带", "魔力支持大量武器生成。"],
        energyRegen: ["快速回能", "快速回能｜悲叹之种/休整", "需净化灵魂宝石。"]
      }),
      notes: notes({
        penetration: "火枪齐射、缎带束缚和Tiro Finale适合先控后杀。攻击速度：火枪齐射要区分召枪、瞄准与弹体飞行，缎带另有展开过程，Tiro Finale也不沿用普通连射节奏。",
