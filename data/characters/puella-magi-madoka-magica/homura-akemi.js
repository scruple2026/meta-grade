(function () {
  ...
  registerCharacters([
    work.character({
      ...
      dimensions: dims({
        attack: ["砖级", "楼级｜枪械/炸药/储备武器", "主要靠现代武器、爆炸物和时间停止创造命中窗口。"],
        defense: ["凡人级", "墙级｜盾/时间停止规避", "防御更多来自时间停止和规避，本体不硬。"],
        ...
        energy: ["墙级能量", "楼级能量｜武器储备/魔力", "魔力与武器储备支撑长期循环作战。"],
        energyRegen: ["快速回能", "快速回能｜悲叹之种/休整", "需净化灵魂宝石和补给武器。"]
      }),
      notes: notes({
        penetration: "攻击依赖枪械、炸药、火箭筒等现代武器与时间停止命中窗口，时间停止本身不等同破坏力。",
