  ...
  registerCharacters([
    work.character({
      ...
      dimensions: dims({
        ...
        energyRegen: ["中速回能", "快速回能｜精神恢复", "高强度持续输出后需要恢复。"]
      }),
      notes: notes({
        penetration: "念动力可远程扭曲、压缩、撕裂、抬升和投掷大范围地形，对护盾内目标也能施加强控；输出来自精神力和操控范围，不是传统拳脚破坏。攻击速度：念动力扭曲或压缩主要看精神发动与控制建立，抬升后投掷的地形另有飞行时间，不能拿本体位移速度替代。",
        resistance: "念动力屏障远强于本体肉身，可挡下大范围攻击并同时保护多目标；本体没有再生，精神负荷、重伤、分心保护人质和屏障被持续压制都会降低防御。",
        sensing: "念动力感知和大范围精神操作让她可同时追踪多目标与保护对象；精神干扰和多线保护会分散注意力。",
        tactics: "大范围控场和屏障调度极强，能用念动力隔离、挤压和牵制战场；保护多人或本体被偷袭时战术负荷升高。",
