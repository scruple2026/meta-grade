(function () {
  ...
  registerCharacters([
    work.character({
      ...
      notes: notes({
        penetration: "普通拳、连续普通拳和严肃拳都以纯肉体冲击为主，严肃拳系列在可见战斗中展现压倒性破坏与冲击扩散；埼玉的未见上限只写下限，不把搞笑定位换算为无限或自动胜利。攻击速度：普通拳、连续普通拳和严肃拳先看肢体出手与接战距离，拳风或冲击扩散是出拳后的载体效果。",
        resistance: "埼玉主要表现为极高肉体承伤、真空/宇宙环境适应和近乎无伤硬吃强敌攻击；他不是靠再生，精神/规则/封印类能力没有足够样本，不能默认全免疫。",
        sensing: "主要依赖异常肉体五感和近战直觉，能跟上高速强敌但缺少严谨索敌设定；搞笑语境下的察觉不能统一换算。",
        tactics: "通常以简单直接的身体压制解决战斗，复杂战术需求很低；认真程度和缺少可验证上限使精细策略评价有限。",
