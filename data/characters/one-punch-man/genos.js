(function () {
  ...
  registerCharacters([
    work.character({
      ...
      timelinePanels: [
        {
          ...
          status: "初期焚烧炮与推进器",
          dimensions: dims({
            attack: ["楼宇级", "街区级｜焚烧炮", "早期焚烧炮已有大范围火力。"],
            defense: ["楼宇级", "街区级｜改造体", "机体承伤高于常人但常被强敌破坏。"],
            movement: ["超音速", "超音速｜推进器", "推进器提供高速短距机动。"],
            reaction: ["超音速", "超音速｜传感器", "传感器辅助反应。"],
            vitality: ["楼宇级生命阈值", "楼宇级生命阈值｜改造体", "核心部件未毁可继续行动。"],
            healing: ["无自愈", "中速自愈｜维修", "依赖外部维修。"],
            energy: ["楼宇级能量", "街区级能量｜焚烧炮", "火力受机体能源限制。"],
        ...
        },
        {
          ...
          dimensions: dims({
            ...
            vitality: ["楼宇级生命阈值", "街区级生命阈值｜改造体", "只要核心部件未毁可继续行动或修复。"],
      ...
      notes: notes({
        penetration: "焚烧炮、螺旋焚烧炮、推进近战和十秒模式提供高热、爆破、穿甲与短时过载火力；十秒模式是装备峰值，不等于长期稳定输出。攻击速度：推进拳脚取决于机体突进与机械出手，焚烧炮另看锁定、发射和能量投射；十秒模式不等于所有炮击无前摇。",
