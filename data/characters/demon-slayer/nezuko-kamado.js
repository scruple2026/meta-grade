      ...
      timelinePanels: [
        {
          ...
          status: "睡眠恢复与基础鬼体",
          dimensions: dims({
            attack: ["墙级", "墙级｜鬼体", "体术强于常人和普通鬼，但血鬼术尚未稳定突出。"],
            defense: ["墙级", "房屋级｜鬼体", "鬼体可承受和修复重伤。"],
        ...
        },
        {
          ...
          status: "爆血与成年化鬼化",
          dimensions: dims({
            attack: ["墙级", "房屋级｜爆血｜鬼化", "爆血和鬼化体术提升明显。"],
