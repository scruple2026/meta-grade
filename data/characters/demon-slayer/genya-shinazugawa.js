(function () {
  ...
  registerCharacters([
    work.character({
      ...
      dimensions: dims({
        attack: ["墙级", "房屋级｜枪械｜食鬼", "枪械、日轮弹和食鬼后鬼化能力为主。"],
        defense: ["凡人级", "墙级｜食鬼", "食鬼后承伤和恢复提升。"],
        ...
        energy: ["凡人能量", "墙级能量｜食鬼", "资源来自体力、弹药和食鬼状态。"],
        energyRegen: ["常规回能", "快速回能｜食鬼", "食鬼状态有时限和材料依赖。"]
      }),
      notes: notes({
        penetration: "日轮枪弹和血鬼术化弹丸具备针对鬼的特殊杀伤。",
        resistance: "食鬼提升恢复，不代表能承受斩首级伤害。",
        special: "食鬼体质、鬼化恢复、日轮枪弹、短时血鬼术化。",
        weakness: "依赖鬼肉和弹药；基础剑术和速度不如柱。",
        setting: "按刀匠村和无限城食鬼状态综合记录。",
