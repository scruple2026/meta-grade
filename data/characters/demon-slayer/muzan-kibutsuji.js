(function () {
  ...
  registerCharacters([
    work.character({
      ...
      dimensions: dims({
        attack: ["房屋级", "楼级｜血鬼术｜触手群", "多触手、冲击波和血液改造造成大范围近战压制。"],
        defense: ["房屋级", "楼级｜鬼王再生", "防御主要来自高速再生和多脑多心结构。"],
        ...
        energy: ["房屋级能量", "楼级能量｜鬼王", "血液支配、改造和再生资源为鬼中最高。"],
        energyRegen: ["极速回能", "极速回能", "持续作战和再生极强，但药物会削弱。"]
      }),
      notes: notes({
        penetration: "血液注入、细胞破坏和触手群是高接触杀伤，非纯破坏规模。",
