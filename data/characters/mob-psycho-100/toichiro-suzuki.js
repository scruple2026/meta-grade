(function () {
  ...
  registerCharacters([
    work.character({
      ...
      sourceQuality: "entry",
      dimensions: dims({
        attack: ["楼级", "街区级｜储备能量｜自爆风险", "长期储备能量可形成大范围念动力破坏，峰值含自毁风险。"],
        defense: ["楼级", "街区级｜念动力屏障", "屏障和高能量输出支撑承伤。"],
        ...
        energy: ["楼级能量", "街区级能量｜长期储备", "多年储备提供极高能量池，但会失控。"],
        energyRegen: ["快速回能", "快速回能｜储备释放后需恢复", "消耗后需要重新积累。"]
      }),
      notes: notes({
        penetration: "念动力、能量弹和屏障冲击提供大范围压制；最终高峰带自毁风险。",
