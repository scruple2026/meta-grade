(function () {
  ...
  registerCharacters([
    work.character({
      ...
      dimensions: dims({
        attack: ["楼级", "街区级｜100%/???%｜不可控", "念动力可大范围抛掷、压碎和破坏建筑群局部；???% 标不可控。"],
        defense: ["楼级", "街区级｜念动力屏障", "屏障和念动力抵消大幅提高防御。"],
        ...
        energy: ["楼级能量", "街区级能量｜100%/???%", "超能力储量极高，但情绪和状态决定输出。"],
        energyRegen: ["快速回能", "快速回能｜情绪/恢复", "恢复力强但不是无限。"]
      }),
      notes: notes({
        penetration: "念动力可压碎、抛掷、束缚、反弹和大范围清场；???% 是失控峰值，不视为理智常态。",
