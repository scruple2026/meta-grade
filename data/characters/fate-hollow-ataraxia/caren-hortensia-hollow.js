(function () {
  ...
  registerCharacters([
    work.character({
      ...
      dimensions: dims({
        attack: ["凡人级", "砖级｜教会礼装/圣骸布", "本体输出有限，峰值来自教会装备、圣骸布和恶魔祓除语境。"],
        defense: ["凡人级", "砖级｜圣骸布/痛觉体质", "承伤更多来自异常体质和礼装，不是高硬度肉身。"],
        ...
        energy: ["凡人能量", "砖级能量｜教会礼装/圣骸布", "个人资源和礼装规模有限。"],
        energyRegen: ["缓慢回能", "缓慢回能｜休整/外部支援", "补给依赖休整、礼装和教会资源。"]
      }),
      notes: notes({
        penetration: "教会礼装、圣骸布和恶魔祓除能力偏异常目标/灵性处理，不等同大范围破坏。",
