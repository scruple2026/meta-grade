(function () {
  ...
  registerCharacters([
    work.character({
      ...
      dimensions: dims({
        attack: ["墙级", "楼级｜Fragarach反击｜条件", "徒手、符文与魔术格斗高于普通人；Fragarach是对王牌的单体反击，不按大范围破坏处理。"],
        defense: ["墙级", "房屋级｜符文/魔术防护", "人类魔术师本体，承伤强但不能按从者硬度处理。"],
        ...
        energy: ["砖级能量", "楼级能量｜Fragarach/魔术资源｜条件", "个人魔术资源有限，Fragarach是高价值条件牌。"],
        energyRegen: ["缓慢回能", "中速回能｜休整/循环语境", "补能需要休整或外部循环条件，不是无消耗战斗。"]
      }),
      notes: notes({
        penetration: "Fragarach针对敌方切札/王牌进行因果反击，单体穿透和克制极强；基础杀伤仍以魔术格斗与符文武装为主。",
