(function () {
  ...
  registerCharacters([
    work.character({
      ...
      sourceQuality: "entry",
      dimensions: dims({
        attack: ["墙体级", "街区级｜触手/局部破坏｜争议", "常规触手可高效破坏局部目标；月球事件暂只写入说明，不进入主表高风险档。"],
        defense: ["墙体级", "街区级｜触手体/防御形态｜争议", "常规武器难以命中和伤害，弱点武器另算。"],
      ...
      notes: notes({
        penetration: "高速触手、教学式多任务行动、局部破坏和反制暗杀；月球事件属于高风险争议证据，未补具体章节/集数前不等同任意常规单击。攻击速度：触手连击可随高速本体同时多线出手，但局部触手打击、携带武器与月球事件不是同一种攻击过程。",
