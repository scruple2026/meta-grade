(function () {
  ...
  registerCharacters([
    work.character({
      ...
      sourceQuality: "entry",
      dimensions: dims({
        attack: ["砖块级", "墙体级｜格斗/陷阱/武器", "学生中格斗和策略突出，但仍是人类尺度。"],
        defense: ["凡人级", "砖块级｜格斗/防具", "防御依赖身体素质、反应和装备。"],
        movement: ["凡人速", "亚音速｜格斗", "近现实高端学生格斗机动。"],
        reaction: ["凡人速", "亚音速｜格斗/读招", "读招和临场反应强。"],
        vitality: ["强化凡体", "强化凡体", "训练者体魄。"],
        healing: ["无自愈", "无自愈", "无自愈。"],
        energy: ["砖块级能量｜体能/武器", "墙体级能量｜陷阱/团队资源", "峰值来自陷阱、武器和准备。"],
        energyRegen: ["中速回能", "中速回能｜体能", "普通高体能恢复。"]
      }),
      notes: notes({
        penetration: "格斗、陷阱、武器和心理挑衅结合，擅长制造对方失误。攻击速度：拳脚与手持武器是受训学生的近战出手，陷阱则取决于预置触发，二者不能由他的跑动速度互推。",
