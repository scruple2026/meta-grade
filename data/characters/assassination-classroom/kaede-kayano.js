(function () {
  ...
  registerCharacters([
    work.character({
      ...
      dimensions: dims({
        attack: ["凡人级", "墙级｜触手植入/反杀老师武器", "日常学生状态攻击低；触手暴露阶段有短时近战威胁。"],
        defense: ["凡人级", "砖级｜训练/触手辅助", "本体仍是学生肉身，触手可提供短时辅助但不等同杀老师级硬度。"],
        ...
        energy: ["凡人能量", "墙级能量｜触手植入/武器资源", "峰值资源来自触手和反杀老师相关武器，不等同常态体能。"],
        energyRegen: ["中速回能", "中速回能｜体能/准备", "普通学生体能恢复，触手使用受身体和心理状态限制。"]
      }),
      notes: notes({
        penetration: "日常主要依赖暗杀训练、演技和反杀老师武器；触手暴露阶段可形成近战穿刺和压制。",
