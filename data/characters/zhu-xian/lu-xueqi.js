(function () {
  ...
  registerCharacters([
    work.character({
      ...
      dimensions: dims({
        attack: ["墙体级", "楼宇级｜天琊神剑/神剑御雷真诀｜争议", "按青云门主战修真者和法宝飞剑语境保守记录；缺少原文章节前不抬高。"],
        defense: ["墙体级", "楼宇级｜道法防护/法宝", "以修真护体、法宝和主线战斗承压作低档占位，不按境界名号外推。"],
        ...
        energy: ["墙体级能量", "楼宇级能量｜天琊神剑/青云道法｜争议", "能量池按青云道法和天琊神剑使用记录，需原文补证。"],
        energyRegen: ["中速回能", "中速回能｜调息/道法循环", "续航依赖修为、法宝和调息，不写成无限资源。"]
      }),
      notes: notes({
        penetration: "天琊神剑和青云剑诀偏飞剑/雷法穿透与爆发；缺少原文章节时不把法宝名号直接抬到大范围破坏。攻击速度：近身剑诀、御使天琊飞剑与雷法爆发分别看出手、飞剑到达和术法发动；御剑移动不能代替攻击传播。",
