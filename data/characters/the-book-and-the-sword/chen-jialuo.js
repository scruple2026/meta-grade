(function () {
  ...
  registerCharacters([work.character({
    ...
    sourceQuality: "entry",
    dimensions: dims({
      attack: ["砖块级", "墙体级｜百花错拳/庖丁解牛掌", "红花会高手，输出按单体武侠杀伤记录。"],
      defense: ["砖块级", "墙体级｜内功/招架", "防御来自内功、身法和兵刃应对。"],
      ...
      energy: ["砖块级能量", "墙体级能量｜内力", "内力资源按金庸高手处理。"],
      energyRegen: ["缓慢回能", "缓慢回能｜调息", "需调息恢复。"]
    }),
    notes: notes({
      penetration: "百花错拳、庖丁解牛掌和兵刃应对偏技巧与单体打击。攻击速度：拳掌和兵刃应对都发生在近身招式交换中，出手快慢应看具体破招与连击，不以轻功赶路替代。",
