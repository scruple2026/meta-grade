(function () {
  ...
  registerCharacters([work.character({
    ...
    dimensions: dims({
      attack: ["砖块级", "墙体级｜言灵·镜瞳/枪械/混血种训练", "本体以混血种训练和现代装备为主，言灵偏复制/技巧收益。"],
      defense: ["砖块级", "墙体级｜混血种体质/训练规避", "承伤高于普通人，但不是龙王级生命结构。"],
      ...
      energy: ["砖块级能量", "墙体级能量｜言灵·镜瞳/血统", "言灵资源有限，不按大范围输出型言灵处理。"],
      energyRegen: ["缓慢回能", "缓慢回能｜休息/补给", "没有稳定高强度战斗回能体系。"]
    }),
    notes: notes({
      penetration: "主要靠枪械、混血种格斗和言灵·镜瞳带来的技巧复制/学习优势，不以大范围破坏见长。攻击速度：零的近战随混血种格斗节奏，枪弹离膛后独立飞行；镜瞳复制的是技巧与操作优势，不会自动复制所有载体速度。",
