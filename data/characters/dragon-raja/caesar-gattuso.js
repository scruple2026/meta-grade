(function () {
  ...
  registerCharacters([work.character({
    ...
    dimensions: dims({
        attack: ["墙级", "房屋级｜狄克推多/枪械/镰鼬辅助", "以武器、射击和言灵辅助为主，破坏峰值低于龙王级。"],
        defense: ["墙级", "房屋级｜混血种体质/装备", "高素质混血种承伤。"],
        ...
        energy: ["墙级能量", "房屋级能量｜言灵/装备", "资源来自装备、言灵和战术准备。"],
        energyRegen: ["缓慢回能", "中速回能｜血统/休整", "高强度消耗后需要休整。"]
      }),
    notes: notes({
        penetration: "狄克推多、枪械和团队火力是主要杀伤；镰鼬偏感知辅助。",
