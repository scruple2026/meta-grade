(function () {
  ...
  registerCharacters([work.character({
    ...
    dimensions: dims({
        attack: ["墙体级", "楼宇级｜言灵/炼金武装/暴血", "混血种战斗力强，峰值来自言灵、装备或暴血。"],
        defense: ["墙体级", "楼宇级｜血统/装备", "高血统和装备支撑承伤。"],
        movement: ["亚音速", "音速｜暴血/混血种爆发", "短时爆发明显高于常人。"],
        reaction: ["亚音速", "音速｜言灵/战斗经验", "混血种战斗反应强。"],
        vitality: ["强化凡体", "楼宇级生命阈值｜血统/暴血", "生命体量随血统和暴血提升，但不是龙王本体。"],
        healing: ["缓慢自愈", "快速自愈｜血统/医疗", "恢复依赖血统和医疗条件。"],
        energy: ["墙体级能量", "楼宇级能量｜言灵/炼金武装", "言灵和装备提供峰值资源。"],
        energyRegen: ["缓慢回能", "中速回能｜血统/休整", "高强度消耗后需要休整。"]
      }),
    notes: notes({
        penetration: "君焰偏高热和爆燃杀伤，村雨/炼金武装另算近战穿透。攻击速度：村雨斩击随楚子航近战接战，君焰需发动后形成高热爆燃区；爆燃扩张与刀速不是同一个量。",
