(function () {
  ...
  registerCharacters([work.character({
    ...
    dimensions: dims({
        attack: ["墙体级", "街区级｜交易/规则干涉｜争议", "威胁主要来自交易和规则干涉，非普通肉搏。"],
        defense: ["墙体级", "街区级｜特殊存在/复归条件｜争议", "存在方式不明，防御和死亡条件需保守标争议。"],
        ...
        energy: ["墙体级能量", "街区级能量｜交易/规则干涉｜争议", "能量池按可影响战局的交易峰值记录。"],
        energyRegen: ["中速回能", "快速回能｜特殊存在条件｜争议", "回能与存在机制相关。"]
      }),
    notes: notes({
        penetration: "交易和规则干涉比直接破坏更关键，不把其换算为无限攻击。攻击速度：路鸣泽以交易和规则干涉为主，效果依赖契约条件而非可见弹道；远程显现不等于无前摇的无限速打击。",
