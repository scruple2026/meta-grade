(function () {
  ...
  registerCharacters([work.character({
    ...
    dimensions: dims({
        attack: ["楼宇级", "街区级｜审判/皇血｜争议", "审判言灵是高危杀伤，按峰值保守记录。"],
        defense: ["房屋级", "楼宇级｜皇血体质", "身体特殊但不按龙王硬度处理。"],
        movement: ["凡人速", "亚音速｜皇血体质", "缺少高速移动定位。"],
        reaction: ["亚音速", "音速｜皇血/言灵反应", "言灵反应强于普通人。"],
        vitality: ["强化凡体", "楼宇级生命阈值｜皇血/圣骸关联｜争议", "生命状态与血统和圣骸线有关，标争议。"],
        healing: ["缓慢自愈", "快速自愈｜皇血/医疗条件", "恢复依赖血统和外部条件。"],
        energy: ["墙体级能量", "街区级能量｜审判言灵｜争议", "言灵峰值高，但受控制和身体状态限制。"],
