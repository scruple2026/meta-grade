(function () {
  ...
  registerCharacters([work.character({
    ...
    dimensions: dims({
        attack: ["楼级", "街区级｜海洋与水权能/龙王级存在｜仅下限｜争议", "按龙王级存在下限记录，不把称号直接换算为城市级或更高。"],
        ...
        energy: ["楼级能量", "街区级能量｜海洋与水权能/言灵｜仅下限｜争议", "能量池按龙王权能保守下限，不按海洋规模字面上推。"],
        energyRegen: ["中速回能", "快速回能｜龙类生命/环境条件｜争议", "回能受龙类状态和环境影响。"]
      }),
    notes: notes({
        penetration: "海洋与水权能、龙躯和高阶言灵构成威胁，但缺少可直接换算的大范围破坏证据。",
