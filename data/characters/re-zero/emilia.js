(function () {
  ...
  registerCharacters([
    work.character({
      ...
      sourceQuality: "entry",
      dimensions: dims({
        attack: ["砖级", "街区级｜冰魔法/帕克协同｜争议", "本人可用冰魔法，峰值部分依赖契约精灵协同。"],
        defense: ["凡人级", "墙级｜冰防御/精灵术", "肉身有限，防护来自魔法和精灵术。"],
        ...
        energy: ["砖级能量", "街区级能量｜冰魔法/帕克协同｜争议", "魔力资源和帕克协同提供峰值。"],
        energyRegen: ["缓慢回能", "中速回能｜精灵术", "魔力恢复依赖状态和契约条件。"]
      }),
      notes: notes({
        penetration: "冰魔法可冻结、束缚和造成范围控制，帕克协同时威胁提升。",
