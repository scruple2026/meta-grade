(function () {
  ...
  registerCharacters([
    work.character({
      ...
      sourceQuality: "entry",
      dimensions: dims({
        attack: ["墙体级", "街区级｜大精灵冰/火属性｜争议", "大精灵魔法威胁高，但王选篇不把世界终焉说法直接抬高。"],
        defense: ["砖块级", "街区级｜精灵体/魔法防护｜争议", "精灵体与魔法防护强于常人。"],
        ...
        energy: ["墙体级能量", "街区级能量｜大精灵魔力｜争议", "大精灵魔力资源很高但不泛化为高天体档。"],
        energyRegen: ["中速回能", "中速回能｜精灵魔力", "魔力恢复受契约和活动时间限制。"]
      }),
      notes: notes({
        penetration: "冰/火属性精灵魔法可造成范围控制和高压制。攻击速度：冰火精灵魔法包含形成、释放和范围扩张等阶段，魔法视觉效果或精灵本体机动不能充当攻击到达速度。",
