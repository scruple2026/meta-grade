(function () {
  ...
  registerCharacters([
    work.character({
      ...
      dimensions: dims({
        attack: ["墙体级", "房屋级｜炼成武装｜地形突刺", "以拳击、手甲炼成和地形突刺作战，破坏多为局部墙体、石柱和掩体规模。"],
        defense: ["凡人级", "墙体级｜肌肉防护｜格挡", "本体仍是人类肉身，峰值来自强壮体格、格挡和炼成掩体。"],
      ...
      notes: notes({
        penetration: "手甲上的炼成阵可把拳击与石质突刺、石拳和地形改造结合，适合破坏掩体、打断行动和制造近战压迫；不把炼成技巧等同大范围爆破。攻击速度：阿姆斯特朗的拳击随贴身挥拳命中，手甲炼成的石刺、石拳和地形变化则在炼成后展开；两段不能视为同一种动作速度。",
        ...
        basis: "依据阿姆斯特朗作为国家炼金术师的拳斗、手甲炼成、地形破坏和最终日协同战表现，保守定为墙体级常态、房屋级局部峰值。"
      })
    })
  ]);
})();
