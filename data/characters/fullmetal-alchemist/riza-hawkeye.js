(function () {
  ...
  registerCharacters([
    work.character({
      ...
      dimensions: dims({
        attack: ["砖块级", "墙体级｜枪械/爆炸物", "主输出来自手枪、步枪和战场火力配合，不按炼金术大范围破坏处理。"],
        defense: ["凡人级", "砖块级｜防弹装备/掩体", "本体是训练有素的人类士兵，防御依赖掩体、距离和装备。"],
        ...
        energy: ["砖块级能量", "墙体级能量｜弹药/爆炸物", "资源来自弹药与携行装备，不是超自然能量池。"],
        energyRegen: ["无回能", "无回能", "弹药消耗后需要补给。"]
      }),
      notes: notes({
        penetration: "枪械以高速穿透和精确命中为主，可针对要害、掩体缝隙和炼金术师施术窗口；不具备大范围炼金破坏。攻击速度：霍克艾中尉的枪击由举枪、精确瞄准、扣发和枪械循环构成，弹丸离膛后按所用武器飞行；连续压制还受弹匣限制。",
