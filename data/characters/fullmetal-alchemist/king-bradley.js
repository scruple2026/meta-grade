(function () {
  ...
  registerCharacters([
    work.character({
      ...
      dimensions: dims({
        attack: ["墙体级", "房屋级｜剑术连斩", "以高速剑术和精准切割为主，范围破坏有限。"],
        defense: ["凡人级", "墙体级｜格挡", "本体耐久高于常人但不具备多数人造人的再生，主要靠闪避和格挡。"],
        ...
        energy: ["砖块级能量｜人造人体能", "墙体级能量｜体能", "无传统能量池，但能量总量包含体力、肌耐力和连续作战持久度；大总统稳定体能高于普通凡人。"],
        energyRegen: ["中速回能", "中速回能", "无超常回能，依赖休息恢复体力。"]
      }),
      notes: notes({
        penetration: "剑术可精准切开武器、炮弹和人体要害，但不是大范围能量攻击。攻击速度：剑术随手臂、步法和接战距离完成，收招再攻与单次命中不能用移动速度替代。",
