(function () {
  ...
  registerCharacters([
    work.character({
      ...
      dimensions: dims({
        attack: ["墙体级", "房屋级｜硬化爪击/姚麟体术", "硬化碳盾和姚麟体术使近战突破力高。"],
        defense: ["墙体级", "房屋级｜最强之盾", "碳硬化提供高防御，是古利德核心优势。"],
        ...
        energy: ["墙体级能量", "房屋级能量｜贤者之石/硬化", "贤者之石与硬化能力支撑持续近战。"],
        energyRegen: ["缓慢回能", "中速回能｜贤者之石资源", "恢复依赖库存消耗与休整。"]
      }),
      notes: notes({
        penetration: "硬化爪击、姚麟体术和人造人体能偏近战穿透，不是范围炼成爆破。攻击速度：格利德的硬化爪击与姚麟体术都是贴身攻击，速度取决于接近、挥爪和连段衔接，没有离体传播环节。",
