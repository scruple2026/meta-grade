(function () {
  ...
  registerCharacters([
    work.character({
      ...
      dimensions: dims({
        attack: ["房屋级", "楼宇级｜巨体冲撞", "巨体怪力和冲撞可造成大规模局部破坏。"],
        defense: ["房屋级", "楼宇级｜巨体/再生", "巨体和贤者之石再生提供高承伤。"],
        movement: ["凡人速", "亚音速｜直线冲刺", "平时迟缓，但短距离直线爆发极快。"],
        reaction: ["凡人速", "亚音速｜本能冲撞", "反应与判断迟钝，冲刺速度不等同复杂反应。"],
        vitality: ["房屋级生命阈值｜巨体/贤者之石", "楼宇级生命阈值｜巨体/贤者之石", "巨体、人造人结构和贤者之石支撑承伤。"],
        healing: ["快速自愈", "极速自愈｜贤者之石", "可消耗贤者之石修复身体。"],
        energy: ["房屋级能量", "楼宇级能量｜巨体/贤者之石", "体力、巨体和贤者之石资源支撑重体力作战。"],
