(function () {
  ...
  registerCharacters([
    work.character({
      ...
      dimensions: dims({
        attack: ["墙体级", "房屋级｜炼成武装", "体术、铠甲力量和炼成武装可破坏墙体到小型建筑局部。"],
        defense: ["墙体级", "房屋级｜铠甲身体", "空铠甲对常规肉体伤害免疫，但血印和结构破坏是核心风险。"],
      ...
      notes: notes({
        penetration: "炼金术和重型铠甲格斗有局部穿透优势，但范围不高。攻击速度：阿尔冯斯的铠甲拳脚随近身动作命中，炼金术则先发动并形成武器、墙体或地形变化；炼成完成不等于后续打击自动命中。",
