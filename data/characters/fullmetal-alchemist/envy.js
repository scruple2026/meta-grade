(function () {
  ...
  registerCharacters([
    work.character({
      ...
      dimensions: dims({
        attack: ["墙体级", "房屋级｜巨大本体/贤者之石", "可用巨大本体、怪力和变形压制目标。"],
        defense: ["墙体级", "房屋级｜巨大本体/再生", "巨大身体与贤者之石再生提高承伤。"],
        movement: ["凡人速", "亚音速｜变形突进", "速度不是核心优势，依赖体型与变形。"],
        reaction: ["凡人速", "亚音速｜人造人经验", "可应对常规战斗，但不以高速反应见长。"],
        vitality: ["房屋级生命阈值｜贤者之石", "楼宇级生命阈值｜巨大本体/贤者之石｜争议", "生命阈值来自巨大本体和灵魂资源，本体核心仍可被削弱。"],
        healing: ["快速自愈", "极速自愈｜贤者之石", "可消耗贤者之石修复身体，资源耗尽后会崩溃。"],
        energy: ["墙体级能量", "楼宇级能量｜贤者之石/巨大本体", "贤者之石资源支撑变身、巨大化和再生。"],
        energyRegen: ["缓慢回能", "中速回能｜贤者之石资源", "恢复依赖库存消耗而非自然回能。"]
      }),
      notes: notes({
        penetration: "巨大本体的怪力、撕咬和压制适合对人和局部建筑破坏，变身主要服务欺骗而非破坏。攻击速度：恩维巨大本体的撕咬、抓击和压制都要先以巨体接近并挥动肢体，变身只改变外形与欺骗条件，不会形成独立远程攻击。",
