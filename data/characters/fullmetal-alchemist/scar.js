(function () {
  ...
  registerCharacters([
    work.character({
      ...
      fandomSlug: "Scar",
      dimensions: dims({
        attack: ["墙体级", "房屋级｜分解炼成", "分解炼成对接触目标有高穿透，范围仍主要是单体或局部结构破坏。"],
        defense: ["凡人级", "墙体级", "本体为强化人类武僧，靠体术和闪避减少受击。"],
      ...
      notes: notes({
        penetration: "右臂分解可绕开常规硬度直接破坏结构，是接触型高穿透能力。攻击速度：斯卡必须先接近并以右臂触及目标，分解在接触后破坏结构；发动效果没有脱离手臂独立飞行的阶段。",
