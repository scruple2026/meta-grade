(function () {
  ...
  registerCharacters([
    work.character({
      ...
      dimensions: dims({
        attack: ["墙级", "房屋级｜影子触手/贤者之石", "影子切割、贯穿和多方向压制强，范围受光源与容器限制。"],
        ...
        vitality: ["强化凡体｜特殊容器", "楼级生命阈值｜贤者之石/特殊生命结构｜争议", "生命依赖容器、贤者之石和人造人核心，不能按普通儿童肉身处理。"],
        healing: ["快速自愈", "极速自愈｜贤者之石", "可消耗贤者之石修复，资源耗尽或容器破坏会削弱。"],
        energy: ["墙级能量", "楼级能量｜贤者之石/影子", "贤者之石资源和影子能力支撑持续战斗。"],
        energyRegen: ["缓慢回能", "中速回能｜贤者之石资源", "恢复依赖库存消耗，不是自然瞬时回能。"]
      }),
      notes: notes({
        penetration: "影子可切割、贯穿和束缚目标，属于多方向接触型高穿透，不按大范围爆破处理。",
