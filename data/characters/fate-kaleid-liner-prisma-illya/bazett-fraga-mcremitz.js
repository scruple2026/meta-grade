  ...
  registerCharacters([
    work.character({
      ...
      dimensions: dims({
        ...
        healing: ["常规自愈", "瞬愈｜复活符文｜条件", "复活符文可在心脏停止时瞬间恢复身体，触发条件和资源有限。"],
        energy: ["墙级能量", "楼级能量｜符文/弗拉格拉克", "主要是个人魔术、符文和一次性宝具资源。"],
        energyRegen: ["常规回能", "快速回能｜符文准备", "可连续格斗但宝具弹数和符文准备不是无限。"]
      }),
      notes: notes({
        penetration: "弗拉格拉克在对手使用切札后以因果/时间反击命中心脏，单体穿透和克制极强；常规破坏范围仍以符文格斗表现为准。",
