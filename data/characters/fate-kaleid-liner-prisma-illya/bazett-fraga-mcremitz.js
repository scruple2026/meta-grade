(function () {
  ...
  registerCharacters([
    work.character({
      ...
      dimensions: dims({
        attack: ["墙体级", "楼宇级｜符文强化/弗拉格拉克｜条件", "徒手和符文强化可造成大范围局部破坏；弗拉格拉克是单体心脏反击，不按大范围破坏记录。"],
        defense: ["墙体级", "楼宇级｜符文装甲/复活符文｜条件", "符文手套和肉体韧性极高，复活符文属于续命/恢复而非纯硬防。"],
        movement: ["亚音速", "超音速｜格斗突进", "近身爆发强，可压制魔法少女组。"],
        reaction: ["亚音速", "超音速｜对宝具反击", "能处理Class Card宝具战，但弗拉格拉克部分来自条件型反击机制。"],
        vitality: ["精锐韧体", "楼宇级生命阈值｜复活符文｜条件", "能承受重伤并靠复活符文续战，仍可能被克制或消耗。"],
        healing: ["中速自愈", "瞬愈｜复活符文｜条件", "复活符文可在心脏停止时瞬间恢复身体，触发条件和资源有限。"],
        energy: ["墙体级能量", "楼宇级能量｜符文/弗拉格拉克", "主要是个人魔术、符文和一次性宝具资源。"],
        energyRegen: ["中速回能", "快速回能｜符文准备", "可连续格斗但宝具弹数和符文准备不是无限。"]
      }),
      notes: notes({
        penetration: "弗拉格拉克在对手使用切札后以因果/时间反击命中心脏，单体穿透和克制极强；基础破坏范围仍以符文格斗表现为准。攻击速度：强化格斗随巴泽特贴身出拳，弗拉格拉克在对手切札发动后进行因果反击；反击先后规则不能简化为投射弹速。",
