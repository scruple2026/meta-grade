(function () {
  ...
  registerCharacters([
    work.character({
      ...
      timelinePanels: [
        {
          ...
          dimensions: dims({
            attack: ["墙体级", "房屋级｜魔法少女", "战斗技术优于早期伊莉雅，基础输出仍以对人和局部破坏为主。"],
            defense: ["墙体级", "房屋级｜屏障", "变身提供魔法屏障与防护。"],
            movement: ["亚音速", "亚音速｜飞行", "可飞行和高速突进，未按音速记录。"],
            reaction: ["亚音速", "亚音速", "早期近战判断和战斗经验较好。"],
            vitality: ["强化凡体", "精锐韧体｜魔法少女防护", "本体仍是儿童，变身防护和意志提高续战。"],
            healing: ["中速自愈", "快速自愈｜魔杖加速恢复", "依赖变身和供魔，不是独立再生体质。"],
            energy: ["房屋级能量", "楼宇级能量｜万花筒魔杖", "Magical Sapphire供魔稳定。"],
        ...
        },
        {
          ...
          dimensions: dims({
            ...
            defense: ["房屋级", "楼宇级｜魔法屏障/Install", "屏障与Class Card加成提高承伤，但圣杯身份不等同常驻硬防。"],
            movement: ["亚音速", "超音速｜飞行/Install｜争议", "Install可强化机动；缺少稳定高超音速证据。"],
            reaction: ["亚音速", "超音速｜Class Card战", "能参与强敌战并熟练使用卡片，反应仍按画面表现保守记录。"],
            vitality: ["精锐韧体｜完全圣杯", "楼宇级生命阈值｜魔杖/圣杯容器", "作为圣杯容器具有特殊价值和续战潜力，但可被拘束、抽血和仪式利用。"],
            healing: ["快速自愈｜魔杖加速恢复", "极速自愈｜供魔/仪式条件", "恢复依赖魔杖、仪式和外部条件，不按无条件瞬愈。"],
            energy: ["楼宇级能量", "街区级能量｜Class Card/圣杯仪式｜条件", "个人战斗能量与仪式级圣杯资源分开；仪式许愿不反推单次攻击。"],
            energyRegen: ["快速回能", "极速回能｜万花筒魔杖/圣杯", "供魔极强但不写瞬时回能，避免把资源设定直接换成主等级。"]
          }),
      ...
      notes: notes({
        penetration: "Class Card宝具可提供高穿透或特殊命中方式；圣杯许愿、英灵召唤和仪式结果不等同于美游自身单次攻击破坏。攻击速度：Class Card近战、箭矢和宝具放出各有独立过程，圣杯许愿还依赖仪式与条件；不能用飞行机动替代全部攻击速度。",
