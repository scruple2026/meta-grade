(function () {
  ...
  registerCharacters([
    work.character({
      ...
      dimensions: dims({
        attack: ["砖块级", "墙体级｜宝石魔术/礼装", "宝石魔术可形成对人级爆发，不并入Fate本篇高端战绩。"],
        defense: ["凡人级", "墙体级｜魔术防护/礼装", "本体是人类魔术师，峰值依赖防护与礼装。"],
        ...
        energy: ["砖块级能量", "墙体级能量｜宝石/礼装", "宝石储备能提高爆发，资源有限。"],
        energyRegen: ["中速回能", "中速回能｜休整/宝石补充", "宝石和魔力需要准备补充。"]
      }),
      notes: notes({
        penetration: "宝石魔术和礼装可造成对人爆发与局部破坏，缺少稳定大范围战斗表现。攻击速度：宝石魔术需先取用宝石并释放预存魔力，礼装也按各自发动过程判断；现有资料不足以把这些效果统一视为无前摇攻击。",
