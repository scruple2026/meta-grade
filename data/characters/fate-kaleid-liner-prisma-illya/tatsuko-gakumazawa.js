(function () {
  ...
  registerCharacters([
    work.character({
      id: "tatsuko-gakumazawa",
      name: "岳间泽龙子",
      en: "Tatsuko Gakumazawa",
      ja: "嶽間沢龍子",
      affiliation: "伊莉雅同学组",
      grade: "学生 / 同学四人组",
      ...
      aliases: ["龙子", "Tatsuko"],
      fandomSlug: "Tatsuko_Gakumazawa",
      confidence: "review",
      evidenceType: ["官方入口", "资料入口"],
      sourceQuality: "entry",
      revisionNotes: ["从魔法少女伊莉雅 worldbook 的 comment/key 姓名池补入；不采用 worldbook 正文描述。"],
      dimensions: dims({
        attack: ["凡人级", "凡人级", "运动活跃的小学生，非战斗角色。"],
        defense: ["凡人级", "凡人级", "运动活跃的小学生，非战斗角色。"],
        movement: ["凡人速", "凡人速", "运动活跃的小学生，非战斗角色。"],
        reaction: ["凡人速", "凡人速", "运动活跃的小学生，非战斗角色。"],
        vitality: ["凡人肉身", "凡人肉身", "运动活跃的小学生，非战斗角色。"],
      ...
      notes: notes({
        ...
        sensing: "日常观察和同学关系信息。",
        tactics: "运动活跃、日常同学与喜剧支援。",
        special: "伊莉雅同学组日常支援。",
        weakness: "正面战斗能力低，面对Class Card敌人需要保护。",
        setting: "按Prisma Illya早期岳间泽龙子记录。",
        basis: "worldbook只用于抽取岳间泽龙子姓名；定级依据公开角色资料入口和日常同学定位。"
      })
    })
  ]);
})();
