(function () {
  ...
  registerCharacters([
    work.character({
      ...
      dimensions: dims({
        attack: ["砖块级", "墙体级｜宝石魔术/格斗", "宝石魔术与摔角格斗可形成对人压制。"],
        defense: ["凡人级", "墙体级｜魔术防护/礼装", "本体人类，防御依赖礼装和技巧。"],
        ...
        energy: ["砖块级能量", "墙体级能量｜宝石/礼装", "魔力和宝石储备有限。"],
        energyRegen: ["中速回能", "中速回能｜休整/宝石补充", "需要休整与资源补充。"]
      }),
      notes: notes({
        penetration: "宝石魔术和强化格斗适合对人爆发，不等同英灵宝具破坏。攻击速度：强化格斗随露维亚贴身动作，宝石魔术要先投入宝石并放出效果；消耗型爆发与拳脚连击不是同一节奏。",
