  ...
  registerCharacters([
    work.character({
      ...
      dimensions: dims({
        ...
        healing: ["无自愈", "常规自愈｜宿主/置换条件", "缺少独立战斗中高速恢复表现；宿主转移或概念继承属于特殊机制。"],
        energy: ["楼级能量", "街区级能量｜宝具/圣杯战争仪式｜条件", "恩兹华斯家资源、宝具和圣杯战争仪式带来高峰值，但个人即时输出需保守拆分。"],
        energyRegen: ["常规回能", "快速回能｜仪式/家系资源", "依赖仪式、场地、Dolls和美游圣杯资源，不写无限回能。"]
      }),
      notes: notes({
        penetration: "冰结界型宝具偏结界、拘束和范围控制；置换魔术能改变物体、空间和战场结构，属于规则/空间侧压制，不等同纯破坏规模。",
