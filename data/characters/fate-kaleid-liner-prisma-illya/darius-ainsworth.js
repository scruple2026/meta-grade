(function () {
  ...
  registerCharacters([
    work.character({
      ...
      dimensions: dims({
        attack: ["墙体级", "街区级｜冰结界型宝具/置换魔术｜仪式", "个人直接攻击表现有限；峰值主要来自冰结界型宝具、置换魔术和圣杯战争仪式资源。"],
        defense: ["墙体级", "街区级｜冰结界型宝具｜结界", "冰结界型宝具可抗住克洛伊Caladbolg级攻击，仅受轻微损伤；本体硬防不等于结界峰值。"],
        ...
        energy: ["楼宇级能量", "街区级能量｜宝具/圣杯战争仪式｜条件", "恩兹华斯家资源、宝具和圣杯战争仪式带来高峰值，但个人即时输出需保守拆分。"],
