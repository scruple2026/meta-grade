(function () {
  ...
  registerCharacters([
    work.character({
      ...
      dimensions: dims({
        attack: ["墙级", "街区级｜Flash Air/黑化英灵/黑泥资源｜争议", "正面输出依赖置换魔术、Rule Master资源、黑化英灵和Darius宿主状态；不把世界救济仪式目的并入单发攻击。"],
        defense: ["墙级", "街区级｜Flash Air/棘枝外壳/宿主状态｜争议", "可用置换魔术、棘枝外壳和Darius宿主状态防护；硬承伤与术式条件分开记录。"],
        ...
        vitality: ["强化凡体｜宿主", "楼级生命阈值｜Darius宿主/概念置换/黑泥连接｜争议", "宿主、Darius概念置换和黑泥/棘枝连接让生命结构复杂，但不等同不可杀或无限生命。"],
        healing: ["无自愈", "中速自愈｜宿主/黑泥/置换条件｜争议", "缺少稳定高速自愈证据；宿主机制和黑泥连接属于条件生存。"],
        energy: ["楼级能量", "街区级能量｜黑泥/棘枝魔力/Rule Master权限｜争议", "可借圣杯战争、黑泥、Pandora相关资源和Class Card体系形成高峰值。"],
