(function () {
  ...
  registerCharacters([
    work.character({
      ...
      timelinePanels: [
        {
          key: "magical-girl",
          label: "初期 / 万花筒魔法少女",
          status: "Magical Ruby基础变身，不计Zwei和强宝具峰值",
          dimensions: dims({
            attack: ["墙体级", "房屋级｜魔力弹/Schneiden", "基础魔力弹、切割和屏障运用以局部破坏及对人战为主。"],
            defense: ["墙体级", "房屋级｜魔法屏障", "Magical Ruby提供屏障和身体防护，但常态承伤不按英灵本体处理。"],
            ...
            energy: ["房屋级能量", "楼宇级能量｜万花筒魔杖", "魔杖供魔很强，但稳定释放受经验、身体和术式形状限制。"],
        ...
        },
        {
          ...
          dimensions: dims({
            attack: ["房屋级", "街区级｜Zwei/圣剑｜争议", "基础魔法输出高于初期；峰值来自Saber Install、Excalibur和Zwei短时爆发，按本作可见规模保守列街区级。"],
            ...
            vitality: ["精锐韧体｜小圣杯", "楼宇级生命阈值｜Zwei｜短时", "小圣杯和魔杖提高续战，Zwei对身体负担极大。"],
            healing: ["快速自愈｜魔杖加速恢复", "极速自愈｜魔杖/短时", "恢复依赖变身和供魔；不是无条件不死或瞬间复活。"],
            energy: ["楼宇级能量", "街区级能量｜Zwei/圣剑｜争议", "能量池受魔杖和小圣杯潜力支撑，但单次输出仍按本作表现限制。"],
      ...
      notes: notes({
        penetration: "魔力弹、Schneiden和宝具峰值有较强对人/对屏障杀伤；Excalibur和Zwei属于形态或短时峰值，不等同于稳定大范围破坏。攻击速度：魔力弹可连续放出并独立飞行，Schneiden则按具体形成方式、作用距离和命中过程保守判断；Excalibur与Zwei峰值还需形态切换和聚能窗口。",
