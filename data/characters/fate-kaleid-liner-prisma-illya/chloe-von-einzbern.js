(function () {
  ...
  registerCharacters([
    work.character({
      ...
      dimensions: dims({
        attack: ["墙体级", "楼宇级｜Archer投影/Caladbolg II", "基础双刀和投影强于普通魔法少女；Caladbolg等宝具为集中杀伤，范围破坏保守列楼宇级。"],
        defense: ["墙体级", "房屋级｜Archer Install/回避", "主要靠机动、投影武器、防护和战术回避；硬防不按高阶英灵本体处理。"],
        ...
        energy: ["房屋级能量", "楼宇级能量｜Archer投影", "魔力和投影资源来自伊莉雅分离后的供给结构，强但有限。"],
        energyRegen: ["中速回能", "快速回能｜伊莉雅供魔", "缺少供魔会影响存在维持和续战。"]
      }),
      notes: notes({
        penetration: "投影双刀、箭矢和Caladbolg II具备集中穿透与爆发杀伤；对强结界和高阶宝具仍有明显上限。攻击速度：投影双刀随小黑近战，箭矢与Caladbolg II离弦后独立飞行；后者还需投影、搭弓与释放，不能共用刀速。",
