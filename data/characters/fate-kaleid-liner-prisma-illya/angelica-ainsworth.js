(function () {
  ...
  registerCharacters([
    work.character({
      ...
      dimensions: dims({
        attack: ["房屋级", "街区级｜王之财宝｜英雄王卡｜争议", "稳定宝具投射和置换魔术压制力强；峰值按本作对主角组和结界战表现保守列街区级，不套用Gilgamesh全设定。"],
        defense: ["墙体级", "楼宇级｜Archer Install｜置换魔术", "Doll身体、英雄王卡装甲和置换魔术提高承伤与回避，但不等同英灵本体硬防。"],
        ...
        vitality: ["精锐韧体｜Doll", "楼宇级生命阈值｜Doll/Install", "Doll身体和卡片加持提升续战，但存在人格、灵魂和置换术式层面的弱点。"],
        healing: ["无自愈", "中速自愈｜Doll维护/置换条件", "没有稳定反转或高速再生表现；Doll维护、置换或外部处理不等同战斗中瞬愈。"],
        energy: ["楼宇级能量", "街区级能量｜英雄王卡/宝具储备｜争议", "王之财宝提供大量宝具资源，但单次输出和本体承载按本作表现限制。"],
        energyRegen: ["中速回能", "快速回能｜Class Card/宝具储备", "可连续展开宝具压制，但卡片、Doll身体和战术条件不是无限。"]
      }),
      notes: notes({
        penetration: "王之财宝的多宝具投射、锁链/兵装压制和英雄王卡提供高单体穿透与饱和火力；置换魔术可改变位置与攻防角度，但不等同大范围破坏升级。攻击速度：王之财宝的兵装从门后分别射出，可形成多方向连射，速度独立于安洁莉卡移动；置换魔术另按发动与换位条件判断。",
