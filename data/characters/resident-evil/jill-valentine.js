(function () {
  ...
  registerCharacters([work.character({
    ...
    dimensions: dims({
        attack: ["砖级｜手枪/战术武器", "墙级｜重武器/爆炸物/反B.O.W.装备｜装备", "常态为枪械与战术武器；峰值依赖任务重火力。"],
        defense: ["凡人级", "砖级｜防具/战术规避", "本体为人类特工，生还依赖战术和装备。"],
        ...
        energy: ["凡人能量", "墙级能量｜弹药/重武器资源｜装备", "资源来自弹药、爆炸物和任务重武器。"],
        energyRegen: ["无回能", "缓慢回能｜补给/换弹", "依赖补给和换弹。"]
      }),
    notes: notes({
        penetration: "枪械、榴弹、爆炸物和重武器可打B.O.W.弱点，装备峰值不代表本体攻击。",
