(function () {
  ...
  registerCharacters([work.character({
    ...
    dimensions: dims({
        attack: ["砖块级｜手枪/近战", "墙体级｜重武器/爆炸物/反B.O.W.装备｜装备", "常态为枪械与格斗；峰值依赖火箭筒、爆炸物或任务装备。"],
        defense: ["凡人级", "砖块级｜防具/战术规避", "本体仍是人类，生还主要来自战术、装备和规避。"],
        ...
        energy: ["凡人能量", "墙体级能量｜弹药/重武器资源｜装备", "能量池按携带弹药和重武器资源记录。"],
        energyRegen: ["无回能", "缓慢回能｜补给/换弹", "依赖补给和换弹，不存在内源回能。"]
      }),
    notes: notes({
        penetration: "枪械、刀术、爆炸物和火箭筒可针对B.O.W.弱点，但重火力属于装备峰值。攻击速度：刀术按近身挥击判断，枪弹和火箭弹在瞄准后独立飞行；重武器的装填与前摇使其不等同手枪连射。",
