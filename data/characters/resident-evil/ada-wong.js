(function () {
  ...
  registerCharacters([work.character({
    ...
    dimensions: dims({
        attack: ["砖级｜手枪/近战", "墙级｜爆炸物/特殊装备｜装备", "输出依赖枪械、爆炸物和任务装备，偏单体/暗杀。"],
        defense: ["凡人级", "砖级｜防具/闪避/钩枪机动", "本体仍是人类，靠机动和隐蔽降低受击。"],
        ...
        energy: ["凡人能量", "墙级能量｜弹药/爆炸物/装备", "资源来自弹药、爆炸物和工具。"],
        energyRegen: ["无回能", "缓慢回能｜补给/换弹", "依赖补给，不存在内源回能。"]
      }),
    notes: notes({
        penetration: "枪械、爆炸物、钩枪机动和暗杀技巧可打弱点，重火力属于装备峰值。",
