(function () {
  ...
  registerCharacters([work.character({
    ...
    sourceQuality: "entry",
    dimensions: dims({
      attack: ["墙级", "房屋级｜黯然销魂掌/玄铁重剑", "后期掌力和重剑强，但仍按武侠局部破坏处理。"],
      defense: ["墙级", "房屋级｜内力/重剑招架", "深厚内力和实战经验提供强防护。"],
      ...
      energy: ["墙级能量", "房屋级能量｜后期内力", "后期内力资源深厚。"],
      energyRegen: ["缓慢回能", "中速回能｜调息", "需调息恢复。"]
    }),
    notes: notes({
      penetration: "黯然销魂掌、玄铁重剑和多派武学偏单体爆发、重击和招式压制。",
