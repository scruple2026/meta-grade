(function () {
  ...
  registerCharacters([work.character({
    ...
    sourceQuality: "entry",
    dimensions: dims({
      attack: ["墙体级", "房屋级｜九阳神功/乾坤大挪移/太极拳剑", "高端内力和多门绝学可形成强单体压制，但不按大范围破坏处理。"],
      defense: ["墙体级", "房屋级｜九阳神功/乾坤大挪移", "九阳内力和挪移卸劲提高承伤与化解能力。"],
      ...
      energy: ["墙体级能量", "房屋级能量｜九阳内力", "九阳内力深厚，适合持续战斗和化解劲力。"],
      energyRegen: ["中速回能", "快速回能｜九阳调息", "九阳神功回气强，仍是内力调息过程。"]
    }),
    notes: notes({
      penetration: "九阳神功、乾坤大挪移、太极拳剑和圣火令武功偏单体劲力、卸劲、反制和兵刃技巧，范围破坏有限。攻击速度：九阳神功、乾坤大挪移、太极拳剑和圣火令武功随手臂、步法和接战距离完成，收招再攻与单次命中不能用移动速度替代。",
