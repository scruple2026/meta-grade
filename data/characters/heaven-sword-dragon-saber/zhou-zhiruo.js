(function () {
  ...
  registerCharacters([work.character({
    ...
    sourceQuality: "entry",
    dimensions: dims({
      attack: ["砖级", "墙级｜九阴白骨爪/倚天剑", "速成九阴和兵刃提高杀伤，但不按稳定顶级内力处理。"],
      defense: ["砖级", "墙级｜峨嵋武功/身法", "本体仍为武侠人体，防御依赖招架和身法。"],
      ...
      energy: ["砖级能量", "墙级能量｜九阴速成", "内力资源强于普通武者，但速成存在稳定性问题。"],
      energyRegen: ["缓慢回能", "中速回能｜调息", "内力恢复依赖调息。"]
    }),
    notes: notes({
      penetration: "九阴白骨爪偏近身穿刺和擒拿杀伤；倚天剑是兵刃峰值，不等同肉身常态。",
