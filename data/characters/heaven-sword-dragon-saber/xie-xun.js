(function () {
  ...
  registerCharacters([work.character({
    ...
    sourceQuality: "entry",
    dimensions: dims({
      attack: ["砖块级", "墙体级｜七伤拳/狮子吼/屠龙刀", "法王级内力、七伤拳、狮子吼和屠龙刀形成强单体压制。"],
      defense: ["砖块级", "墙体级｜内力/硬撑", "体魄魁梧、内力深厚，但双目失明和旧伤会影响防御。"],
      ...
      energy: ["砖块级能量", "墙体级能量｜法王级内力/七伤拳", "内力深厚，可支持七伤拳、狮子吼等高消耗武功。"],
      energyRegen: ["缓慢回能", "缓慢回能｜调息", "需调息恢复，七伤拳也有自损风险。"]
    }),
    notes: notes({
      penetration: "七伤拳偏内伤与劲力侵入，狮子吼偏声波震慑，屠龙刀提供兵刃破坏；均以单体或局部杀伤为主。攻击速度：谢逊的七伤拳与屠龙刀随近身拳法、兵刃动作命中，狮子吼则由发声后以声波向外传达；三者不能只用拳速概括。",
