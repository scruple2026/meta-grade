(function () {
  ...
  registerCharacters([
    work.character({
      ...
      timelinePanels: [
        {
          ...
          status: "第六门至第七门体术峰值",
          dimensions: dims({
            attack: ["楼宇级", "街区级｜昼虎", "七门昼虎是高压空气冲击，不按忍术能量池处理。"],
            defense: ["墙体级", "楼宇级｜八门负荷前", "体术体魄极强，但防御不是核心优势。"],
            ...
            energy: ["楼宇级能量", "街区级能量｜昼虎", "八门将体能爆发为短时输出。"],
            energyRegen: ["中速回能", "中速回能", "八门后需要休养，非稳定回能。"]
          }),
          notes: "不计入第八门死门。"
        },
        {
          ...
          dimensions: dims({
            ...
            defense: ["墙体级", "街区级｜八门负荷", "八门提高身体输出而非等比例提高防御；反噬极强。"],
            ...
            energyRegen: ["中速回能", "无回能｜死门代价", "第八门是一次性代价，不存在战斗中回能。"]
          }),
      ...
      notes: notes({
        penetration: "昼虎、夕象、夜凯是高压体术冲击和连击穿透，不代表大范围地表破坏。攻击速度：迈特凯的夕象与夜凯都由体术动作和突进形成，昼虎则在挥拳后形成空气冲击；起手、接近和冲击传播须分别看。",
        resistance: "八门不提供等比例防御，反而造成严重自损；承伤不能按夜凯攻击峰值反推。",
        sensing: "主要依赖体术修行、近战节奏读取和对强敌动作的经验判断；没有忍术型远距索敌。",
        tactics: "体术路线极端专精，能用八门节奏和连续压迫突破强防御；缺少忍术/幻术广度，第八门是一次性终局手段。",
