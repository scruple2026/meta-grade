(function () {
  ...
  registerCharacters([
    work.character({
      ...
      timelinePanels: [
        {
          ...
          dimensions: dims({
            attack: ["楼宇级", "街区级｜神威/木遁", "主要杀伤来自空间转移、锁链、木遁和战术压制。"],
            defense: ["墙体级", "街区级｜神威虚化｜空间", "虚化是空间规避，不等同肉身防御。"],
            ...
            energy: ["楼宇级能量", "街区级能量｜神威/木遁", "空间忍术消耗大。"],
      ...
      notes: notes({
        penetration: "神威属于空间转移/虚化，求道玉有特殊消解性质；这些不直接换算为更高破坏范围。攻击速度：带土的神威按接触吸入或视线锁定等具体用法发动，空间转移效果不按普通弹道飞行；求道玉则离体后独立移动和命中。",
        resistance: "虚化可规避接触型攻击，十尾状态恢复强；但持续时间、实体化窗口、封印和尾兽抽离是关键限制。",
        sensing: "写轮眼、轮回眼、神威空间和六道状态提升索敌与自保判断；神威虚化仍存在攻防转换窗口。",
        tactics: "长期布局和空间战术强，擅长用虚化、转移、尾兽控制和信息差制造无法命中局面；意志动摇和封印条件会削弱执行。",
