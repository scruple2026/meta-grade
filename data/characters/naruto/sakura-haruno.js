      ...
      timelinePanels: [
        {
          ...
          status: "纲手训练后初期",
          dimensions: dims({
            attack: ["楼宇级", "楼宇级｜怪力", "查克拉强化拳已能造成显著地形破坏。"],
            defense: ["墙体级", "墙体级｜查克拉防护", "肉身仍较脆，依靠闪避和医疗知识。"],
            ...
            energy: ["楼宇级能量", "楼宇级能量｜怪力", "怪力输出依赖查克拉控制。"],
        ...
        },
        {
          ...
          status: "百豪之术开放",
          dimensions: dims({
            attack: ["楼宇级", "街区级｜怪力", "查克拉强化拳可造成大范围地形破坏。"],
            defense: ["墙体级", "楼宇级｜百豪承伤", "肉身防御不等同再生，靠医疗忍术续战。"],
            movement: ["亚音速", "超音速｜忍者机动｜争议", "后期可参与高端战场，但不按顶级六道速度。"],
            reaction: ["亚音速", "超音速｜争议", "战斗经验和医疗判断强。"],
            vitality: ["精锐韧体", "楼宇级生命阈值｜百豪", "百豪提升重伤续战。"],
            healing: ["快速自愈", "极速自愈｜百豪之术", "可战斗中快速恢复明显伤势。"],
            energy: ["楼宇级能量", "街区级能量｜百豪储备", "百豪长期储存查克拉。"],
