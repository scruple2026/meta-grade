(function () {
  ...
  registerCharacters([
    work.character({
      ...
      timelinePanels: [
        {
          ...
          status: "万花筒与未完成须佐能乎",
          dimensions: dims({
            attack: ["楼宇级", "街区级｜天照/须佐能乎", "杀伤强但范围和稳定性低于后期。"],
            defense: ["楼宇级", "街区级｜须佐能乎", "须佐能乎为外覆防御。"],
            movement: ["超音速", "超音速｜瞬身", "高速瞬身和体术。"],
            reaction: ["超音速", "超音速｜写轮眼", "写轮眼预判提升反应。"],
            vitality: ["精锐韧体", "精锐韧体｜咒印/查克拉支撑", "主要靠闪避、防御和意志。"],
            healing: ["无自愈", "中速自愈｜外部治疗", "重伤通常需要外部治疗。"],
            energy: ["楼宇级能量", "街区级能量｜万花筒", "万花筒消耗巨大。"],
            energyRegen: ["中速回能", "中速回能", "续航受瞳力消耗限制。"]
          }),
          notes: "不计入永恒万花筒和轮回眼。"
        },
        {
          ...
          dimensions: dims({
            ...
            healing: ["无自愈", "中速自愈｜外部治疗", "自身恢复仍有限。"],
            energy: ["街区级能量", "国家级能量｜须佐能乎｜争议", "查克拉储量与瞳力消耗很高。"],
            energyRegen: ["中速回能", "快速回能｜外源", "高峰依赖外源或储备。"]
          }),
          notes: "用于区分轮回眼最终战。"
        },
        {
          ...
          dimensions: dims({
            ...
            healing: ["无自愈", "中速自愈｜医疗/外源", "自身恢复不如鸣人，重伤需外部治疗。"],
            energy: ["街区级能量", "大陆级能量｜六道查克拉｜争议", "峰值查克拉来源包含六道与尾兽相关资源。"],
            energyRegen: ["中速回能", "快速回能｜外源/尾兽查克拉", "常态续航有限，高峰依赖外源或储备。"]
          }),
          notes: "当前主面板版本。"
        }
      ],
      ...
      notes: notes({
        penetration: "千鸟/雷切系贯穿、天照黑炎、须佐能乎箭矢与斩击、轮回眼和因陀罗之矢提供高单体穿透与远程压制；天手力是空间换位和命中角度优势，不直接折算为连续移动速度或破坏规模。攻击速度：佐助的千鸟与雷切随持术突进近身贯穿，须佐箭与因陀罗之矢离弦后远程飞行，天照和天手力再按瞳术发动另判。",
        resistance: "须佐能乎提供外覆防御，写轮眼/轮回眼提升预判和幻术对抗；本体肉身不等同须佐硬度，瞳力消耗、查克拉不足、失明风险、封印和空间/精神反制都能绕过优势。",
        sensing: "写轮眼、万花筒和轮回眼提供动作捕捉、查克拉识别、幻术与空间变化判断；视线、瞳力和查克拉消耗是限制。",
        tactics: "战斗分析与连招设计强，擅长用幻术、天手力、须佐和属性变化制造杀局；自尊、复仇心和高消耗峰值会带来风险。",
        special: "写轮眼、万花筒、须佐能乎、轮回眼、天手力、因陀罗之矢。",
        weakness: "轮回眼与完全体须佐消耗巨大，因陀罗之矢依赖外源查克拉储备；被迫长战、被封印、被迫脱离须佐或遇到克制瞳术的情报战时风险上升。",
        setting: "按疾风传最终战轮回眼版本记录；五影会谈万花筒和永恒万花筒阶段已拆入时间线，不计入后续成年期状态。",
