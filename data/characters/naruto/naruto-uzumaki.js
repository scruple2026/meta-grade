(function () {
  ...
  registerCharacters([
    work.character({
      ...
      timelinePanels: [
        {
          ...
          dimensions: dims({
            attack: ["楼宇级", "街区级｜仙术/九尾爆发", "仙术螺旋丸、蛙组手和九尾爆发显著强于早期。"],
            defense: ["楼宇级", "街区级｜仙术/九尾查克拉", "仙术感知和九尾查克拉提高承伤。"],
            ...
            energy: ["楼宇级能量", "街区级能量｜仙术/九尾", "仙术和九尾查克拉提高储量。"],
      ...
      notes: notes({
        penetration: "螺旋丸体系、仙术蛙组手、尾兽玉、求道玉级对抗和六道仙术让鸣人同时具备钝击、查克拉爆破、感知追踪和大规模分身围攻；尾兽玉与六道峰值按争议高峰，不把影分身数量直接换算为单体破坏。攻击速度：鸣人的蛙组手与螺旋丸随近身动作命中，尾兽玉和求道玉则在成形、发射后远程传播；影分身各自出手另计。",
        resistance: "九尾查克拉外衣、仙人模式、六道力量和人柱力生命力提供高承伤与快速恢复；封印、查克拉抽离、幻术/精神干涉、求道玉/阴阳遁和尾兽协同被切断仍是关键风险。",
        sensing: "仙人感知、恶意感知、尾兽协同和六道感知显著强化索敌与预判；特殊感知不直接等同光速反应或全知。",
        tactics: "临场创造力强，善用影分身收集情报、佯攻、组合螺旋丸和仙术/尾兽资源；大量分身和高峰形态需要管理查克拉。",
