(function () {
  ...
  registerCharacters([
    work.character({
      ...
      timelinePanels: [
        {
          ...
          status: "木遁、强体质与医疗能力",
          dimensions: dims({
            attack: ["楼宇级", "街区级｜木遁", "大规模木遁可改变战场，但不计入真数千手峰值。"],
            defense: ["楼宇级", "街区级｜木遁防御", "木遁和体质提高承伤。"],
      ...
      notes: notes({
        penetration: "木遁以压制、封锁、吸收/束缚和大规模结构打击为主，不把封印压制直接换算成更高破坏级。攻击速度：柱间结印并发动木遁后，木结构再生长、伸展和束缚目标；真数千手等大型术式还需形成结构，不能只看本体动作。",
