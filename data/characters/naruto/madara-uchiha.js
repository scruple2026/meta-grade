(function () {
  ...
  registerCharacters([
    work.character({
      ...
      timelinePanels: [
        {
          ...
          dimensions: dims({
            ...
            healing: ["无自愈", "中速自愈｜外部/柱间细胞前不稳定", "终结谷时期不按稳定自愈处理。"],
      ...
      notes: notes({
        penetration: "求道玉、轮回眼术式和完全体须佐有高穿透/高压制能力；无限月读属于大范围精神/瞳术机制，不直接换算为破坏规模。攻击速度：斑的须佐能乎斩击随巨臂动作，求道玉与须佐箭离体后独立移动；轮回眼瞳术和无限月读另有发动、锁定或覆盖条件。",
        resistance: "六道体质、求道玉和恢复力很强；封印、阴阳遁、空间转移和特定六道力量仍可威胁。",
        sensing: "写轮眼、轮回眼、六道感知和战场经验提供动作、查克拉与空间层面的高端识别；不同形态下感知来源需分开看。",
        tactics: "战术与压迫力顶级，善用须佐、木遁、轮回眼和心理威慑拆解战场；高峰依赖十尾/秽土等状态，不是生前常态。",
