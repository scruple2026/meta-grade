(function () {
  ...
  registerCharacters([work.character({
    ...
    sourceQuality: "entry",
    dimensions: dims({
      attack: ["墙级", "房屋级｜降龙十八掌", "以掌力、内力和近战压制为主，峰值按局部强破坏记录。"],
      defense: ["墙级", "房屋级｜内力护体", "高强度内力和体魄支撑硬战。"],
      ...
      energy: ["墙级能量", "房屋级能量｜深厚内力", "总内力可支撑连战，不等同单次大范围破坏。"],
      energyRegen: ["缓慢回能", "中速回能｜调息", "内力需要调息恢复。"]
    }),
    notes: notes({
      penetration: "降龙十八掌以内力掌劲和近身压制见长，穿透强于范围破坏。",
