(function () {
  ...
  registerCharacters([work.character({
    ...
    sourceQuality: "entry",
    dimensions: dims({
      attack: ["墙体级｜不稳定", "房屋级｜六脉神剑", "六脉神剑远程杀伤强，但发挥稳定性需标注。"],
      defense: ["砖块级", "墙体级｜北冥内力/凌波微步", "防御多依赖闪避和内力基础。"],
      ...
      energy: ["墙体级能量｜北冥内力", "房屋级能量｜六脉神剑", "总内力极深，但输出稳定性和命中另算。"],
      energyRegen: ["缓慢回能", "中速回能｜北冥内力", "内力补充依赖吸纳、调息和剧情条件。"]
    }),
    notes: notes({
      penetration: "六脉神剑偏远程指力穿透，范围破坏不高。攻击速度：六脉神剑是由指法发出的远程劲力，载体速度独立于段誉施展凌波微步；出指稳定性与瞄准也影响实际命中。",
