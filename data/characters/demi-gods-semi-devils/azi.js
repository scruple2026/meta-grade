(function () {
  ...
  registerCharacters([work.character({
    ...
    sourceQuality: "entry",
    dimensions: dims({
      attack: ["凡人级", "砖块级｜毒物/星宿手段", "本体武功有限，毒物和诡计更危险。"],
      defense: ["凡人级", "砖块级｜江湖经验", "体魄和防护较低。"],
      movement: ["凡人速", "亚音速｜江湖身法", "有一定江湖身法但不属高手。"],
      reaction: ["凡人速", "凡人速", "实战反应有限。"],
      vitality: ["强化凡体", "强化凡体", "略强于普通人但不高。"],
      healing: ["无自愈", "缓慢自愈｜治疗/休整", "依赖治疗与休整。"],
      energy: ["凡人能量", "砖块级能量｜毒物/小技", "主要资源来自毒物、道具和小规模内力。"],
      energyRegen: ["缓慢回能", "缓慢回能", "需要休整。"]
    }),
    notes: notes({
      penetration: "毒物、暗算和星宿派手段比正面攻击更危险。攻击速度：星宿派掌法与暗算随阿紫近身或投掷动作，毒物真正危险在接触后的生效过程，并非毒性越强就飞得越快。",
