(function () {
  ...
  registerCharacters([work.character({
    ...
    dimensions: dims({
      attack: ["墙级", "楼级｜童话怪物/使魔｜争议", "使魔和童话怪物可形成高威胁，按条件峰值而非常态肉身。"],
      defense: ["墙级", "房屋级｜使魔/结界/工房", "防护依赖使魔、结界和宅邸/工房环境。"],
      ...
      energy: ["房屋级能量", "楼级能量｜童话怪物/工房资源｜争议", "资源上限取决于使魔、工房和准备。"],
      energyRegen: ["中速回能", "快速回能｜工房/准备｜争议", "准备和工房环境提高续航。"]
    }),
    notes: notes({
      penetration: "童话怪物和使魔偏特殊召唤、陷阱和规则化攻击，不等同有珠本体拳脚破坏。",
