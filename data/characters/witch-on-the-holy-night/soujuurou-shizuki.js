(function () {
  ...
  registerCharacters([work.character({
    ...
    dimensions: dims({
      attack: ["砖块级", "墙体级｜山育体术/短时爆发", "异常训练带来高单体肉搏威胁，但不写成大范围破坏。"],
      defense: ["砖块级", "墙体级｜耐痛/山育体魄", "承伤和耐痛强，仍是人体结构。"],
      ...
      energy: ["凡人能量", "砖块级能量｜短时爆发", "主要是体力和短时爆发，不具备魔术能量池。"],
      energyRegen: ["缓慢回能", "缓慢回能｜休整", "体力恢复依赖休息。"]
    }),
    notes: notes({
      penetration: "山育体术偏近身要害破坏、关节和瞬间爆发，不等同范围攻击。攻击速度：山育体术依靠近身接战、关节攻击和瞬间发力，没有脱离身体独立飞行的攻击载体。",
