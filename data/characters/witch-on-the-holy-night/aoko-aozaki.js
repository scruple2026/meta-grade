(function () {
  ...
  registerCharacters([work.character({
    ...
    dimensions: dims({
      attack: ["墙体级", "楼宇级｜魔弹/第五魔法｜争议", "本篇魔术火力强；第五魔法按高风险条件峰值，不直接泛化为常态破坏。"],
      defense: ["墙体级", "房屋级｜强化/魔术防护", "本体仍是人类魔术师，防护依赖强化和术式。"],
      ...
      energy: ["房屋级能量", "楼宇级能量｜魔法使/第五魔法｜争议", "魔力资源和第五魔法相关峰值高风险记录。"],
      energyRegen: ["中速回能", "快速回能｜魔术回路/准备｜争议", "续航依赖魔术回路、状态和准备。"]
    }),
    notes: notes({
      penetration: "魔弹和第五魔法相关机制既有破坏也有规则/时间性质，不把魔法使称号直接换算为更高破坏档。攻击速度：魔弹有发射与传播过程，第五魔法相关时间机制未必存在常规弹道，两者不能因同属魔术而共用速度判断。",
