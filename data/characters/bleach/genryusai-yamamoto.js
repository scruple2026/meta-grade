(function () {
  ...
  registerCharacters([
    work.character({
      ...
      timelinePanels: [
        {
          ...
          dimensions: dims({
            ...
            healing: ["缓慢自愈", "中速自愈｜灵体恢复", "无强再生，依赖灵体恢复或治疗。"],
      ...
      notes: notes({
        penetration: "残火太刀兼具高温、斩击和灵压压制；高温环境影响不直接等同持续全球破坏。攻击速度：残火太刀的刀击随山本近身挥斩，火焰与高温影响可向周围扩展；环境升温不等于每一道斩击拥有同一传播速度。",
