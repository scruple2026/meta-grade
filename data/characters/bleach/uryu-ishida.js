  ...
  registerCharacters([
    work.character({
      ...
      dimensions: dims({
        ...
        healing: ["缓慢自愈", "中速自愈｜灵子恢复", "无稳定高速再生。"],
        energy: ["街区级能量", "城市级能量｜灭却师能力｜争议", "灵子操控输出高。"],
        energyRegen: ["中速回能", "快速回能｜灵子吸收", "可利用环境灵子恢复。"]
      }),
      notes: notes({
        penetration: "灵子弓、灭却师箭、飞廉脚位移和完圣体输出提供远程高穿透；圣文字相关反转/转移效果属于机制优势，需要按具体阶段和触发条件判断。攻击速度：灭却师箭离弦后具有独立飞行速度，连射还受拉弓、灵子成形与瞄准节奏限制，不能用飞廉脚移动档直接替代。",
        resistance: "灭却师灵子操控和防御术提升承伤，飞廉脚可避免被近战锁死；本体没有死神式灵体再生，面对高灵压压制、封锁灵子、近身肉搏和信息差仍危险。",
        sensing: "灭却师灵子感知、飞廉脚战斗经验和高端灵压环境判断支撑远程锁定；圣文字条件仍需按已知资料保守。",
        tactics: "远程射击、灵子操控和阵营博弈判断较强，擅长利用距离和装备；近战承伤与同阵营情报差限制稳定性。",
