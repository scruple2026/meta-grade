(function () {
  ...
  registerCharacters([
    work.character({
      ...
      notes: notes({
        penetration: "袖白雪通过低温、冻结和斩魄刀技压制目标，白霞罚可把自身周边温度降到极端低温并冻结范围内敌人；冰冻属于状态压制，不直接等同爆炸破坏。攻击速度：袖白雪剑技随露琪亚挥刀，白霞罚则需解放后让低温覆盖周边；冻结范围的形成不能仅凭冰雪视觉效果换算弹速。",
