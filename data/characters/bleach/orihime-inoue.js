(function () {
  ...
  registerCharacters([
    work.character({
      ...
      dimensions: dims({
        attack: ["砖块级", "墙体级｜孤天斩盾", "攻击能力有限，核心价值在防护与拒绝。"],
        ...
        energyRegen: ["中速回能", "快速回能｜灵力恢复", "连续治疗和防护会消耗。"]
      }),
      notes: notes({
        penetration: "孤天斩盾具备有限切割/排斥攻击，但织姬核心不是输出；事象拒绝可以治疗、回溯伤害结果和展开屏障，属于支援/防御权能，不抬攻击主档。攻击速度：孤天斩盾需由六花展开并飞向目标，三天结盾与双天归盾则先形成屏障或作用区；这些发动过程不随织姬奔跑同步。",
        resistance: "三天结盾可挡下远强于织姬肉身的攻击，双天归盾能拒绝伤害结果并治疗；本体仍接近人类，屏障反应、精神状态和六花可用性决定防御上限。",
        sensing: "灵力感知和六花反馈帮助她发现伤势、攻击方向和需要保护的对象；本体不是高速侦查型战士。",
        tactics: "支援判断强，擅长把屏障、治疗和队友站位结合；杀伤薄弱，被分割或精神压制时决策空间很小。",
