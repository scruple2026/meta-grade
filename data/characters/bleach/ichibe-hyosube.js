  ...
  registerCharacters([
    work.character({
      ...
      dimensions: dims({
        ...
        healing: ["中速自愈", "极速自愈｜名字复归条件", "复归与名字机制相关，不能视为无条件再生。"],
        energy: ["城市级能量", "大陆级能量｜真打一文字｜争议", "灵压和墨/名字权能储量极高。"],
        energyRegen: ["快速回能", "快速回能｜灵压恢复", "权能和灵压仍有发动条件。"]
      }),
      notes: notes({
        penetration: "一文字的黑与名字剥夺属于规则/概念性质权能，不直接换算为纯破坏穿透。攻击速度：毛笔挥击与泼墨有实际出手和覆盖过程，名字剥夺在墨染条件满足后生效；概念效果本身不等于无前摇的无限速攻击。",
        resistance: "名字机制提供特殊复归条件；全知全能、未来改写和更高规则干涉可绕过常规优势。",
        sensing: "零番队首领经验、灵王宫权限和名字/黑相关权能让他能识别高端灵压与概念层目标；未来改写仍可形成风险。",
        tactics: "规则运用和战场控制老练，擅长用墨、改名和距离控制逐步剥夺对手能力；权能命中条件和未来干涉是关键变数。",
        special: "一文字、真打一文字、黑、名字剥夺、改名、灵王宫零番队首领权限。",
        weakness: "名字权能依赖命中、墨和规则生效条件；面对未来改写类能力存在明显风险。",
        setting: "按千年血战篇真打一文字状态记录；名字剥夺、改名和复归机制写入特殊权能，不把零番队首领身份直接抬级。",
