(function () {
  ...
  registerCharacters([work.character({
    ...
    dimensions: dims({
        attack: ["砖级｜魔术师肉身", "街区级｜圣杯/Beast关联/根源接续｜外源｜争议", "日常肉身不强；峰值来自根源、圣杯和Beast相关机制，需标外源与争议。"],
        ...
        energy: ["砖级能量｜魔术师", "街区级能量｜圣杯/Beast关联/根源接续｜外源｜争议", "能量池和支配力主要来自高风险机制，不等同常态体力。"],
        energyRegen: ["缓慢回能", "快速回能｜圣杯/外源条件｜争议", "峰值回能依赖圣杯或外部机制。"]
      }),
    notes: notes({
        penetration: "根源接续、圣杯和Beast关联更偏规则/仪式/支配机制，不把称号直接换成物理破坏档。",
