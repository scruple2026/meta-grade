(function () {
  ...
  registerCharacters([work.character({
    ...
    dimensions: dims({
        attack: ["凡人级", "砖级｜魔术/令咒支援｜条件", "本体输出有限，从者输出不并入御主本人。"],
        defense: ["凡人级", "砖级｜魔术防护/礼装｜条件", "防御依赖基础魔术、礼装和Saber保护。"],
        ...
        energy: ["凡人能量", "砖级能量｜魔术回路/令咒", "魔力与令咒能支援从者，但不等同自身高输出。"],
        energyRegen: ["缓慢回能", "缓慢回能｜休整/供魔", "供魔和恢复需要时间。"]
      }),
    notes: notes({
        penetration: "本体攻击依赖基础魔术、礼装或令咒支援；Saber宝具不并入她的主面板。",
