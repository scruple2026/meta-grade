(function () {
  ...
  registerCharacters([work.character({
    ...
    dimensions: dims({
      attack: ["楼宇级", "街区级｜Excalibur Proto｜条件｜争议", "常态近战为从者级白刃战；圣剑真名解放作为条件峰值。"],
      defense: ["楼宇级", "街区级｜魔力放出/圣剑防护｜条件", "从者灵基、铠甲和魔力放出支撑高承伤，但不按无条件概念防御处理。"],
      movement: ["音速", "超音速｜魔力放出", "按高速从者近战机动记录。"],
      reaction: ["音速", "超音速｜直感/从者战", "剑术经验、直感和从者身体支撑高速应对。"],
      vitality: ["楼宇级生命阈值", "街区级生命阈值｜供魔充足/从者灵基", "生命体量取决于灵基、供魔和伤势性质。"],
      healing: ["中速自愈｜灵体/供魔", "快速自愈｜供魔充足", "恢复依赖灵基和供魔条件。"],
      energy: ["楼宇级能量", "街区级能量｜圣剑/供魔", "魔力与宝具资源强，但不按无限能量处理。"],
      energyRegen: ["中速回能", "快速回能｜供魔充足", "供魔质量直接影响续航和宝具使用。"]
    }),
    notes: notes({
      penetration: "圣剑、魔力放出和从者级剑术可造成高单体压制；Excalibur Proto作为条件光炮峰值记录。攻击速度：亚瑟的圣剑挥击随近身剑术出手；Excalibur Proto须另计真名解放与光炮发射，不能用白刃连击速度代替。",
