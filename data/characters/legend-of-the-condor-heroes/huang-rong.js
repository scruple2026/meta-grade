(function () {
  ...
  registerCharacters([work.character({
    ...
    sourceQuality: "entry",
    dimensions: dims({
      attack: ["砖块级", "墙体级｜打狗棒法/桃花岛武学", "个人输出不靠大范围破坏，峰值来自棒法、掌法和机关应对。"],
      defense: ["砖块级", "墙体级｜轻功/招架", "防御主要依赖身法、招式和临场规避。"],
      ...
      energy: ["砖块级能量", "墙体级能量｜内力/棒法", "内力资源按金庸高手处理。"],
      energyRegen: ["缓慢回能", "缓慢回能｜调息", "需调息恢复。"]
    }),
    notes: notes({
      penetration: "打狗棒法、桃花岛武学和机关巧计偏技巧、破绽利用和单体压制。攻击速度：黄蓉的打狗棒法与桃花岛武学随近身步法和兵器动作命中，机关巧计则要先布置或发射后按自身结构运作。",
