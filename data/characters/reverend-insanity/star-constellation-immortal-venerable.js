  ...
  registerCharacters([
    work.character({
      ...
      dimensions: dims({
        ...
        movement: ["超光速｜星道杀招｜争议", "有限宇宙尺度超光速｜星宿棋盘/布置调度｜非纯速度｜争议", "星道调度和布置能力不等同无条件无限速。"],
        reaction: ["超光速｜智道推演/尊者斗法｜争议", "有限宇宙尺度超光速｜智道预判/天庭布置｜争议", "智道推演提升应对，但谋算优势不直接替代身体反应。"],
      ...
      notes: notes({
        penetration: "智道推演、星道杀招、星宿棋盘和天庭布置提供高层级压制；预判和布局不直接换算为大范围破坏。",
