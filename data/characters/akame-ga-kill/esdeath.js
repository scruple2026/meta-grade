(function () {
  ...
  registerCharacters([work.character({
    ...
    dimensions: dims({
        attack: ["楼级｜冰系帝具", "街区级｜大范围冰系帝具/摩珂钵特摩｜争议", "常态可用冰枪、冰墙、冰爆等战斗输出；峰值按大范围冰系控场保守记录。"],
        defense: ["墙级｜冰盾/冰甲", "楼级｜大范围冰墙/防护｜帝具", "防御峰值来自冰构造物和控场，不代表肉身硬度。"],
        movement: ["亚音速", "音速｜战斗机动/冰面位移", "高端近战与冰面机动支撑高速战斗，但不把停时写成移动速度。"],
        reaction: ["亚音速", "音速｜将军级战斗经验", "反应来自实战经验和帝具战斗，不把时间冻结等同本体反应。"],
        vitality: ["强化凡体", "楼级生命阈值｜帝具/高耐久", "本体耐久和战斗续航明显高于普通人，但生命体量与冰盾防御分开。"],
        healing: ["无自愈", "缓慢自愈｜休整/医疗", "缺少稳定自愈表现，恢复主要依赖休整。"],
        energy: ["楼级能量", "街区级能量｜冰系帝具/大范围控场", "恶魔之粹提供大量冰系输出资源；总量不自动反推每一击攻击规模。"],
        energyRegen: ["中速回能", "快速回能｜帝具持续释放", "可以连续制造冰，但大范围招式和时间冻结仍有使用窗口。"]
      }),
    notes: notes({
        penetration: "冰枪、冰刃、冰爆、冻结和大范围控场兼具杀伤与限制；时间冻结是特殊权能，不作为速度档。",
