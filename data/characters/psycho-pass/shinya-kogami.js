(function () {
  ...
  registerCharacters([
    work.character({
      ...
      sourceQuality: "entry",
      dimensions: dims({
        attack: ["砖级", "墙级｜Dominator/枪械/爆破", "优秀格斗与警用武装，Dominator授权时火力更高。"],
        defense: ["凡人级", "砖级｜防具/格挡", "肉身仍是人类，靠训练和装备承伤。"],
        movement: ["凡人速", "亚音速｜格斗/追踪", "受训执行官机动。"],
        reaction: ["凡人速", "亚音速｜格斗/刑事直觉", "近战和追踪反应强。"],
        vitality: ["强化凡体", "精锐韧体", "高训练度和承压能力。"],
        healing: ["无自愈", "缓慢自愈｜体魄", "自然恢复。"],
        energy: ["砖级能量｜体能/武器", "墙级能量｜Dominator/爆破", "资源来自体能、武器和公安装备。"],
        energyRegen: ["中速回能", "缓慢回能｜补给", "弹药和装备需要补给。"]
      }),
      notes: notes({
        penetration: "Dominator、枪械、爆破、格斗和刑事追踪结合。",
