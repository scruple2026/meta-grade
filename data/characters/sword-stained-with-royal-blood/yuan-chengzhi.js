(function () {
  ...
  registerCharacters([work.character({
    ...
    dimensions: dims({
      attack: ["墙级", "房屋级｜金蛇剑法/混元功", "主线后期内力与剑法已属本作高端，仍按局部武侠破坏处理。"],
      defense: ["墙级", "房屋级｜内力/招架", "内力、身法和兵刃招架支撑承压。"],
      ...
      energy: ["墙级能量", "房屋级能量｜混元功/金蛇传承", "总内力和体力属本作高端，但不反推大范围攻击。"],
      energyRegen: ["缓慢回能", "中速回能｜调息", "内力恢复依赖调息。"]
    }),
    notes: notes({
      penetration: "金蛇剑法、华山武学和兵刃技巧偏单体杀伤、破招和穿刺，不等同大范围爆破。",
