(function () {
  ...
  registerCharacters([
    work.character({
      ...
      dimensions: dims({
        attack: ["有限宇宙级｜无限大道攻击用途｜宇宙论依赖｜争议", "有限宇宙级｜无限世界输出｜总量/结构依赖｜争议", "终章攻击可按高端宇宙论争议档记录；没有把防御无限直接反推为攻击无限。"],
        defense: ["有限宇宙级｜无限大道防线｜宇宙论依赖｜争议", "无限级｜无限世界防线｜宇宙论依赖｜争议", "代表防御能级的无限样例；防御来源是无限世界/无限大道结构性承接与化解，不是单纯肉身硬度。"],
        movement: ["有限宇宙尺度超光速｜终章机动｜宇宙论依赖｜争议", "有限宇宙尺度超光速｜无限世界调度｜非纯速度｜争议", "终章机动和世界结构调度极高，但大量表现带结构转移性质。"],
        reaction: ["有限宇宙尺度超光速｜高端交锋｜宇宙论依赖｜争议", "有限宇宙尺度超光速｜无限大道信息处理｜非纯反应｜争议", "无限大道的信息处理优势极强，但不直接写成无限反应。"],
        vitality: ["有限宇宙级生命结构｜人间界/无限世界关联｜争议", "有限宇宙级生命结构｜无限大道关联｜非无限代表项｜争议", "生命与世界结构关联很深，但防线无限不等于死亡条件无限。"],
        healing: ["极速自愈｜世界结构修复｜条件｜争议", "瞬愈｜无限世界重构｜条件｜争议", "恢复按结构性修复记录，和防御能级分开。"],
        energy: ["有限宇宙级能量｜无限大道资源｜总量非单击｜争议", "有限宇宙级能量｜无限世界资源池｜总量/结构依赖｜争议", "能量池很高，但本条仍不把无限大道名称直接写成能量总量无限。"],
        energyRegen: ["极速回能｜体系循环｜争议", "极速回能｜无限世界循环｜非无限尺度｜争议", "补能来自体系循环和结构调度，不写成无限回能。"]
      }),
      notes: notes({
        penetration: "攻击补为有限宇宙级争议档；无限大道的进攻和改写效果应另做逐章证据复核，不能由防御代表项自动抬升到无限。攻击速度：江离终盘的神通与无限大道改写需按具体章节中的起手、作用对象和生效方式分别判断；当前文件没有足够材料把有限宇宙级攻击档换算成统一出手或传播速度。",
