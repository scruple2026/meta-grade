    ...
    work.character({
      ...
      timelinePanels: [
        ...
        },
        {
          ...
          dimensions: dims({
            attack: ["星系级｜神之气高端｜争议", "有限宇宙级｜自在极意｜宇宙论依赖｜争议", "高端形态可与龙珠超顶级敌人交锋；有限宇宙级只按作品宇宙论争议峰值记录。"],
            defense: ["星系级｜神之气防御｜争议", "有限宇宙级｜自在极意防御｜宇宙论依赖｜争议", "气防御、自在极意闪避和承伤共同构成高端防护；不等于无限防御。"],
            ...
            vitality: ["星系级生命结构｜气防御｜争议", "有限宇宙级生命结构｜自在极意｜争议", "赛亚人体质、气防御和高端形态共同提高生命阈值；不按无限生命处理。"],
            healing: ["无自愈", "中速自愈｜仙豆/外部", "自身没有稳定再生，常需外部恢复。"],
            energy: ["星系级能量｜神之气｜争议", "有限宇宙级能量｜自在极意｜争议", "神之气总量极高；输出、总量和形态维持分开。"],
      ...
      notes: notes({
        penetration: "龟派气功、神之气爆发、自在极意近战和高端气功以高密度能量与格斗压制为主；瞬间移动只改变位置，不提高攻击能级。",
