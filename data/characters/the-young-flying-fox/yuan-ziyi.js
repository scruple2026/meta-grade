(function () {
  ...
  registerCharacters([work.character({
    ...
    dimensions: dims({
      attack: ["砖块级", "墙体级｜兵刃/门派武学", "个人武功强于普通江湖人物，但不按飞狐系列最顶级处理。"],
      defense: ["砖块级", "墙体级｜招架/轻功", "主要靠身法、招架和经验承压。"],
      ...
      energy: ["墙体级能量", "墙体级能量｜门派武学", "内力资源按飞狐系列武林高手处理。"],
      energyRegen: ["缓慢回能", "中速回能｜调息", "内力恢复依赖调息。"]
    }),
    notes: notes({
      penetration: "兵刃和门派武学偏单体杀伤、点到为止和破招，不等同范围破坏。攻击速度：门派武学和兵刃攻击以贴身招式、点到为止或破招为主，现有描述没有可单列的远程高速载体。",
