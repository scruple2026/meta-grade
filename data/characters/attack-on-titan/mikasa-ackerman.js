(function () {
  ...
  registerCharacters([
    work.character({
      ...
      dimensions: dims({
        attack: ["砖块级", "墙体级｜雷枪｜立体机动", "常规刀刃针对巨人弱点；雷枪可造成局部爆破。"],
        defense: ["凡人级", "墙体级｜机动规避", "本体仍是人类，峰值靠立体机动、护具和规避。"],
        ...
        energy: ["凡人能量", "墙体级能量｜装备", "输出依赖体力、刀刃和雷枪装备。"],
        energyRegen: ["中速回能", "中速回能", "依赖体力恢复和补给。"]
      }),
      notes: notes({
        penetration: "对巨人后颈有体系弱点针对；雷枪有局部爆破穿透。攻击速度：双刀近斩跟随立体机动切入，雷枪发射后是独立弹体且需要瞄准与装填，不能用米卡莎奔跑速度代替。",
        resistance: "无巨人级肉体抗性，面对爆炸和枪械仍脆弱。",
        sensing: "阿克曼觉醒、立体机动经验和对杀意/轨迹的读取让她近战预判突出；侦查范围仍依赖视野和装备。",
        tactics: "单兵处置效率极高，擅长快速切入后颈、救援和护卫；装备、瓦斯和锚点不足会限制战术选择。",
        special: "阿克曼战斗本能、立体机动、对巨人斩杀经验。",
        weakness: "高度依赖装备、瓦斯、刀刃和战场锚点。",
        setting: "按最终章成熟调查兵三笠记录；阿克曼战斗本能、雷枪和立体机动装备合并为成熟调查兵口径。",
