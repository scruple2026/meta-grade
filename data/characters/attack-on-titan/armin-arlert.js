(function () {
  ...
  registerCharacters([
    work.character({
      ...
      timelinePanels: [
        ...
        },
        {
          ...
          dimensions: dims({
            ...
            defense: ["凡人级", "楼宇级｜超大型巨人体", "人类本体脆弱，巨人体承伤高但行动迟缓。"],
            movement: ["凡人速", "亚音速｜立体机动", "人类状态依赖立体机动；超大型巨人移动慢。"],
            reaction: ["凡人速", "亚音速", "战术判断强，身体反应不按顶级阿克曼处理。"],
            vitality: ["强化凡体", "楼宇级生命阈值｜巨人体", "巨人体可承受大量伤害，本体仍是关键。"],
      ...
      notes: notes({
        penetration: "超大型巨人爆风以范围热冲击为主，不是精准穿透。攻击速度：超大型巨人的爆炸与热浪在变身点展开，重点是变身前置和范围扩散，不是阿尔敏本体挥击或奔跑速度。",
