(function () {
  ...
  registerCharacters([
    work.character({
      ...
      dimensions: dims({
        attack: ["楼宇级", "街区级｜投石轰炸", "兽之巨人的远程投掷可造成炮击级区域破坏。"],
        defense: ["楼宇级", "楼宇级｜巨人体", "巨人体承伤高，但被利威尔等针对后颈可快速失能。"],
        movement: ["凡人速", "亚音速｜巨人体", "移动速度一般，远程火力和控制更突出。"],
        reaction: ["凡人速", "亚音速", "战场判断强，近战反应不及顶级阿克曼。"],
        vitality: ["楼宇级生命阈值｜巨人体｜特殊生命结构", "楼宇级生命阈值｜巨人体", "巨人继承者生命力和再生强于人类。"],
        healing: ["快速自愈", "极速自愈｜巨人之力｜王血相关", "可依巨人之力和特殊机制从重伤恢复。"],
        energy: ["楼宇级能量", "街区级能量｜投石持续火力", "以巨人体体力、投掷和王血巨人控制体现。"],
        energyRegen: ["中速回能", "快速回能｜巨人之力", "恢复和多次巨人化仍受体力限制。"]
      }),
      notes: notes({
        penetration: "投石具备远程炮击效果，对阵地和舰队有强压制。攻击速度：投石离手后以独立弹道高速飞行，明显不同于兽之巨人的奔跑；连续炮击还受取材、握碎与再次投掷节奏限制。",
