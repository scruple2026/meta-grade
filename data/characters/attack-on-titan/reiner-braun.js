(function () {
  ...
  registerCharacters([
    work.character({
      ...
      dimensions: dims({
        attack: ["楼宇级", "街区级｜巨人冲撞｜硬质化", "铠之巨人冲撞和硬质化可破坏城墙局部与建筑群。"],
        defense: ["楼宇级", "街区级｜铠甲硬质化", "硬质化铠甲可抗常规炮火和巨人攻击，但雷枪等装备可破防。"],
        movement: ["亚音速", "亚音速｜巨人体冲刺", "巨人体冲刺强但不按音速处理。"],
        reaction: ["凡人速", "亚音速", "战士训练和巨人近战经验优秀。"],
        vitality: ["楼宇级生命阈值｜巨人体｜特殊生命结构", "街区级生命阈值｜巨人体", "巨人体和继承者再生显著提升生存力。"],
        healing: ["快速自愈", "快速自愈｜巨人之力", "巨人之力可修复重伤，受体力和意志影响。"],
        energy: ["楼宇级能量", "街区级能量｜巨人之力", "以巨人体体力、硬质化和再生资源体现。"],
        energyRegen: ["中速回能", "快速回能｜巨人之力", "可恢复但不能无限连续巨人化。"]
      }),
      notes: notes({
        penetration: "硬质化拳击和冲撞适合破墙破阵，精准穿透有限。攻击速度：硬质化拳击和冲撞都由铠之巨人巨体直接完成，出手受庞大肢体转向与接战距离影响，没有独立远程弹速。",
        resistance: "对常规刀刃、冲击有高抗性；雷枪、反巨人炮和后颈攻击是弱点。",
        sensing: "战士训练和巨人化经验提供对立体机动、雷枪和近战威胁的基础识别；精神波动会影响判断。",
        tactics: "正面防御和任务执行经验丰富，擅长用铠甲承压保护队友或争取时间；心理负担和后颈弱点会被针对。",
