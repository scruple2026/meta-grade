(function () {
  ...
  registerCharacters([
    work.character({
      ...
      dimensions: dims({
        attack: ["砖级", "墙级｜雷枪｜高速斩击", "常规斩击针对巨人弱点，雷枪提供局部爆破。"],
        defense: ["凡人级", "墙级｜机动规避", "本体仍为人类，防御来自规避、经验和装备。"],
        ...
        energy: ["凡人能量", "墙级能量｜装备", "输出依赖装备、爆雷和体力。"],
        energyRegen: ["常规回能", "常规回能", "需要补给和休养。"]
      }),
      notes: notes({
        penetration: "对巨人后颈、眼部和关节有极强弱点打击能力。",
