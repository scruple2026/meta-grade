(function () {
  ...
  registerCharacters([work.character({
    ...
    sourceQuality: "entry",
    dimensions: dims({
      attack: ["墙体级", "房屋级｜吸星大法/掌力", "正面掌力和吸内力威胁高，范围仍按局部破坏处理。"],
      defense: ["墙体级", "房屋级｜内力/经验", "深厚内力和老练经验提高防护。"],
      ...
      energy: ["墙体级能量", "房屋级能量｜吸星大法", "可通过吸取内力扩充资源，需命中和条件。"],
      energyRegen: ["缓慢回能", "快速回能｜吸星大法｜条件", "只有成功吸取内力时才快速补能。"]
    }),
    notes: notes({
      penetration: "吸星大法偏内力吸取、控制和削弱对手，不等同纯破坏规模。攻击速度：吸星大法需要近身接触和内力运转，掌指攻击也以接战出手为主，不存在随移动换算的远程弹体。",
