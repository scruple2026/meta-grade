(function () {
  ...
  registerCharacters([work.character({
    ...
    sourceQuality: "entry",
    dimensions: dims({
      attack: ["砖块级", "墙体级｜华山剑法/坐斗田伯光", "早期以华山剑法、胆识和临场应变为主。"],
      defense: ["砖块级", "墙体级｜江湖身手", "金盆洗手期仍会被伤病和强敌压制。"],
      ...
      energy: ["砖块级能量", "墙体级能量｜内力/剑法", "早期内力不按后期顶级状态处理。"],
      energyRegen: ["缓慢回能", "缓慢回能｜调息", "内力需调息恢复。"]
    }),
    notes: notes({
      penetration: "早期剑法偏招式和破绽利用，不等同后期独孤九剑的稳定破招上限。攻击速度：剑击依赖观察破绽后的近身出手，独孤九剑的破招优势体现为时机与路线，不是远程载体或固定速度档。",
