(function () {
  ...
  registerCharacters([work.character({
    ...
    sourceQuality: "entry",
    dimensions: dims({
      attack: ["墙级", "房屋级｜葵花宝典/绣花针", "单体高速穿刺与近战压制极强，但不按大范围破坏处理。"],
      defense: ["砖级", "墙级｜高速规避/招架", "本体防御不靠硬抗，主要依赖速度、招架和先手。"],
      ...
      energy: ["墙级能量", "房屋级能量｜葵花宝典", "内力资源和高速输出按顶级武者记录。"],
      energyRegen: ["缓慢回能", "中速回能｜调息", "回气仍需内功调息。"]
    }),
    notes: notes({
      penetration: "绣花针和葵花宝典偏高速穿刺、点穴和先手压制，范围破坏很低。",
