(function () {
  ...
  registerCharacters([work.character({
    ...
    sourceQuality: "entry",
    dimensions: dims({
      attack: ["砖级", "墙级｜琴音/武功/暗器", "正面武功不按顶级教主处理，峰值来自武功、暗器和情境控制。"],
      defense: ["砖级", "墙级｜轻功/招架", "本体仍是武侠人体，依赖身法和护卫网络。"],
      movement: ["亚音速", "亚音速｜轻功", "具备江湖高手身法。"],
      reaction: ["亚音速", "亚音速｜机变", "判断和临场应对强。"],
      vitality: ["强化凡体", "精锐韧体｜内功", "人体结构，内功提高续战。"],
      healing: ["缓慢自愈", "缓慢自愈｜调息", "恢复依赖调息和休养。"],
      energy: ["砖级能量", "墙级能量｜内力/资源", "个人内力和可调动资源分开记录。"],
      energyRegen: ["缓慢回能", "缓慢回能｜调息", "需调息恢复。"]
    }),
    notes: notes({
      penetration: "个人攻击偏兵刃、暗器、琴音扰敌和情境压制，不是正面爆破型。",
