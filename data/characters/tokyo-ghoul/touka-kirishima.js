(function () {
  ...
  registerCharacters([
    work.character({
      ...
      sourceQuality: "entry",
      dimensions: dims({
        attack: ["墙体级", "楼宇级｜羽赫爆射", "羽赫高速晶体射击和近战突袭。"],
        defense: ["墙体级", "墙体级｜赫子防御", "承伤依赖喰种体质与机动规避。"],
        ...
        energy: ["墙体级能量", "楼宇级能量｜羽赫", "羽赫连续射击消耗较快。"],
        energyRegen: ["快速回能", "快速回能｜进食/恢复", "需要进食和休整补充。"]
      }),
      notes: notes({
        penetration: "羽赫晶体适合高速穿刺、牵制和爆发突袭，持续火力不如重型赫子。攻击速度：羽赫晶体脱离身体后有独立飞行过程，爆发突袭包含本体接近；晶体连射与移动速度不是同一项。",
