(function () {
  ...
  registerCharacters([
    work.character({
      ...
      sourceQuality: "entry",
      dimensions: dims({
        attack: ["墙级", "楼级｜库因克/鸣神/IXA", "高端库因克和极高技巧带来对喰种的强穿透。"],
        defense: ["墙级", "楼级｜库因克防御/技量", "防御主要来自装备、预判和压制距离。"],
        ...
        energy: ["砖级能量", "楼级能量｜库因克电击/装备", "资源来自库因克与体力。"],
        energyRegen: ["无回能", "中速回能｜装备/体力", "库因克和体力需要维护恢复。"]
      }),
      notes: notes({
        penetration: "IXA、鸣神等库因克具备高速刺击、电击和对赫子破坏能力，对喰种有强克制。",
