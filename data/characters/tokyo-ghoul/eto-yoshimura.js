(function () {
  ...
  registerCharacters([
    work.character({
      ...
      sourceQuality: "entry",
      dimensions: dims({
        attack: ["楼宇级", "街区级｜赫者/独眼之枭", "独眼之枭形态可造成大范围近战与赫子破坏。"],
        defense: ["楼宇级", "街区级｜赫者甲壳/再生", "赫者外壳和再生极强。"],
        movement: ["亚音速", "音速｜赫者机动", "大型赫者仍可高速压制。"],
        reaction: ["亚音速", "音速｜经验", "可与特等搜查官级战斗周旋。"],
        vitality: ["楼宇级生命阈值", "街区级生命阈值｜赫者/再生", "半人半喰种和赫者状态带来高生命阈值。"],
        healing: ["快速自愈｜喰种再生", "极速自愈｜赫者｜争议", "再生强但可被高端库因克和持续伤害压制。"],
        energy: ["楼宇级能量", "街区级能量｜赫者", "赫者形态与赫子输出消耗巨大。"],
        energyRegen: ["快速回能", "快速回能｜进食/恢复", "高峰不能无限维持。"]
      }),
      notes: notes({
        penetration: "独眼之枭赫者形态以巨体、赫子群、撕裂和压制为主。攻击速度：巨型赫者肢体与赫子群要区分本体挥击、多个赫子伸展和围压节奏，巨体覆盖范围不代表瞬间命中。",
