(function () {
  ...
  registerCharacters([
    work.character({
      ...
      dimensions: dims({
        attack: ["墙体级", "楼宇级｜鳞赫/蜈蚣", "鳞赫和半赫者状态具强近战穿刺与破坏。"],
        defense: ["墙体级", "楼宇级｜赫子/再生", "喰种体质和赫子提高防御，但本体仍可被库因克重创。"],
        movement: ["亚音速", "音速｜喰种机动", "高阶喰种近战机动。"],
        reaction: ["亚音速", "音速｜战斗本能", "后期适应高速喰种与搜查官战斗。"],
        vitality: ["强化凡体", "楼宇级生命阈值｜再生/半赫者", "喰种再生与半赫者状态显著提高续战。"],
        healing: ["快速自愈｜喰种再生", "极速自愈｜半赫者｜争议", "再生强但受饥饿、RC 抑制和重伤限制。"],
        energy: ["墙体级能量", "楼宇级能量｜赫子", "赫子展开和再生消耗 RC 细胞与体力。"],
