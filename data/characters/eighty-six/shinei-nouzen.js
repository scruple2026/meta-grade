(function () {
  ...
  registerCharacters([
    work.character({
      ...
      sourceQuality: "entry",
      dimensions: dims({
        attack: ["凡人级", "墙体级｜Juggernaut火炮｜装备", "本体是少年兵，战斗输出来自Juggernaut机体和火炮。"],
        defense: ["凡人级", "墙体级｜Juggernaut装甲｜装备", "个人肉身脆弱，机体提供有限战场防护。"],
        ...
        healing: ["无自愈", "无自愈", "无自愈。"],
        energy: ["凡人能量", "墙体级能量｜弹药/机体", "战斗资源来自机体、弹药、燃料和整备。"],
        energyRegen: ["中速回能", "缓慢回能｜整备补给", "战斗资源需要补给和维修。"]
      }),
      notes: notes({
        penetration: "以Juggernaut主炮、机枪、机动包抄和对Legion弱点打击为主。攻击速度：辛的主炮和机枪弹离膛后独立飞行，近距弱点射击虽常与高速机动衔接，仍需转向、瞄准和开火窗口。",
