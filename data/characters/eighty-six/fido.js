(function () {
  ...
  registerCharacters([
    work.character({
      ...
      sourceQuality: "entry",
      dimensions: dims({
        attack: ["凡人级", "砖块级｜机械冲撞/工具", "本职是支援与搬运，直接攻击有限。"],
        defense: ["砖块级", "墙体级｜机械结构", "支援机结构强于普通生物肉身，但不是主战机体。"],
        ...
        energy: ["砖块级能量｜电源/机械", "墙体级能量｜补给物资", "主要携带补给与设备资源。"],
        energyRegen: ["缓慢回能｜充电/整备", "缓慢回能｜充电/整备", "需要维修、充电和补给。"]
      }),
      notes: notes({
        penetration: "可用机械结构、工具和搬运支援造成有限物理威胁，但不是主攻单位。攻击速度：菲多主要用机械臂、工具和搬运动作支援，只有有限近距物理威胁，未装备可据此认定的高速主炮或连射武器。",
