(function () {
  ...
  registerCharacters([
    work.character({
      ...
      sourceQuality: "entry",
      dimensions: dims({
        attack: ["凡人级", "墙体级｜迎击炮/远程指挥｜外部", "个人无高输出；峰值来自指挥链、迎击炮和战场火力调度。"],
        ...
        energy: ["凡人能量", "墙体级能量｜指挥资源/外部火力", "个人资源有限，战场峰值依赖外部炮兵与通信链。"],
        energyRegen: ["中速回能", "缓慢回能｜补给/指挥链", "本人体力恢复普通；外部火力需要弹药和授权条件。"]
      }),
      notes: notes({
        penetration: "主要威胁来自远程指挥、炮火协同和战场情报，不是个人武器输出。攻击速度：蕾娜本人没有同档直接攻击，炮击由远端单位接令、校射后发射；通信和火力调度前置远比她的个人动作更关键。",
