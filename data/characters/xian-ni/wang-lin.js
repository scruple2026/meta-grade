(function () {
  ...
  registerCharacters([
    work.character({
      ...
      dimensions: dims({
        attack: ["可观测宇宙级｜终盘本源/古神体系｜宇宙论依赖｜争议", "可观测宇宙级｜踏天相关终盘｜非无限代表项｜争议", "终盘王林按修真高端宇宙论争议档记录，不写无限攻击。"],
        defense: ["可观测宇宙级｜终盘法体/本源防护｜争议", "可观测宇宙级｜古神/本源防护｜争议", "防御按终盘法体、本源与古神体系保守记录。"],
        movement: ["可观测宇宙尺度超光速｜终盘遁行｜争议", "可观测宇宙尺度超光速｜跨域/本源位移｜非纯速度｜争议", "跨域移动和本源处理很高，但不写无限速。"],
        reaction: ["可观测宇宙尺度超光速｜终盘斗法｜争议", "可观测宇宙尺度超光速｜本源交锋｜争议", "反应按终盘斗法争议档记录。"],
        vitality: ["可观测宇宙级生命结构｜终盘法体｜争议", "可观测宇宙级生命结构｜古神/本源关联｜争议", "生命结构极高但不写无限生命。"],
        healing: ["极速自愈｜法体/本源", "瞬愈｜终盘重构/本源｜争议", "恢复依赖终盘法体、本源和修真资源。"],
        energy: ["可观测宇宙级能量｜终盘法力/本源｜争议", "可观测宇宙级能量｜踏天相关终盘｜争议", "能量总量按终盘高端记录，不写无限能量池。"],
        energyRegen: ["极速回能｜本源/修真资源｜争议", "极速回能｜终盘本源循环｜非无限尺度｜争议", "补能极强但仍按有限高端处理。"]
      }),
      notes: notes({
        penetration: "本源、古神体系和终盘修真术法提供高层级压制；当前不做无限层级比较。攻击速度：古神近战、本源术法与高层级压制有不同发动和命中方式，境界或法则层级不能证明攻击无前摇、无传播。",
        ...
        basis: "worldbook只用于抽取王林姓名；定级依据起点正版入口和萌娘百科作品资料入口，终盘高端暂收束为可观测宇宙级争议档。"
      })
    })
  ]);
})();
