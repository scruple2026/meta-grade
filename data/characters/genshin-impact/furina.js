(function () {
  ...
  registerCharacters([work.character({
    ...
    dimensions: dims({
        attack: ["墙体级｜水元素/剑", "楼宇级｜元素战技/召唤物/元素爆发｜争议", "常态按水元素战斗和剑术记录；峰值含游戏技能机制但不把神明称号直接换算高阶破坏。"],
        defense: ["砖块级｜水元素护持", "楼宇级｜队伍机制/治疗支援", "防御更多来自治疗、召唤物和队伍机制，本体硬度保守。"],
        movement: ["凡人速", "亚音速｜战斗闪避", "战斗移动按提瓦特可操作角色常见水平记录。"],
        reaction: ["凡人速", "亚音速｜元素战斗反应", "反应按元素战斗和舞台经验保守记录。"],
        vitality: ["强化凡体", "楼宇级生命阈值｜神明身份/剧情争议", "身份和剧情特殊性存在争议，生命体量不按无限或神格硬抬。"],
        healing: ["缓慢自愈｜水元素/支援", "快速自愈｜治疗机制/队伍支援", "治疗强项主要来自技能和队伍机制。"],
        energy: ["墙体级能量", "楼宇级能量｜水元素/元素爆发/召唤物", "资源池来自水元素技能和召唤物，不等同单次攻击全量释放。"],
        energyRegen: ["中速回能", "快速回能｜元素充能/队伍循环", "依赖元素充能、战斗循环和队伍资源。"]
      }),
    notes: notes({
        penetration: "水元素攻击、召唤物和元素爆发兼具持续伤害与辅助，不按称号直接换算大范围破坏。攻击速度：芙宁娜的直接水元素攻击按施术与水元素载体判断，召唤物出现后按自身攻击节奏行动；元素爆发另有释放和范围生效过程，三者不能合并。",
