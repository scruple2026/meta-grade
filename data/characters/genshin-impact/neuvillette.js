(function () {
  ...
  registerCharacters([work.character({
    ...
    dimensions: dims({
        attack: ["楼级｜水元素/重击", "城市级｜古龙权柄/大范围水元素｜争议", "常态按可操作水元素输出记录；峰值含古龙权柄语境，需剧情证据细化。"],
        defense: ["楼级｜水元素护持", "城市级｜古龙权柄/水元素防护｜争议", "古龙权柄可提高防护语境，但不等同全类型免疫。"],
        movement: ["亚音速", "音速｜水元素战斗机动", "机动按高端元素角色保守记录。"],
        reaction: ["亚音速", "音速｜古龙/审判官战斗反应", "反应按高端元素战斗和剧情身份保守记录，不写成光速。"],
        vitality: ["楼级生命阈值", "城市级生命阈值｜古龙生命结构｜争议", "古龙身份支持高生命阈值语境，但不写无限生命。"],
        healing: ["中速自愈｜源水之滴/战斗机制", "快速自愈｜水元素/战斗机制", "恢复依赖水元素战斗机制和条件资源。"],
        energy: ["楼级能量", "城市级能量｜古龙权柄/水元素资源池｜争议", "古龙权柄与水元素资源池显著高于常规角色，但不自动反推每一击。"],
        energyRegen: ["中速回能", "快速回能｜水元素循环/权柄", "依赖水元素循环、战斗机制和剧情权柄。"]
      }),
    notes: notes({
        penetration: "水元素重击、审判官技能和古龙权柄可形成高压持续输出；大范围权柄按争议峰值。",
