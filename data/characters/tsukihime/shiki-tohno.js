(function () {
  ...
  registerCharacters([work.character({
    ...
    dimensions: dims({
      attack: ["砖块级", "墙体级｜直死魔眼/七夜体术｜特殊", "物理破坏不高，直死魔眼属于死亡线弱点杀伤。"],
      defense: ["凡人级", "砖块级｜规避/七夜体术", "本体仍是人类，防御主要来自闪避和近战处理。"],
      ...
      energy: ["凡人能量", "砖块级能量｜短时爆发", "以体力和精神负荷为主，不把直死魔眼写成能量池。"],
      energyRegen: ["缓慢回能", "缓慢回能｜休整", "战后需要休整。"]
    }),
    notes: notes({
      penetration: "直死魔眼可切断死亡线/点，是高穿透规则杀伤；不能直接换算为同范围爆破。攻击速度：必须以刀刃实际触及死亡线或点，规则穿透不等于直接生效；命中仍受接战、观察和挥刀过程限制。",
