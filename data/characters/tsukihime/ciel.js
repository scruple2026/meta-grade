(function () {
  ...
  registerCharacters([work.character({
    ...
    dimensions: dims({
      attack: ["墙体级", "楼宇级｜第七圣典/黑键/洗礼咏唱｜争议", "代行者武装和术式火力强，峰值来自装备与术式。"],
      defense: ["墙体级", "房屋级｜代行者体魄/不死性｜争议", "承压强且存在特殊不死机制，但不等同高硬度肉身。"],
      ...
      energy: ["房屋级能量", "楼宇级能量｜圣堂教会武装/术式｜争议", "装备、黑键和术式提供高资源上限。"],
      energyRegen: ["中速回能", "快速回能｜术式/装备准备", "续航依赖装备、术式和准备。"]
    }),
    notes: notes({
      penetration: "黑键、第七圣典和洗礼咏唱偏对吸血种/死徒的特殊杀伤，不等同普适大范围破坏。攻击速度：黑键有近身挥刺与投掷飞行之分，第七圣典和洗礼咏唱另有展开或咏唱过程，不能共用一种速度。",
