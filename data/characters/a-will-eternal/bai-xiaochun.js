(function () {
  ...
  registerCharacters([
    work.character({
      ...
      dimensions: dims({
        attack: ["有限宇宙级｜终盘永恒境｜宇宙论依赖｜争议", "有限宇宙级｜永恒境/不死长生功｜非无限代表项｜争议", "终盘按耳根体系高端争议档记录，不写无限攻击。"],
        defense: ["有限宇宙级｜不死长生功/永恒境｜争议", "有限宇宙级｜终盘防护｜争议", "防御按不死长生功、肉身和终盘境界保守记录。"],
        movement: ["有限宇宙尺度超光速｜终盘遁行｜争议", "有限宇宙尺度超光速｜永恒仙域高端｜争议", "高端遁行与跨域处理很强，但不写无限速。"],
        reaction: ["有限宇宙尺度超光速｜终盘斗法｜争议", "有限宇宙尺度超光速｜永恒境交锋｜争议", "反应按终盘高端斗法争议档记录。"],
        vitality: ["有限宇宙级生命结构｜不死长生功｜争议", "有限宇宙级生命结构｜永恒境｜争议", "生命与恢复很强，但不由永恒名号直接写无限生命。"],
        healing: ["极速自愈｜不死长生功", "瞬愈｜永恒境/肉身重构｜争议", "恢复是白小纯核心优势之一，但仍标条件和阶段。"],
        energy: ["有限宇宙级能量｜终盘法力/炼药资源｜争议", "有限宇宙级能量｜永恒境｜争议", "能量总量按终盘高端记录，不写无限能量池。"],
        energyRegen: ["极速回能｜丹药/体修资源｜争议", "极速回能｜永恒境循环｜非无限尺度｜争议", "补能极强但仍按有限高端处理。"]
      }),
      notes: notes({
        penetration: "终盘境界、炼药/丹炉相关手段和不死长生功体系提供高端压制；不把永恒名号换算成无限攻击。",
        ...
        basis: "worldbook只用于抽取白小纯姓名；定级依据起点正版入口和萌娘百科作品资料入口，终盘高端暂收束为有限宇宙级争议档。"
      })
    })
  ]);
})();
