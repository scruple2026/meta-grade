(function () {
  ...
  registerCharacters([
    work.character({
      ...
      dimensions: dims({
        attack: ["可观测宇宙级｜纪元之道/永生之门｜宇宙论依赖｜争议", "可观测宇宙级｜终章压制仙王｜非无限代表项｜争议", "终章攻击按作品高端宇宙论争议档记录；不从生命无限直接反推攻击无限。"],
        defense: ["可观测宇宙级｜永生之门防护｜宇宙论依赖｜争议", "可观测宇宙级｜复归不同于硬度｜非无限代表项｜争议", "防御和生命体量分开：能复归不等于常驻硬度无限。"],
        movement: ["可观测宇宙尺度超光速｜终章机动｜宇宙论依赖｜争议", "可观测宇宙尺度超光速｜永生之门关联位移｜非纯速度｜争议", "终章行动跨越高端宇宙论场景，但不把门/境界关系直接写成无限速度。"],
        reaction: ["可观测宇宙尺度超光速｜仙王级交锋｜宇宙论依赖｜争议", "可观测宇宙尺度超光速｜终章信息处理｜非纯反应｜争议", "终章信息处理和交锋层级极高，但无所不能语境不直接等于无限反应。"],
        vitality: ["可观测宇宙级生命结构｜永生之门｜宇宙论依赖｜争议", "无限级生命结构｜永生之门/永生境界｜宇宙论依赖｜争议", "代表生命体量的无限样例；核心是生命主体、复归和死亡条件覆盖永生之门相关非有限结构。"],
        healing: ["极速自愈｜纪元/永生之门｜条件｜争议", "瞬愈｜永生之门复归｜条件｜争议", "最终阶段存在死亡后复归语境，但恢复速度和触发条件需与生命结构分开。"],
        energy: ["可观测宇宙级能量｜纪元之道｜总量非单击｜争议", "可观测宇宙级能量｜永生之门资源｜总量/结构依赖｜争议", "能量池按终章高端记录；不把生命结构直接换算成无限能量。"],
        energyRegen: ["极速回能｜永生之门关联｜争议", "极速回能｜复归/结构补充｜非无限尺度｜争议", "补能和复归相关，但不写无限回能。"]
      }),
      notes: notes({
        penetration: "攻击补为可观测宇宙级争议档；方寒最终阶段的攻击仍需逐章审证，不能由永生之门生命结构直接外推到无限攻击。攻击速度：方寒的法宝、神通与近身斗法各有独立祭出或发动过程，永生之门相关生命结构不能直接换成所有攻击载体的速度。",
        resistance: "防御补为可观测宇宙级争议档；生命代表项强调死亡条件和复归结构，不等于普通防御能级，被击伤、被压制和能否彻底杀死应分开判断。",
