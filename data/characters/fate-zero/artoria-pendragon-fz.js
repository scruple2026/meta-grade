(function () {
  ...
  registerCharacters([work.character({
    ...
    dimensions: dims({
        attack: ["楼宇级", "街区级｜Excalibur｜争议", "常规白刃战极强，圣剑真名解放作为条件峰值。"],
        defense: ["楼宇级", "街区级｜魔力放出/铠甲", "铠甲、对魔力和魔力放出提高承伤。"],
        movement: ["音速", "超音速｜魔力放出", "高速从者近战机动。"],
        reaction: ["音速", "超音速｜直感/从者战", "直感和剑术支撑高速应对。"],
        vitality: ["楼宇级生命阈值", "街区级生命阈值｜从者灵基/供魔", "从者灵基和供魔状态影响续战。"],
        healing: ["中速自愈｜灵体/供魔", "快速自愈｜供魔充足", "恢复依赖灵基、供魔和伤势性质。"],
        energy: ["楼宇级能量", "街区级能量｜Excalibur", "魔力与宝具资源强但非无限。"],
