(function () {
  ...
  registerCharacters([work.character({
    ...
    dimensions: dims({
        attack: ["砖块级", "房屋级｜起源弹/现代武装/令咒", "本体火力来自枪械、爆破、起源弹和魔术礼装，不按从者级输出处理。"],
        defense: ["砖块级", "墙体级｜防护/战术规避", "承伤仍是人类范围，主要靠规避、准备和装备。"],
        ...
        energy: ["砖块级能量", "房屋级能量｜令咒/礼装/爆破资源", "可战斗资源来自魔术回路、令咒和携行装备。"],
        energyRegen: ["缓慢回能", "缓慢回能｜准备", "消耗后主要依赖准备和补给。"]
      }),
    notes: notes({
        penetration: "起源弹针对魔术回路和魔术防护极危险，但不是大范围破坏量级。攻击速度：切嗣使用枪械须经过拔枪、瞄准与击发，起源弹离膛后按枪弹独立飞行；破坏魔术回路是命中后的特殊效果，不会提高弹速。",
