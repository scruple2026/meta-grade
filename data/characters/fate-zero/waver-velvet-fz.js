(function () {
  ...
  registerCharacters([work.character({
    ...
    dimensions: dims({
        attack: ["凡人级", "砖块级｜基础魔术/令咒", "年轻魔术师输出很低，主要依赖Rider。"],
        defense: ["凡人级", "砖块级｜基础术式", "本体防御弱。"],
        movement: ["凡人速", "凡人速", "普通人移动。"],
        reaction: ["凡人速", "凡人速", "普通人反应，战场上多靠Rider保护。"],
        vitality: ["凡人肉身", "凡人肉身", "普通人生命体量。"],
        healing: ["无自愈", "缓慢自愈｜医疗", "无战斗自愈。"],
        energy: ["砖块级能量", "墙体级能量｜令咒/御主资源", "魔术资源有限，令咒为主要峰值。"],
        energyRegen: ["缓慢回能", "缓慢回能", "无法支撑高强度魔术战。"]
      }),
    notes: notes({
        penetration: "基础魔术不适合正面杀伤，令咒为特殊命令资源。攻击速度：韦伯的基础魔术按具体施术动作和术式作用判断；令咒只负责下达强制命令，Rider接令后的攻击不属于韦伯本体出手。",
