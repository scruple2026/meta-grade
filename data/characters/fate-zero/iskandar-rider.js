(function () {
  ...
  registerCharacters([work.character({
    ...
    dimensions: dims({
        attack: ["楼级", "街区级｜神威车轮/王之军势｜争议", "常态近战和战车强，王之军势偏军团/固有结界机制。"],
        defense: ["楼级", "街区级｜战车/军势", "灵基和宝具阵势提高承伤，但非单体硬度无限。"],
        movement: ["音速", "超音速｜神威车轮", "战车提供高机动峰值。"],
        reaction: ["音速", "超音速｜从者战/王者经验", "从者级反应和战场统御。"],
        vitality: ["楼级生命阈值", "街区级生命阈值｜从者灵基/军势", "生命体量按本体灵基，军势另作特殊项。"],
        healing: ["中速自愈｜灵体/供魔", "快速自愈｜供魔充足", "恢复依赖供魔。"],
        energy: ["楼级能量", "街区级能量｜王之军势/战车", "宝具资源强但受御主与展开条件影响。"],
        energyRegen: ["中速回能", "快速回能｜供魔/宝具展开", "供魔状态影响持续展开。"]
      }),
    notes: notes({
        penetration: "神威车轮偏冲击和机动压制，王之军势是军团/固有结界，不等同单发爆破。",
