(function () {
  ...
  registerCharacters([work.character({
    ...
    dimensions: dims({
        attack: ["楼级", "街区级｜王之财宝/Ea｜争议", "宝具雨和Ea作为条件峰值，常态不按无限火力处理。"],
        defense: ["楼级", "街区级｜铠甲/宝具防护", "从者灵基和装备强，傲慢时会降低实战防护。"],
        movement: ["音速", "超音速｜从者机动/飞行宝具", "高速从者行动和载具宝具。"],
        reaction: ["音速", "超音速｜从者战/宝具应对", "反应强但受傲慢和轻敌影响。"],
        vitality: ["楼级生命阈值", "街区级生命阈值｜从者灵基/装备", "灵基承伤高，但并非不可杀。"],
        healing: ["中速自愈｜灵体/供魔", "快速自愈｜供魔充足", "恢复依赖供魔和灵基状态。"],
        energy: ["楼级能量", "街区级能量｜王之财宝/Ea", "宝库资源极强，但主档仍按FZ表现保守。"],
        energyRegen: ["中速回能", "快速回能｜供魔/宝库资源", "供魔与宝库调用支撑续航。"]
      }),
    notes: notes({
        penetration: "王之财宝偏多宝具压制和穿透，Ea作为高争议峰值特殊说明。",
