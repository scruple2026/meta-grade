(function () {
  ...
  registerCharacters([
    work.character({
      ...
      dimensions: dims({
        attack: ["墙体级", "楼宇级｜灵魂寒气", "剑术和灵魂寒气具单体杀伤与控制。"],
        defense: ["凡人级", "墙体级｜骷髅身体", "骷髅身体对部分伤害特殊，但结构脆弱。"],
        movement: ["亚音速", "超音速｜剑士突进｜争议", "高速剑士机动。"],
        reaction: ["亚音速", "亚音速", "剑士反应优秀。"],
        vitality: ["精锐韧体｜黄泉果实｜特殊生命结构", "精锐韧体｜黄泉果实", "灵魂复归后死亡条件特殊，但身体仍可破坏。"],
        healing: ["无自愈", "中速自愈｜骨骼修复/牛奶", "恢复带喜剧表现，保守记录。"],
        energy: ["墙体级能量", "楼宇级能量｜灵魂寒气", "灵魂能力输出有限。"],
        energyRegen: ["中速回能", "中速回能", "依赖体力。"]
      }),
      notes: notes({
        penetration: "剑术高速突刺、灵魂寒气和音乐催眠可绕开单纯肉体硬碰硬，主打冻结、削弱节奏和灵魂侧干扰；黄泉果实带来的灵魂攻击不直接换算为更大破坏范围。攻击速度：布鲁克的高速突刺随剑尖近身命中，灵魂寒气附在剑击或灵魂能力上，音乐催眠则需声音传达；三者不能按同一传播过程处理。",
        resistance: "骷髅身体对失血、部分器官伤和常规肉体弱点有特殊优势，灵魂可短时出窍侦查；骨架结构仍会被破坏，海楼石、强灵魂干涉和粉碎性打击需要另判。",
        sensing: "灵魂出窍可用于侦查，剑士听觉/节奏感和黄泉果实让他能感知部分灵魂层目标；面对高灵魂抗性需另判。",
        tactics: "擅长奇袭、催眠、寒气剑术和灵魂侦查支援；骨架脆弱使他更适合扰乱和切入而非硬拼。",
