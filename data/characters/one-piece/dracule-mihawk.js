  ...
  registerCharacters([
    work.character({
      ...
      dimensions: dims({
        ...
        energyRegen: ["中速回能", "快速回能｜霸气恢复", "无特殊瞬时回能。"]
      }),
      notes: notes({
        penetration: "黑刀与顶级剑术主打斩击穿透和大范围切割，不把称号直接换算为更高破坏范围。攻击速度：米霍克的黑刀斩击先随持刀动作完成，近身切割直接接触，离体斩击再向外传播；两者不能共用移动速度。",
        resistance: "依赖剑术格挡、霸气和闪避；缺少果实体质或再生。",
        sensing: "顶级剑士见闻色、距离感和杀气读取支撑远距斩击与格挡；公开全力索敌表现仍少。",
        tactics: "剑术判断极精，擅长用黑刀夜的距离、角度和斩击强度控制对手；缺少完整全力战样本需保留争议。",
        special: "黑刀夜提供顶级斩击载体，配合顶级剑术、武装色和见闻色进行远距切割、格挡和要害压制。",
        weakness: "公开全力战斗样本少，顶级定位需要后续卷话补证。",
        setting: "按新世界后期米霍克记录；世界第一剑豪称号仅作定位，主面板仍以可见斩击和同阶关系保守定级。",
