(function () {
  ...
  registerCharacters([
    work.character({
      ...
      dimensions: dims({
        attack: ["墙体级", "楼宇级｜恶魔形态", "花花果实可进行关节锁、巨肢打击和范围压制。"],
        defense: ["凡人级", "墙体级｜规避/分身", "本体防御有限。"],
        movement: ["凡人速", "亚音速｜能力辅助", "位移能力不突出。"],
        reaction: ["凡人速", "亚音速", "战场控制与预判较强。"],
        vitality: ["强化凡体", "强化凡体", "本体仍接近人类。"],
        healing: ["无自愈", "无自愈", "依赖治疗。"],
        energy: ["墙体级能量", "楼宇级能量｜恶魔形态", "大范围能力消耗体力。"],
        energyRegen: ["中速回能", "中速回能", "依赖体力恢复。"]
      }),
      notes: notes({
        penetration: "花花果实可在目标身上或周围长出肢体，主打关节锁、脊椎扭转、巨肢压制和恶魔形态的近距强控；对生物关节和多目标杂兵有效，但对无关节、元素化或高硬度目标需要另判。攻击速度：罗宾发动花花果实后，肢体可直接在目标身上或周围成形，再完成抓握、扭转或打击；不应假设这些肢体从罗宾所在处飞向目标。",
