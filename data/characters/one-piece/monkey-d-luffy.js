(function () {
  ...
  registerCharacters([
    work.character({
      ...
      timelinePanels: [
        {
          ...
          status: "二档、三档成型",
          dimensions: dims({
            attack: ["楼宇级", "街区级｜二档/三档", "橡胶体术和巨大化打击显著提升。"],
            defense: ["楼宇级", "街区级｜橡胶体质", "承伤强，但霸气体系尚未成熟。"],
            movement: ["超音速", "超音速｜二档", "二档以短时高速为核心。"],
            reaction: ["亚音速", "超音速｜二档", "近战反应随二档提升。"],
            vitality: ["精锐韧体", "街区级生命阈值", "高意志和橡胶体质支撑续战。"],
            healing: ["中速自愈", "中速自愈｜进食/休息", "无稳定再生。"],
            energy: ["楼宇级能量", "街区级能量｜二档/三档", "爆发消耗体力。"],
        ...
        },
        {
          ...
          dimensions: dims({
            ...
            healing: ["中速自愈", "快速自愈｜进食恢复｜争议", "恢复依赖外部补给。"],
        ...
        },
        {
          ...
          dimensions: dims({
            ...
            healing: ["中速自愈", "快速自愈｜进食/五档恢复｜争议", "恢复依食物、休息和觉醒状态，不是稳定再生。"],
      ...
      notes: notes({
        penetration: "五档的巨大化、弹性改写式打击、霸王色缠绕和内部破坏型武装色能把钝击、压缩、反弹与霸气伤害叠加到单体目标；尼卡式自由变形属于命中方式和战术优势，不直接换算为更高破坏范围。攻击速度：路飞五档的拳脚仍需伸展、挥击或弹回后命中，巨大化会改变动作距离；霸气与内部破坏附着在命中上，不是独立飞行攻击。",
        resistance: "橡胶体质、武装色、霸王色对冲和五档觉醒让路飞对钝击、冲击与常规肉搏有极强承受力；斩击、海水/海楼石、霸气耗尽、五档衰竭和精神/规则类控制仍需单独判断。",
        sensing: "见闻色霸气和未来视是核心感知，能读取气息与短时行动；未来视需要集中，不能替代五档后的体力与身体响应。",
        tactics: "临场创造力极强，能把橡胶/尼卡特性、霸气和地形转化为非常规打法；性格直冲和体力空窗会给对手窗口。",
