(function () {
  ...
  registerCharacters([
    work.character({
      ...
      notes: notes({
        penetration: "震震果实提供地震、冲击波和海啸级大范围破坏，暗暗果实可吸引能力者并在接触中压制恶魔果实能力；双果实组合既能正面破坏也能绕过能力防御，但国家级峰值仅按争议标签处理。攻击速度：蒂奇发动震震果实后，震动与冲击向外扩散；暗暗果实的吸引过程和接触压制另有作用距离，不能与震动传播合并计速。",
