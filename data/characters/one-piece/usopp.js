(function () {
  ...
  registerCharacters([
    work.character({
      ...
      fandomSlug: "Usopp",
      dimensions: dims({
        attack: ["砖块级", "墙体级｜特殊弹药", "狙击与特殊弹药可造成局部破坏和控制。"],
        defense: ["凡人级", "墙体级｜极限承伤", "本体防御有限但承伤意志强。"],
        movement: ["凡人速", "亚音速", "逃跑和战场机动优秀。"],
        reaction: ["凡人速", "亚音速｜见闻色萌芽", "狙击预判和见闻色萌芽。"],
        vitality: ["强化凡体", "精锐韧体", "经常在重伤下继续行动。"],
        healing: ["无自愈", "无自愈", "依赖医疗。"],
        energy: ["凡人能量", "墙体级能量｜弹药", "输出依赖弹药和植物武器。"],
        energyRegen: ["无回能", "无回能", "依赖补给。"]
      }),
      notes: notes({
        penetration: "弹弓狙击、爆炸弹、植物弹药和特殊弹能从超远距离打眼、关节、后颈或环境弱点；杀伤依赖弹药类型和命中部位，不按正面破城火力处理。攻击速度：乌索普先选弹、装填弹弓并瞄准，发射后爆炸弹、植物弹和特殊弹各按自身轨迹飞行；远距校正会限制连续射击。",
