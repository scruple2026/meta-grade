(function () {
  ...
  registerCharacters([
    work.character({
      ...
      fandomSlug: "Nami",
      dimensions: dims({
        attack: ["墙体级", "街区级｜宙斯雷云｜装备", "天候棒与宙斯可造成雷击和区域天气打击。"],
        defense: ["凡人级", "墙体级｜规避", "本体防御有限，依赖机动和队友。"],
        movement: ["凡人速", "亚音速", "身体能力高于常人但非近战主力。"],
        reaction: ["凡人速", "亚音速｜战术预判", "靠气象知识和战术预判。"],
        vitality: ["强化凡体", "强化凡体", "承伤强于常人但仍脆弱。"],
        healing: ["无自愈", "无自愈", "依赖治疗。"],
        energy: ["墙体级能量", "街区级能量｜宙斯｜装备", "输出主要来自装备和宙斯。"],
        energyRegen: ["无回能", "中速回能｜装备/宙斯", "依赖装备状态。"]
      }),
      notes: notes({
        penetration: "天候棒可用雷云、风压、气象诱导和宙斯追踪雷击绕开单纯肉搏防御，主打远程电击、范围干扰和弱点命中；输出来自装备与宙斯，不代表娜美本体拳脚能级。攻击速度：娜美要先用天候棒布置或引导雷云，宙斯追踪与雷击随后自行锁定和落下；气象准备、追踪和放电是不同阶段。",
