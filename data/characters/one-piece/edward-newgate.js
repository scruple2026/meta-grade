(function () {
  ...
  registerCharacters([
    work.character({
      ...
      timelinePanels: [
        {
          ...
          dimensions: dims({
            ...
            energyRegen: ["快速回能", "快速回能｜体力恢复", "无瞬时回能。"]
          }),
        ...
        },
        {
          ...
          dimensions: dims({
            ...
            energyRegen: ["中速回能", "快速回能｜意志/体力", "顶上战争中持续消耗不可长期维持。"]
          }),
          notes: "当前主面板版本。"
        }
      ],
      ...
      notes: notes({
        penetration: "震震果实以震动、冲击和地形/海面破坏为主；世界毁灭级传闻不直接转成主等级。攻击速度：白胡子以拳头或薙刀发动震震果实，震动随后向空气、地面或海面扩散；起手和震动扩散不能合并成一个速度。",
        resistance: "极限承伤和意志很强，但病弱、旧伤、连续创伤会显著削弱。",
        sensing: "巅峰期霸气和经验支撑顶级战场感知，顶上战争病情会削弱见闻色稳定性与预警。",
        tactics: "大规模战场指挥和近身经验极强，擅长用震震果实保护舰队、破坏地形和逼退强敌；病弱状态下更依赖部下与威慑。",
