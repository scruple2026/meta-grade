(function () {
  ...
  registerCharacters([work.character({
    ...
    dimensions: dims({
        attack: ["凡人级", "墙体级｜枪械/弹药/临时武器｜装备", "本体普通，输出高度依赖枪械、弹药和临时武器。"],
        ...
        energy: ["凡人能量", "墙体级能量｜枪械/弹药资源｜装备", "战斗资源来自枪械、弹药和工具。"],
        energyRegen: ["无回能", "缓慢回能｜换弹/补给", "依赖补给和换弹。"]
      }),
    notes: notes({
        penetration: "枪械和临时武器可远程击杀丧尸或压制人类敌人，峰值取决于弹药和武器。攻击速度：平野耕太的枪击速度由举枪、瞄准、扣发和枪械射速共同决定，弹丸离膛后另算；临时武器须按其实际结构处理。",
