(function () {
  ...
  registerCharacters([work.character({
    ...
    dimensions: dims({
        attack: ["砖块级｜木刀/近战", "砖块级｜真剑/要害斩击｜武器", "剑道和刀具让她对丧尸有高效单体杀伤，但不按大范围破坏处理。"],
        ...
        energy: ["凡人能量", "砖块级能量｜刀具/体力", "能量资源来自体力和武器。"],
        energyRegen: ["无回能", "缓慢回能｜休息/补给", "依赖休息和补给。"]
      }),
    notes: notes({
        penetration: "真剑、木刀和剑道技巧偏要害斩击，对丧尸清场效率高但范围有限。攻击速度：毒岛冴子的真剑与木刀都靠步法、挥臂和刃部接触完成斩击，收刀再攻需要动作衔接，不存在离体飞行阶段。",
