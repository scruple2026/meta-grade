(function () {
  ...
  registerCharacters([
    work.character({
      ...
      fandomSlug: "Kurapika",
      dimensions: dims({
        attack: ["墙体级", "房屋级｜锁链制约", "锁链对旅团有特殊制约杀伤，常规破坏范围有限。"],
        defense: ["墙体级", "房屋级｜念防御", "念防御与治愈锁链提升承伤，但代价和条件明显。"],
        movement: ["凡人速", "亚音速", "优秀念能力者速度，不按音速处理。"],
        reaction: ["亚音速", "亚音速｜火红眼", "火红眼与念战经验提升反应。"],
        vitality: ["强化凡体", "精锐韧体｜念强化", "念强化和治愈锁链提升续战。"],
        healing: ["中速自愈", "快速自愈｜治愈锁链", "治愈锁链可快速修复伤势，但消耗与条件明显。"],
        energy: ["墙体级能量", "房屋级能量｜火红眼", "火红眼状态提升念能力，但消耗寿命。"],
        energyRegen: ["中速回能", "快速回能｜代价型", "能力提升伴随寿命代价，不按无条件回能处理。"]
      }),
      notes: notes({
        penetration: "锁链制约对幻影旅团有针对性压制，不能泛化到所有敌人。攻击速度：酷拉皮卡先挥动或延伸锁链，链条接近、缠绕目标后才施加对应制约；对幻影旅团的条件强化改变效果，不会让锁链跳过命中过程。",
