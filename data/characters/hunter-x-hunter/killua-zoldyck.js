(function () {
  ...
  registerCharacters([
    work.character({
      ...
      timelinePanels: [
        {
          ...
          status: "未掌握念",
          dimensions: dims({
            attack: ["凡人级", "墙体级｜暗杀术", "暗杀手刀和体术远超常人。"],
            defense: ["凡人级", "墙体级｜暗杀训练", "抗毒抗电训练突出。"],
            movement: ["凡人速", "亚音速｜暗杀步法", "短距爆发和潜行强。"],
            reaction: ["凡人速", "亚音速", "早期反应依赖暗杀训练。"],
            vitality: ["强化凡体", "强化凡体", "身体训练优异。"],
            healing: ["无自愈", "无自愈", "无超常恢复。"],
            energy: ["凡人能量", "墙体级能量｜体力", "未掌握念。"],
            energyRegen: ["中速回能", "中速回能", "依赖休息。"]
          }),
          notes: "不计入念能力和神速。"
        },
        {
          ...
          status: "变化系电气念成型",
          dimensions: dims({
            attack: ["墙体级", "房屋级｜电击念", "念强化和电击提升单体杀伤。"],
            defense: ["墙体级", "房屋级｜念防御", "念防御和身体训练提升承伤。"],
            movement: ["亚音速", "亚音速｜念强化", "机动强但神速尚未成型。"],
            reaction: ["亚音速", "亚音速", "念战经验提升反应。"],
            vitality: ["强化凡体", "精锐韧体｜念强化", "抗毒抗电和念强化支撑续战。"],
            healing: ["无自愈", "无自愈", "无超常恢复。"],
            energy: ["墙体级能量", "房屋级能量｜电击念", "念与电力储备限制输出。"],
            energyRegen: ["中速回能", "中速回能｜充电条件", "电力需外部补充。"]
          }),
          notes: "不计入蚁王篇神速自动反应。"
        },
        {
          ...
          status: "电光石火与疾风迅雷",
          dimensions: dims({
            attack: ["墙体级", "房屋级｜电击念", "暗杀术、念强化和电击可造成强单体杀伤。"],
            defense: ["墙体级", "房屋级｜念防御", "身体训练和念防御较强，但不代表能硬抗摧毁整栋建筑的所有攻击。"],
            ...
            healing: ["无自愈", "无自愈", "无超常恢复。"],
            energy: ["墙体级能量", "房屋级能量｜蓄电", "念与电力储备共同限制神速持续时间。"],
            energyRegen: ["中速回能", "快速回能｜充电条件", "念可恢复，电力需外部补充。"]
          }),
          notes: "当前主面板版本。"
        }
      ],
      ...
      notes: notes({
        penetration: "暗杀手刀和电击针对神经、要害有穿透优势。攻击速度：奇犽的暗杀手刀随近身步法和手臂动作命中，接触电击在碰到目标后生效；神速强化的是自身行动与应对，放电方式仍须按具体招式区分。",
        resistance: "抗毒抗电训练突出，但不是全类型抗性。",
        sensing: "暗杀训练和神速电信号让他能预设自动反应路径；疾风迅雷是条件化自动应对，不等同全局预知。",
        tactics: "暗杀、撤退和节奏控制极强，擅长用电、速度差和信息差打断敌人；神速续航和蓄电条件要求精细资源管理。",
        special: "变化系电气念、神速、电光石火、疾风迅雷、暗杀术。",
        weakness: "神速持续时间和蓄电条件有限，面对规则型能力仍需情报。",
        setting: "按蚁王篇掌握神速后的奇犽记录；暗杀术、电气念和神速持续时间共同决定战斗口径。",
