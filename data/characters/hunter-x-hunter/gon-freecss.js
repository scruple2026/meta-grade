(function () {
  ...
  registerCharacters([
    work.character({
      ...
      timelinePanels: [
        {
          ...
          status: "念能力入门前后",
          dimensions: dims({
            attack: ["砖块级", "墙体级｜念强化", "早期以身体能力和念强化入门为主。"],
            defense: ["砖块级", "墙体级｜念防御", "念防御刚成型。"],
        ...
        },
        {
          ...
          status: "强化系必杀技成型",
          dimensions: dims({
            attack: ["墙体级", "房屋级｜猜猜拳", "集中蓄力打击提升单体破坏。"],
            defense: ["墙体级", "房屋级｜坚/硬", "念防御更成熟。"],
            movement: ["亚音速", "亚音速", "高速近战但不按音速。"],
            reaction: ["亚音速", "亚音速", "念战反应稳定。"],
            vitality: ["强化凡体", "精锐韧体｜念强化", "念强化提高承伤。"],
            healing: ["无自愈", "无自愈", "无主动自愈。"],
            energy: ["墙体级能量", "房屋级能量｜猜猜拳", "必杀技消耗念量。"],
        ...
        },
        {
          ...
          status: "极端誓约换取峰值",
          dimensions: dims({
            attack: ["墙体级", "街区级｜成人杰｜一次性｜誓约", "常态猜猜拳为局部重击；成人杰是极端誓约换来的不可持续峰值。"],
            defense: ["墙体级", "街区级｜成人杰｜一次性", "常态防御依赖坚与硬；成人杰体能大幅提高但代价极端。"],
            ...
            energy: ["墙体级能量", "街区级能量｜成人杰｜誓约", "念量峰值来自极端誓约，不代表常态资源池。"],
      ...
      notes: notes({
        penetration: "猜猜拳把强化系念集中到拳、剪、布三种输出，主打单点破甲和近身爆发；成人杰峰值是极端誓约，不代表可反复使用。攻击速度：小杰的猜猜拳要先聚念并完成出拳姿势；石头随拳头近身命中，剪与布的作用距离另判，成人形态也不消除蓄力步骤。",
