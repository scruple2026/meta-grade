(function () {
  ...
  registerCharacters([
    work.character({
      ...
      sourceQuality: "entry",
      dimensions: dims({
        attack: ["楼宇级", "楼宇级｜高速攻击魔法", "擅长高速连续攻击魔法，偏精密火力。"],
        defense: ["墙体级", "楼宇级｜防御魔法", "防御依赖魔法屏障。"],
        ...
        energy: ["楼宇级能量", "楼宇级能量｜魔力", "魔力储量优秀但低于顶级精灵/大魔族。"],
        energyRegen: ["快速回能", "快速回能｜魔力恢复", "可恢复魔力但需休整。"]
      }),
      notes: notes({
        penetration: "高速普通攻击魔法适合打断施法和压制防御薄弱目标。攻击速度：菲伦的普通攻击魔法强调快速施放与连续射击，但每发仍有瞄准、发射和魔法弹飞行；现有资料未给可独立换算的弹速档。",
