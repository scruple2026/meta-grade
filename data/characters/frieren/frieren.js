(function () {
  ...
  registerCharacters([
    work.character({
      ...
      sourceQuality: "entry",
      dimensions: dims({
        attack: ["楼宇级", "街区级｜攻击魔法/封印解析", "常用攻击魔法和高阶魔法足以压制大魔族，但不把年龄直接换成高破坏档。"],
        defense: ["墙体级", "楼宇级｜防御魔法", "防御依赖魔法屏障和距离管理，本体并非高硬度肉身。"],
        ...
        energy: ["楼宇级能量", "街区级能量｜长期魔力储备", "魔力量和经验极高，但单次输出与总量分开。"],
        energyRegen: ["快速回能", "快速回能｜魔力恢复", "长期续航强但战斗中会消耗。"]
      }),
      notes: notes({
        penetration: "攻击魔法、解析封印和对魔族知识提供高命中与克制，不把特殊解析直接换成破坏规模。攻击速度：芙莉莲的攻击魔法需分别看施法、瞄准与魔法弹飞行；解析封印和对魔族知识用于判断与克制，本身没有攻击速度。",
