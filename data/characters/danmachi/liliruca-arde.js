(function () {
  ...
  registerCharacters([
    work.character({
      ...
      sourceQuality: "entry",
      dimensions: dims({
        attack: ["砖块级", "墙体级｜装备/短弩", "支援者本体输出有限，依赖装备和战术。"],
        defense: ["砖块级", "墙体级｜装备", "小体格但有冒险者经验和装备防护。"],
        ...
        energy: ["砖块级能量", "墙体级能量｜变身魔法/装备", "资源以支援、伪装和装备运用为主。"],
        energyRegen: ["缓慢回能", "缓慢回能", "战斗续航依赖补给。"]
      }),
      notes: notes({
        penetration: "短弩、道具和陷阱式支援为主，不适合正面破坏。攻击速度：短弩箭矢离弦后独立于莉莉的奔跑，陷阱依赖预先布置和触发；她本人没有持续高速近战连击表现。",
