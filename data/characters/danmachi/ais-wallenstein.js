(function () {
  ...
  registerCharacters([
    work.character({
      ...
      sourceQuality: "entry",
      dimensions: dims({
        attack: ["楼级", "街区级｜风灵疾走/复仇姬", "剑技、风魔法和对怪物特化使峰值高于普通近战。"],
        defense: ["房屋级", "楼级｜风防护/装备", "风魔法与装备提高承伤，但不是无条件免伤。"],
        movement: ["音速", "超音速｜风灵疾走", "一线冒险者高速机动。"],
        reaction: ["音速", "超音速｜剑姬战斗", "高阶近战反应，适合对怪物和冒险者高速战。"],
        vitality: ["房屋级生命阈值", "楼级生命阈值｜Falna", "高等级冒险者体魄与精神支撑续战。"],
        healing: ["无自愈", "缓慢自愈｜治疗/休整", "没有稳定高速自愈。"],
        energy: ["楼级能量", "街区级能量｜风魔法/技能", "魔法和技能资源支撑持续战斗，但仍会消耗。"],
        energyRegen: ["缓慢回能", "中速回能｜休整/补给", "战斗续航强于一般冒险者，但不是瞬时恢复。"]
      }),
      notes: notes({
        penetration: "剑技与风魔法偏高速斩击和单体压制，对怪物特化明显。",
