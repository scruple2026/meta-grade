(function () {
  ...
  registerCharacters([
    work.character({
      ...
      sourceQuality: "entry",
      dimensions: dims({
        attack: ["凡人级", "砖块级｜基础魔法", "本体直接输出很低，核心价值是等级提升支援。"],
        defense: ["凡人级", "砖块级｜Falna", "本体脆弱，不适合正面承伤。"],
        movement: ["凡人速", "亚音速｜冒险者行动", "机动能力有限。"],
        reaction: ["凡人速", "亚音速｜战场支援", "能在队伍保护下执行支援。"],
        vitality: ["凡人肉身", "强化凡体｜Falna", "生命体量接近低阶冒险者。"],
        healing: ["无自愈", "无自愈", "没有稳定自愈。"],
        energy: ["砖块级能量", "房屋级能量｜等级提升", "魔力资源主要用于提升队友等级，不等同自身单击输出。"],
        energyRegen: ["缓慢回能", "缓慢回能", "支援魔法消耗明显，需要保护与恢复。"]
      }),
      notes: notes({
        penetration: "直接杀伤弱，等级提升可间接提高队友输出。攻击速度：春姬缺少稳定正面杀伤，等级提升要先完成咏唱并施加给队友；增益生效不等于她拥有同速的攻击弹体。",
