(function () {
  ...
  registerCharacters([
    work.character({
      ...
      sourceQuality: "entry",
      dimensions: dims({
        attack: ["房屋级", "楼宇级｜魔法/剑术", "剑术和精灵魔法兼具单体突破与局部范围攻击。"],
        defense: ["房屋级", "楼宇级｜装备/经验", "高经验冒险者承伤和回避优秀。"],
        movement: ["音速", "超音速｜疾风", "高速机动是核心优势。"],
        reaction: ["音速", "超音速｜战斗经验", "对冒险者和怪物高速战经验丰富。"],
        vitality: ["房屋级生命阈值", "楼宇级生命阈值｜Falna/意志", "重伤下仍能坚持，但不是再生型。"],
        healing: ["无自愈", "缓慢自愈｜治疗/休整", "依赖外部治疗与休整。"],
        energy: ["楼宇级能量", "楼宇级能量｜精灵魔法", "魔法和体力资源支撑持续战斗。"],
        energyRegen: ["缓慢回能", "中速回能｜休整/补给", "战斗后需恢复。"]
      }),
      notes: notes({
        penetration: "剑术、咏唱魔法和高速突袭结合，偏精确打击。攻击速度：高速剑击随琉的突袭步法，精灵魔法需经过咏唱再放出，咏唱窗口与魔法载体速度必须分开处理。",
