(function () {
  ...
  registerCharacters([
    work.character({
      ...
      sourceQuality: "entry",
      dimensions: dims({
        attack: ["墙体级", "楼宇级｜克罗佐魔剑", "本体近战中等，魔剑可显著提高范围与瞬时输出。"],
        defense: ["墙体级", "房屋级｜装备/前卫", "冒险者体魄和装备支撑前卫承伤。"],
        ...
        energy: ["墙体级能量", "楼宇级能量｜魔剑资源", "魔剑资源和体力不等同自身稳定单击。"],
        energyRegen: ["缓慢回能", "中速回能｜补给/换装", "续航依赖装备和补给。"]
      }),
      notes: notes({
        penetration: "魔剑提供强范围元素打击，近战武器适合破甲和牵制。攻击速度：近战武器随韦尔夫挥击，魔剑元素打击在挥动或解放后扩散；魔剑范围效果与本人冲刺速度是不同过程。",
