(function () {
  ...
  registerCharacters([
    work.character({
      ...
      dimensions: dims({
        attack: ["大陆级｜大罗金仙/法则｜争议", "可观测宇宙级｜时间法则/掌天瓶｜宇宙论依赖｜争议", "仙界篇后期按高阶修仙与法则战保守入高端争议档，不写无限攻击。"],
        defense: ["大陆级｜大罗金仙体魄/法宝｜争议", "可观测宇宙级｜法则防护/掌天瓶资源｜宇宙论依赖｜争议", "防御依赖法宝、炼体、法则和资源，不按境界名直接抬到无限。"],
        movement: ["超光速｜高阶遁速｜争议", "可观测宇宙尺度超光速｜跨界遁行/法则｜争议", "高阶修仙者遁行和跨界语境极高，但需后续逐章补证。"],
        reaction: ["超光速｜高阶斗法｜争议", "可观测宇宙尺度超光速｜法则斗法｜争议", "反应按高端斗法争议档处理，不把谋略和准备直接换成反应速度。"],
        vitality: ["大陆级生命阈值｜大罗金仙/炼体｜争议", "可观测宇宙级生命结构｜仙界篇高端｜争议", "生命体量按高阶仙人和炼体资源保守记录，未写无限生命。"],
        healing: ["快速自愈｜丹药/法体", "极速自愈｜仙界资源/法则｜争议", "恢复依赖丹药、法体、法则与准备资源。"],
        energy: ["大陆级能量｜大罗金仙法力｜争议", "可观测宇宙级能量｜掌天瓶/法则资源｜争议", "能量总量很高但不按掌天瓶外物直接写无限。"],
        energyRegen: ["快速回能｜丹药/灵材", "极速回能｜掌天瓶资源/法则调度｜争议", "韩立优势在资源、准备和续航，不等于无消耗瓶颈。"]
      }),
      notes: notes({
        penetration: "时间法则、法宝、炼体和多套底牌提供穿透与压制；掌天瓶作为关键外物资源写入峰值条件。攻击速度：近身炼体、法宝驱使和法术释放是三类攻击流程，应分别记录出手、催动和传播；掌天瓶作为外物资源不参与攻击速度判断。",
