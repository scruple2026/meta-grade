(function () {
  ...
  registerCharacters([
    work.character({
      ...
      sourceQuality: "entry",
      dimensions: dims({
        attack: ["楼宇级", "街区级｜显化触肢/幽体伤害｜特殊｜争议", "显化体能压制格斯并造成实体与幽体伤害，但不按大范围破坏外推。"],
        defense: ["楼宇级", "街区级｜显化体/神之手存在｜争议", "显化体可被特殊武器 destabilize，神之手本体存在方式另算。"],
        movement: ["不适用｜幽界显现", "不适用｜幽界/显化", "常通过仪式、幽界或环境显化，不按连续移动速度。"],
        reaction: ["亚音速", "音速｜权能/因果预判｜争议", "可与格斯、髑髅骑士相关局面互动，主要依靠权能和显化体。"],
        vitality: ["楼宇级生命阈值｜显化体", "街区级生命阈值｜神之手存在｜争议", "显化体被破坏不等同本体死亡。"],
        healing: ["未知", "未知｜显化体消散", "表现更接近撤离或显化解除，不写成稳定再生。"],
        energy: ["楼宇级能量", "街区级能量｜幽界显化/精神诱导｜争议", "能通过环境与幽界显化并影响人类，但不直接换算成大爆破。"],
