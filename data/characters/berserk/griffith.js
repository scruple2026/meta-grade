(function () {
  ...
  registerCharacters([
    work.character({
      ...
      timelinePanels: [
        {
          ...
          status: "鹰之团团长",
          dimensions: dims({
            attack: ["砖块级", "墙体级｜剑术", "人类剑士和指挥官水平。"],
            defense: ["凡人级", "墙体级｜甲胄/格挡", "依靠甲胄和技巧。"],
            movement: ["凡人速", "亚音速｜剑术", "人类顶级机动。"],
            reaction: ["凡人速", "亚音速｜剑术", "剑术反应优秀。"],
            vitality: ["强化凡体", "强化凡体", "人类肉身。"],
            healing: ["无自愈", "无自愈", "无自愈。"],
            energy: ["凡人能量", "砖块级能量｜体力/装备", "无超自然能量池。"],
        ...
        },
        {
          ...
          status: "神之手成员",
          dimensions: dims({
            attack: ["墙体级", "街区级｜空间压缩/神之手权能｜特殊｜争议", "Femto权能偏空间/因果处理，不按纯破坏范围抬高。"],
            defense: ["墙体级", "街区级｜神之手权能｜特殊｜争议", "防御更多来自神之手存在方式和权能，不等同肉身硬度。"],
            ...
            energy: ["墙体级能量", "街区级能量｜神之手权能｜争议", "权能高于人类阶段，但不按世界观称号泛化。"],
      ...
      notes: notes({
        penetration: "Femto的重力/空间压缩和因果律相关权能是特殊处理，不按普通剑击破坏规模换算。攻击速度：人类时期剑击随近身交锋，Femto的重力与空间压缩属于权能作用；空间效果不因缺少可见弹道就视为无限速。",
