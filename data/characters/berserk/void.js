(function () {
  ...
  registerCharacters([
    work.character({
      ...
      sourceQuality: "entry",
      dimensions: dims({
        attack: ["墙体级", "街区级｜空间扭曲/烙印仪式｜特殊｜争议", "空间扭曲和烙印仪式是特殊权能，不按纯破坏范围扩张。"],
        defense: ["墙体级", "街区级｜空间扭曲/神之手存在｜特殊｜争议", "可用空间扭曲反制攻击，防御更多来自权能和存在方式。"],
        ...
        energy: ["墙体级能量", "街区级能量｜空间/烙印权能｜争议", "权能规模高于人类和普通使徒，但不按神之手称号泛化到大范围破坏。"],
