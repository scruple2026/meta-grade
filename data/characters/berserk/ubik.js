(function () {
  ...
  registerCharacters([
    work.character({
      ...
      sourceQuality: "entry",
      dimensions: dims({
        attack: ["无资料", "墙体级｜意识显化/精神诱导｜特殊｜争议", "主要价值是精神操纵和意识显化，缺少直接破坏表现。"],
        defense: ["墙体级", "街区级｜神之手存在｜争议", "防御来自神之手存在方式和仪式语境，不等同肉身硬度。"],
        ...
        energy: ["无资料", "墙体级能量｜意识显化/幻象诱导｜争议", "能打开意识层面和幻象诱导，但缺少纯能量输出资料。"],
