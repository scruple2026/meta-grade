(function () {
  ...
  registerCharacters([
    work.character({
      ...
      sourceQuality: "entry",
      dimensions: dims({
        attack: ["墙体级", "街区级｜地形转化/瘟疫显化｜特殊｜争议", "可在仪式中转化地形并通过鼠群/瘟疫显化，但不是常规爆破输出。"],
        defense: ["墙体级", "街区级｜神之手存在｜争议", "防御来自神之手存在方式和显化语境，缺少常规硬抗换算。"],
        ...
        energy: ["墙体级能量", "街区级能量｜地形转化/显化｜争议", "权能可影响仪式空间和瘟疫显化，但缺少纯输出规模。"],
