(function () {
  ...
  registerCharacters([
    work.character({
      ...
      timelinePanels: [
        {
          ...
          status: "战争恶魔接管与基础武器化",
          dimensions: dims({
            attack: ["凡人级", "墙体级｜武器化", "早期依赖临场武器化，强度不稳定。"],
            ...
            energy: ["凡人能量", "墙体级能量｜武器化条件", "能力依赖可武器化对象和罪恶感。"],
            energyRegen: ["中速回能", "中速回能", "资源依赖条件和可用对象。"]
          }),
        ...
        },
        {
          ...
          status: "条件型武器化成型",
          dimensions: dims({
            attack: ["墙体级", "街区级｜武器化｜战争恶魔｜争议", "武器化强度取决于对象价值、情感和战争恶魔状态。"],
            defense: ["凡人级", "墙体级｜恶魔宿主", "本体较脆，主要靠武器化和战术避免受击。"],
            movement: ["凡人速", "亚音速｜恶魔接管", "恶魔接管提升战斗动作，但无音速证据。"],
            reaction: ["凡人速", "亚音速｜恶魔经验", "战争恶魔经验提升反应。"],
            vitality: ["强化凡体", "精锐韧体｜恶魔宿主", "宿主结构特殊但不等同混成体再生。"],
            healing: ["无自愈", "中速自愈｜恶魔影响｜争议", "恢复表现不如混成体，保守记录。"],
            energy: ["墙体级能量", "街区级能量｜武器化条件｜争议", "能力强度高度依赖武器化条件。"],
            energyRegen: ["中速回能", "快速回能｜条件型", "随战争恶魔状态与可武器化对象变化。"]
          }),
      ...
      notes: notes({
        penetration: "武器化可把拥有感、罪恶感和对象价值转成武器强度，适合制造高单体杀伤、异常材质兵器和临场破甲；这是条件型权能，不把最强情绪武器泛化为常态街区输出。攻击速度：三鹰朝挥动已制成武器仍属近战动作，投掷或射出的武器有独立弹道；武器化本身还需要所有感与命名等前置。",
