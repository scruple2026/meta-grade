(function () {
  ...
  registerCharacters([
    work.character({
      ...
      dimensions: dims({
        attack: ["砖块级", "房屋级｜契约恶魔", "常态刀术偏低，契约恶魔可提供单体高杀伤。"],
        defense: ["凡人级", "墙体级｜战斗服与规避", "本体为人类，靠训练和契约规避风险。"],
      ...
      notes: notes({
        penetration: "狐之恶魔、诅咒之恶魔等契约可造成高于常态的单体杀伤。攻击速度：刀击随早川秋近身动作，狐之恶魔与诅咒之恶魔则要满足召唤或契约步骤；召唤结果不能当成本体挥刀速度。",
        resistance: "人类本体脆弱，对恶魔高速突袭和大范围攻击风险高。",
        sensing: "未来恶魔契约提供短暂未来视，是核心预判来源；它不等同身体速度，仍受可执行窗口和代价限制。",
        tactics: "职业恶魔猎人判断冷静，擅长把刀术、狐、诅咒和未来视组合成条件击杀；契约代价和寿命消耗使长战风险高。",
