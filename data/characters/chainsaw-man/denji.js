(function () {
  ...
  registerCharacters([
    work.character({
      ...
      timelinePanels: [
        {
          ...
          status: "基础电锯变身",
          dimensions: dims({
            attack: ["墙体级", "墙体级｜电锯混成体", "早期以近身切割和突进为主。"],
            defense: ["墙体级", "墙体级｜混成体再生", "主要靠混成体再生续战。"],
            ...
            energy: ["墙体级能量", "墙体级能量｜血液供能", "缺血会明显削弱。"],
        ...
        },
        {
          ...
          status: "常规电锯人稳定战斗状态",
          dimensions: dims({
            attack: ["墙体级", "房屋级｜电锯混成体", "电锯斩击和肉体力量以单体切割、建筑局部破坏为主。"],
            defense: ["墙体级", "房屋级｜混成体再生", "防御不是硬抗，主要靠恶魔混成体生命结构和再生续战。"],
            movement: ["亚音速", "亚音速｜电锯机动", "近战爆发和机动强，但不按音速记录。"],
            reaction: ["亚音速", "亚音速", "能与恶魔和魔人近战，许多闪避仍可能包含预判。"],
            vitality: ["精锐韧体｜混成体｜特殊生命结构", "楼宇级生命阈值｜混成体", "肢体破坏、斩首等可通过血液和拉绳恢复，核心条件特殊。"],
            healing: ["快速自愈", "极速自愈｜饮血｜混成体", "饮血后可快速修复重伤和肢体损伤。"],
            energy: ["墙体级能量", "房屋级能量｜血液供能", "战斗资源依赖血液和恶魔心脏，不是无限能量。"],
      ...
      notes: notes({
        penetration: "电锯对血肉、肢体和恶魔身体有高切割杀伤，范围破坏有限。攻击速度：手臂与头部电锯的切割随电次贴身突进和肢体挥动，链锯链条高速转动提升切割效率，但不是远程飞行速度。",
