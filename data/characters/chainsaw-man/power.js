(function () {
  ...
  registerCharacters([
    work.character({
      ...
      fandomSlug: "Power",
      dimensions: dims({
        attack: ["墙体级", "房屋级｜血武器", "血液武器可穿刺、砸击和局部破坏建筑。"],
        defense: ["墙体级", "房屋级｜血液补强", "魔人肉体强于人类但并非高硬度防御。"],
        ...
        healing: ["中速自愈", "快速自愈｜饮血", "补血可恢复伤势，缺血时削弱。"],
        energy: ["墙体级能量", "房屋级能量｜血液操控", "血液是主要资源。"],
        energyRegen: ["中速回能", "快速回能｜饮血", "依赖血液补充。"]
      }),
      notes: notes({
        penetration: "血矛和血锤具备穿刺杀伤，但受血量和操控限制。攻击速度：血锤随帕瓦近战挥动，血矛则需先由血液塑形成兵器再用于刺击；成形与出手都受可用血量和操控影响。",
        resistance: "魔人身体可承受部分重伤，仍可能被斩首、贯穿和压制。",
        sensing: "魔人五感和血液操控带来近距战斗感知，但纪律性差会影响威胁判断；缺少稳定远程侦查。",
        tactics: "擅长临时制造血武器和虚张声势，能在支援位制造意外窗口；恐惧、撒谎和冲动会让计划执行不稳定。",
