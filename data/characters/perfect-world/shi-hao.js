(function () {
  ...
  registerCharacters([
    work.character({
      ...
      dimensions: dims({
        attack: ["可观测宇宙级｜仙帝/他化自在法｜宇宙论依赖｜争议", "可观测宇宙级｜荒天帝终盘｜非无限代表项｜争议", "终盘荒天帝按作品高端宇宙论争议档记录，不把称号或诗性简介写成无限。"],
        defense: ["可观测宇宙级｜仙帝体魄/法则｜宇宙论依赖｜争议", "可观测宇宙级｜荒天帝终盘防护｜争议", "防御按终盘高端承伤和法则防护保守记录。"],
        movement: ["可观测宇宙尺度超光速｜终盘机动｜宇宙论依赖｜争议", "可观测宇宙尺度超光速｜独断万古/时空处理｜非纯速度｜争议", "时空处理和终盘机动很高，但不直接写无限速。"],
        reaction: ["可观测宇宙尺度超光速｜仙帝交锋｜宇宙论依赖｜争议", "可观测宇宙尺度超光速｜终盘信息处理｜争议", "反应按高端交锋争议档记录，后续需补原文证据。"],
        vitality: ["可观测宇宙级生命结构｜仙帝体魄｜宇宙论依赖｜争议", "可观测宇宙级生命结构｜荒天帝终盘｜争议", "生命结构极高但暂不写无限生命。"],
        healing: ["极速自愈｜仙帝法体｜争议", "瞬愈｜终盘重构/复苏｜争议", "恢复按高端法体和终盘重构语境记录。"],
        energy: ["可观测宇宙级能量｜仙帝法力｜宇宙论依赖｜争议", "可观测宇宙级能量｜荒天帝终盘｜争议", "能量总量按终盘高端记录，不写无限能量池。"],
        energyRegen: ["极速回能｜仙帝法力循环｜争议", "极速回能｜终盘法则循环｜非无限尺度｜争议", "补能极强但仍按有限高端处理。"]
      }),
      notes: notes({
        penetration: "他化自在法、终盘仙帝层级和高端法则压制是核心；当前不做无限层级比较。攻击速度：近身攻伐、宝术投射与法则压制是不同命中过程；他化自在等高端机制不能因视觉规模被视为无传播延迟。",
        ...
        basis: "worldbook只用于抽取石昊/荒天帝姓名；定级依据正版作品入口和公开作品资料入口，终盘高端暂收束为可观测宇宙级争议档。"
      })
    })
  ]);
})();
