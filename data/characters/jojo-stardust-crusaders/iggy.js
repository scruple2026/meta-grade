(function () {
  ...
  registerCharacters([
    work.character({
      ...
      fandomSlug: "Iggy",
      dimensions: dims({
        attack: ["砖块级", "墙体级｜愚者", "砂替身可形成尖刺、拳击和防御结构。"],
        defense: ["凡人级", "墙体级｜砂防御", "本体为犬类，替身砂结构可抵挡部分攻击。"],
        movement: ["凡人速", "亚音速｜替身滑翔", "短距机动灵活。"],
        reaction: ["凡人速", "亚音速", "替身战反应优秀。"],
        vitality: ["强化凡体", "强化凡体", "体型小但意志强，本体仍脆弱。"],
        healing: ["无自愈", "无自愈", "无自体再生。"],
        energy: ["凡人能量", "墙体级能量｜砂替身", "替身输出有限。"],
        energyRegen: ["中速回能", "中速回能", "依赖精神力。"]
      }),
      notes: notes({
        penetration: "愚者可把砂构造成拳、尖刺、罩体和滑翔结构，适合出其不意、限制视线和局部刺击；砂替身杀伤依赖形状和地形，不是高爆发破坏。攻击速度：伊奇先让愚者塑造砂拳或尖刺，再由砂构型伸展、突刺或撞击目标；成形和命中分开，不能按伊奇本体肢体速度处理。",
        resistance: "砂构造可形成临时盾和替身外壳，本体体型小、机动灵活；本体仍是犬类，受到重击、冰冻、切割或替身反馈时承伤有限。",
        sensing: "犬类嗅觉、替身感知和砂之愚者的地形反馈让他适合侦查与伏击；离开砂源时感知优势收缩。",
        tactics: "善于用砂伪装、滑翔和盾形变化制造突袭或撤退路线；本体脆弱且常受保护队友动机影响。",
