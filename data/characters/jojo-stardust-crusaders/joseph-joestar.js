(function () {
  ...
  registerCharacters([
    work.character({
      ...
      dimensions: dims({
        attack: ["砖块级", "墙体级｜波纹/隐者之紫", "老年乔瑟夫以波纹、替身和策略为主。"],
        defense: ["凡人级", "墙体级｜波纹与规避", "本体年老，防御有限。"],
        ...
        energy: ["凡人能量", "墙体级能量｜波纹", "波纹与替身资源有限。"],
        energyRegen: ["中速回能", "中速回能", "依赖体力。"]
      }),
      notes: notes({
        penetration: "隐者之紫本身攻击力有限，主要靠缠绕、导电、侦查和波纹辅助制造弱点命中；乔瑟夫的真正杀伤来自情报、陷阱和对吸血鬼体系的波纹克制。攻击速度：隐者之紫先从乔瑟夫身边伸展，再缠绕、抽打或导电；情报判断与陷阱布置属于前置准备，波纹效果须经藤蔓或接触传递。",
        resistance: "老年本体防御有限，波纹训练和经验提高承伤与临场应对；对枪伤、强替身近战和时间停止没有硬抗能力，主要靠预判、骗术和队友。",
        sensing: "隐者之紫可做情报搜查和远程影像线索，波纹/经验辅助读取敌意；本体近战感知受年龄限制。",
        tactics: "心理战、欺骗和环境利用极强，常用假动作、道具和语言诱导反杀；若敌人不吃诱导或快速近身，需依赖队友。",
