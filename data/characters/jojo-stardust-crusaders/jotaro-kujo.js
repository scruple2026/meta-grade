(function () {
  ...
  registerCharacters([
    work.character({
      ...
      timelinePanels: [
        {
          ...
          status: "精密高速近战成型",
          dimensions: dims({
            attack: ["墙体级", "房屋级｜白金之星", "白金之星连打已有高单体破坏。"],
            defense: ["凡人级", "墙体级｜替身格挡", "本体是人类，主要由替身格挡保护。"],
        ...
        },
        {
          ...
          status: "白金之星与短时时停",
          dimensions: dims({
            attack: ["墙体级", "房屋级｜白金之星", "白金之星近战连打具备高单体破坏，但范围有限。"],
            defense: ["凡人级", "墙体级｜替身格挡", "本体是人类，防御主要来自替身格挡和时间停止。"],
      ...
      notes: notes({
        penetration: "白金之星连打、精密抓取和极高近距力量能打碎硬物、贯穿人体要害并在时间停止内完成必中近战；时间停止改变行动窗口，不扩大白金之星的物理破坏范围。攻击速度：白金之星的连打、抓取和格挡都在近距离随替身动作完成；时间停止只让承太郎获得无干扰行动窗口，不会把拳速变成瞬时。",
