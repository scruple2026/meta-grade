(function () {
  ...
  registerCharacters([
    work.character({
      ...
      dimensions: dims({
        attack: ["墙体级", "房屋级｜世界", "替身近战和吸血鬼肉体单体杀伤强，范围破坏有限。"],
        defense: ["墙体级", "房屋级｜吸血鬼身体", "肉体再生和替身格挡强，但阳光、波纹和头部破坏仍关键。"],
        movement: ["亚音速", "亚音速｜时间停止内位移", "时间停止期间移动属于时间权能，不按连续速度抬级。"],
        reaction: ["亚音速", "超音速｜世界｜争议", "世界近战反应极强，时间停止另写特殊。"],
        vitality: ["精锐韧体｜吸血鬼｜特殊生命结构", "楼宇级生命阈值｜吸血鬼再生", "吸血鬼与乔纳森身体结合，生命结构特殊。"],
        healing: ["快速自愈", "极速自愈｜吸血鬼", "吸血鬼再生可修复重伤，受头部和阳光限制。"],
        energy: ["墙体级能量", "房屋级能量｜替身/吸血鬼", "无大范围能量池表现。"],
        energyRegen: ["快速回能", "快速回能｜吸血", "可通过吸血补充生命力。"]
      }),
      notes: notes({
        penetration: "世界的近距连打、投掷物、吸血鬼肉体力量和时间停止内行动可绕开反应差距直接打击要害；时停提升命中窗口，不把近战范围扩大成大规模破坏。攻击速度：世界的近距连打随替身贴身出手，DIO投出的物体离手后独立飞行；时间停止只增加可行动窗口，不改变两者各自速度。",
