(function () {
  ...
  registerCharacters([
    work.character({
      ...
      dimensions: dims({
        attack: ["墙体级", "房屋级｜银色战车", "银色战车高速剑击以单体穿刺和切割为主。"],
        defense: ["凡人级", "墙体级｜替身格挡", "本体脆弱，替身可格挡。"],
        ...
        energyRegen: ["中速回能", "中速回能", "依赖体力与精神。"]
      }),
      notes: notes({
        penetration: "银色战车以高速剑刺、连斩、精密切割和脱甲后的速度爆发取胜，适合刺穿要害、截断小型投射物和近距压制；杀伤集中在剑尖与剑身，不是大范围输出。攻击速度：银色战车在替身射程内以剑刺和连斩近身命中，脱甲会改变替身动作节奏；这些是替身动作，不等同波鲁那雷夫本体手臂或步法。",
