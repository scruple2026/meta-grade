(function () {
  ...
  registerCharacters([
    work.character({
      ...
      dimensions: dims({
        attack: ["楼宇级", "街区级｜冰凝咒法/大范围冻结｜争议", "冰凝咒法可大范围冻结与控场，但不把宿傩下属身份直接抬档。"],
        defense: ["墙体级", "楼宇级｜咒力防护/反转术式", "咒力强化和恢复提高容错，硬防不按特级咒灵处理。"],
        ...
        energy: ["楼宇级能量", "街区级能量｜冰凝咒法", "咒力资源足以支撑大范围冰系术式和长时间对抗。"],
        energyRegen: ["快速回能", "快速回能｜咒力运用", "古代术师咒力运用稳定，但不是无限回能。"]
      }),
      notes: notes({
        penetration: "冰凝咒法偏冻结、束缚、区域控场和低温伤害，单点穿透不等同纯破坏规模。攻击速度：里梅发动冰凝咒法后，寒气与冰层在目标区域扩张并冻结对象；术式起手、冻结范围和低温持续不能视为同一速度。",
