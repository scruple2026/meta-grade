(function () {
  ...
  registerCharacters([
    work.character({
      ...
      fandomSlug: "Panda",
      dimensions: dims({
        attack: ["墙体级", "楼宇级｜核心转换", "以咒骸肉搏和核心转换提升输出。"],
        defense: ["墙体级", "楼宇级｜咒骸结构", "咒骸结构比普通人耐打，但核心被毁会重创。"],
        ...
        energy: ["墙体级能量", "楼宇级能量", "咒骸核心提供战斗能量。"],
        energyRegen: ["中速回能", "中速回能", "无异常回能表现。"]
      }),
      notes: notes({
        penetration: "以钝击、撕扯和形态力量为主，无特殊穿透。攻击速度：胖达的钝击和撕扯随各形态的肢体动作与接战距离完成，核心转换会改变动作取向；没有脱离身体独立飞行的攻击载体。",
        resistance: "咒骸结构可承受部分肢体损伤，但核心受损是致命短板。",
        sensing: "自律咒骸具备稳定战斗视听和咒力环境判断，核心转换可改变战斗取向；缺少远距侦查或预知。",
        tactics: "擅长用形态切换和咒骸身体迷惑对手，能承担前排牵制；核心受损后可选策略大幅减少。",
