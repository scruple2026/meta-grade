(function () {
  ...
  registerCharacters([
    work.character({
      ...
      timelinePanels: [
        {
          ...
          status: "低咒力、依赖咒具与体术",
          dimensions: dims({
            attack: ["墙级", "墙级｜咒具", "早期主要靠咒具体术造成单体杀伤。"],
            defense: ["凡人级", "墙级｜体术", "承伤高于常人但未完成天与咒缚。"],
        ...
        },
        {
          ...
          status: "零咒力、超常感官、释魂刀",
          dimensions: dims({
            attack: ["墙级", "楼级｜释魂刀｜觉醒", "觉醒后肉体与咒具杀伤大幅提升；释魂刀按攻击性质处理。"],
            defense: ["墙级", "楼级｜觉醒", "觉醒后肉体承伤和抗打击显著上升。"],
            ...
            energy: ["凡人能量", "墙级能量｜觉醒体能", "完全觉醒后近乎无咒力，但能量总量仍按体力、肌耐力和连续作战持久度保守记录。"],
            energyRegen: ["常规回能", "常规回能", "无咒力回复体系；体力恢复依赖休息和外部治疗。"]
          }),
          notes: "当前主面板版本。"
        }
      ],
      ...
      notes: notes({
        penetration: "释魂刀可无视常规肉体硬度打击灵魂轮廓，属于高穿透咒具，不抬破坏规模。",
