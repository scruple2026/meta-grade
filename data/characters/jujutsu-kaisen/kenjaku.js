(function () {
  ...
  registerCharacters([
    work.character({
      ...
      dimensions: dims({
        attack: ["楼级", "街区级｜咒灵操术/领域/反重力", "咒灵操术、领域和反重力形成复合峰值。"],
        defense: ["墙级", "楼级｜反转术式/反重力", "本体防御依赖术式、咒力和反转术式，不等同咒灵库存总量。"],
        ...
        energy: ["楼级能量", "街区级能量｜咒灵操术/结界术", "咒力量、库存咒灵和结界资源丰富。"],
        energyRegen: ["快速回能", "快速回能｜咒力恢复", "续航强但库存咒灵和领域会消耗。"]
      }),
      notes: notes({
        penetration: "咒灵操术、极之番、反重力系统和领域可从多角度制造破防；夺舍和结界规则不按纯破坏档处理。",
