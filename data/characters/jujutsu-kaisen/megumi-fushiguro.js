    ...
    work.character({
      ...
      timelinePanels: [
        ...
        },
        {
          ...
          status: "未完成领域与式神联动",
          dimensions: dims({
            attack: ["墙体级", "楼宇级｜领域｜式神", "本人输出依赖式神组合和未完成领域；魔虚罗只写入召唤权能，不算稳定面板。"],
            defense: ["凡人级", "墙体级｜式神分担", "本体防御不高，能通过影子、式神和战术规避伤害。"],
            ...
            energy: ["墙体级能量", "楼宇级能量｜领域", "领域和高阶式神消耗大。"],
