(function () {
  ...
  registerCharacters([
    work.character({
      ...
      dimensions: dims({
        attack: ["楼宇级", "街区级｜伏魔御厨子｜世界斩｜火焰", "开放领域和斩击范围极强，但按实际破坏规模保守列街区级峰值。"],
        defense: ["楼宇级", "街区级｜反转术式｜领域", "顶层咒力防护与反转术式，承伤强但不折算国级。"],
        ...
        energy: ["楼宇级能量", "街区级能量", "咒力量和咒力操作处作品顶层。"],
        energyRegen: ["快速回能", "极速回能", "长线战斗续航极强。"]
      }),
      notes: notes({
        penetration: "世界斩、解/捌和领域斩击具备极强切割穿透；这是空间/规则式杀伤，不抬破坏主等级。攻击速度：宿傩的本体近战随其接战动作出手，普通远程解/捌则有独立的发动与命中过程；世界斩的手势、咏唱和方向指定属于发动负担，不能与斩击传播混成一个速度；伏魔御厨子的必中与范围内生效不等于无限传播速度，火焰的发射和载体速度还须另行判断。",
