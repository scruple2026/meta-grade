(function () {
  ...
  registerCharacters([
    work.character({
      ...
      dimensions: dims({
        attack: ["墙级", "楼级｜共鸣｜黑闪", "共鸣可通过媒介打击本体或灵魂，破坏规模仍保守处理。"],
        defense: ["凡人级", "墙级｜咒力防护", "承伤能力低于高阶近战角色。"],
        ...
        energy: ["墙级能量", "楼级能量", "咒力量足以支持钉、锤、共鸣和簪。"],
        energyRegen: ["常规回能", "常规回能", "无高强度回能表现。"]
      }),
      notes: notes({
        penetration: "共鸣是条件型高穿透攻击，尤其适合通过身体组织或连接物打击本体。",
        resistance: "对普通物理和低阶咒术有基础防护；对灵魂改造不具备明确抗性。",
        special: "芻灵咒法、共鸣、簪、黑闪。",
