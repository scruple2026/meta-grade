(function () {
  ...
  registerCharacters([
    work.character({
      ...
      sourceQuality: "entry",
      dimensions: dims({
        attack: ["凡人级", "砖块级｜体力", "本人常避免主动伤人，体力输出高于普通人。"],
        defense: ["砖块级", "墙体级｜耐打/体力", "耐打和持久力突出。"],
        movement: ["凡人速", "凡人速", "移动速度仍属普通人范围。"],
        reaction: ["凡人速", "凡人速", "普通人反应。"],
        vitality: ["强化凡体", "精锐韧体", "耐力和承伤极高但仍是人类。"],
        healing: ["无自愈", "缓慢自愈｜体魄", "自然恢复。"],
        energy: ["砖块级能量｜体力", "墙体级能量｜长时间劳动", "体力和持续劳动能力极强。"],
        energyRegen: ["中速回能", "中速回能｜体力", "按高体能恢复处理。"]
      }),
      notes: notes({
        penetration: "直接伤害不突出，主要靠体力、搬运、阻挡和耐久。攻击速度：大树主要搬运、阻挡而非主动攻击，即使拳脚也只是强壮凡人的近战动作，没有远程高速载体表现。",
