(function () {
  ...
  registerCharacters([work.character({
    ...
    dimensions: dims({
      attack: ["砖级", "墙级｜直死魔眼/刀具｜特殊", "物理破坏不高；直死魔眼是死亡线切断和弱点杀伤，不等同范围破坏。"],
      defense: ["凡人级", "砖级｜战斗训练/规避", "本体仍是人类，防御主要来自规避、刀具和近战判断。"],
      ...
      energy: ["凡人能量", "砖级能量｜集中战斗体力", "主要是人体体力与精神负荷，不把直死魔眼写成能量池。"],
      energyRegen: ["缓慢回能", "缓慢回能｜休整", "体力和精神负荷需要休整。"]
    }),
    notes: notes({
      penetration: "直死魔眼可切断死亡线/点，属于高穿透规则杀伤；不能直接换算为同范围破坏规模。",
