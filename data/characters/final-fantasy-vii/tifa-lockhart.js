(function () {
  ...
  registerCharacters([work.character({
    ...
    dimensions: dims({
        attack: ["砖块级｜格斗/拳套", "楼宇级｜Limit Break/Materia/战斗系统｜争议", "常态按武术和拳套近战记录；峰值包含战斗系统资源但不等同召唤兽或剧情演出。"],
        defense: ["凡人级", "砖块级｜防具/战斗系统", "本体为强化训练人类，承伤峰值主要来自装备、防具和战斗系统。"],
        ...
        energy: ["砖块级能量", "楼宇级能量｜Materia/Limit资源", "资源池来自体力、Materia与Limit；不等同单次攻击全部释放。"],
