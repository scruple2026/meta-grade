(function () {
  ...
  registerCharacters([work.character({
    ...
    dimensions: dims({
        attack: ["凡人级", "墙级｜枪械/爆炸物/机关｜装备/准备", "本体攻击为人类尺度；峰值来自枪械、炸药、机关和准备。"],
        defense: ["凡人级", "砖级｜防具/规避/逃脱", "生还依赖规避、诡计和装备，不是高硬度肉身。"],
        ...
        energy: ["凡人能量", "墙级能量｜装备/弹药/机关资源", "资源来自工具、枪械、爆炸物、载具和准备。"],
        energyRegen: ["无回能", "缓慢回能｜补给/准备", "依赖补给、换装和事前准备。"]
      }),
    notes: notes({
        penetration: "枪械、爆炸物、机关、变装和潜入工具能越过普通防护，常靠条件制胜而非硬破坏。",
