(function () {
  ...
  registerCharacters([work.character({
    ...
    dimensions: dims({
        attack: ["凡人级", "砖块级｜枪械/爆炸物/机关｜装备", "常态为训练人类；峰值来自枪械、炸药和盗窃装备。"],
        ...
        energy: ["凡人能量", "砖块级能量｜枪械/工具/载具", "资源来自工具、枪械、载具和情报准备。"],
        energyRegen: ["无回能", "缓慢回能｜补给/准备", "依赖补给和事前准备。"]
      }),
    notes: notes({
        penetration: "枪械、炸药、陷阱和情报欺骗可提高杀伤或越防效果。攻击速度：峰不二子的枪击只按举枪、瞄准、扣发和弹丸飞行计算；炸药看布置与引信，陷阱看触发，情报欺骗不属于攻击载体。",
