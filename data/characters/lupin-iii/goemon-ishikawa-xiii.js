(function () {
  ...
  registerCharacters([work.character({
    ...
    dimensions: dims({
        attack: ["砖块级｜剑术", "墙体级｜斩铁剑/高穿透｜武器", "斩铁剑提供高穿透切割，但不把切割性质直接换算为大范围破坏。"],
        defense: ["凡人级", "砖块级｜剑挡/规避", "防御主要来自剑术格挡、预判和规避，本体仍为人类。"],
        ...
        energy: ["凡人能量", "砖块级能量｜斩铁剑/体力", "资源来自体力和斩铁剑，不是超自然能量池。"],
        energyRegen: ["无回能", "缓慢回能｜休息/整备", "依赖休息和武器整备。"]
      }),
    notes: notes({
        penetration: "斩铁剑可提供远超普通刀剑的切割和破障能力；这是武器穿透，不代表本体范围破坏。攻击速度：斩铁剑随手臂、步法和接战距离完成，收招再攻与单次命中不能用移动速度替代。",
