(function () {
  ...
  registerWorkSource(WORK, {
    ...
    scaleEvidenceLinks: [],
    scaleNotes: {
      scope: "当前收录金庸共通/蛊 worldbook key/comment 中明确出现、且符合主角团口径的神雕核心：杨过、小龙女；暂不加入支线高手、前代传说人物和阶段性反派。",
      versionPolicy: "按《神雕侠侣》原作主线综合期记录；早年古墓期、断臂后、黯然销魂掌、左右互搏、玉女心经和冰魄银针等应在峰值标签或后续时间线中区分。",
      highRisk: ["黯然销魂掌", "玄铁重剑", "玄铁剑法", "独孤九剑", "无剑胜有剑", "传说侧面证据", "玉女心经", "左右互搏", "冰魄银针", "九阴真经", "峨嵋开派", "古墓派始创人"],
      conservativeNotes: "神雕高端武者仍按金庸人体/内力尺度保守处理；绝学、兵器、毒针和独孤求败传说记录为峰值或特殊项，不直接换算为大范围破坏。"
    },
