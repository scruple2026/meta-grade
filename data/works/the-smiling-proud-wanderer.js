(function () {
  ...
  registerWorkSource(WORK, {
    ...
    scaleNotes: {
      scope: "当前收录金盆洗手 worldbook 索引字段及金庸共通 worldbook key/comment 中明确出现的主要角色：刘正风、曲洋、曲非烟、令狐冲、仪琳、田伯光、费彬、丁勉、陆柏、莫大先生、岳不群、任盈盈、东方不败、任我行、左冷禅、林平之、宁中则、风清扬、天门道人、定闲师太、定静师太、定逸师太、林震南、王元霸。",
      versionPolicy: "早期金盆洗手角色按金盆洗手前后记录；后续补入角色按《笑傲江湖》主线综合期或明确峰值记录。独孤九剑、吸星大法、易筋经、辟邪剑谱、葵花宝典和寒冰真气必须用时间线、峰值标签或说明区分。",
      highRisk: ["五岳剑派武功", "嵩山十三太保", "衡山剑法", "恒山剑法", "泰山剑法", "金刀门武功", "福威镖局武功", "快刀", "点穴", "内力", "独孤九剑", "吸星大法", "辟邪剑谱", "葵花宝典", "寒冰真气"],
