(function () {
  ...
  registerWorkSource(WORK, {
    ...
    scaleNotes: {
      scope: "当前收录蚀之刻相关主角与最终反派团核心：格斯、卡思嘉、格里菲斯/费蒙特，以及神之手 Void、Slan、Ubik、Conrad；鹰之团支线成员、髑髅骑士和佐德不再按 worldbook 名字池自动扩入。",
      versionPolicy: "黄金时代人类状态、使徒/神之手、狂战士铠甲和幽界相关能力必须分开标注。",
      highRisk: ["神之手", "因果律", "贝黑莱特", "烙印", "空间扭曲", "幽界显化", "意识诱导", "瘟疫/地形转化", "狂战士铠甲", "使徒化"],
