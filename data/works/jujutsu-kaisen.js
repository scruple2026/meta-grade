(function () {
  ...
  registerWorkSource(WORK, {
    ...
    scaleNotes: {
          "scope": "当前收录主角团、五条/乙骨/真希等高专核心、夏油杰、羂索、天元、胀相、七海建人、与幸吉/究极机械丸、禅院真依、禅院直哉、雷吉·史达、乌鹭亨子、石流龙、黑沐死、多鲁布·拉克达瓦拉、万、星绮罗罗、加茂宪纪、三轮霞、日下部笃也、猪野琢真、庵歌姬、夜蛾正道、米格尔、九十九由基、秤金次、鹿紫云一、日车宽见、高羽史彦、来栖华/天使、冥冥、家入硝子、里梅、真人、漏瑚、花御、陀艮、东堂葵、伏黑甚尔和最终 Boss 两面宿傩；召唤/外置战力写入所属角色的战力解释项。",
