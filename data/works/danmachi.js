(function () {
  ...
  registerWorkSource(WORK, {
    ...
    scaleNotes: {
      scope: "当前收录异端儿篇 worldbook 索引字段中的主要角色与主要敌对实体：贝尔、赫斯缇雅、艾丝、埃伊娜、莉莉、韦尔夫、大和命、春姬、琉、希儿、米娅、薇妮、利德、蕾伊、古罗斯、阿斯泰里俄斯、地下城普通怪物/魔石/掉落物，以及楼层主/Monster Rex/Juggernaut。",
      versionPolicy: "按异端儿篇/第9-11卷附近记录。Falna 等级、魔法、魔剑、等级提升、神格、魅惑和异端儿生命结构分开处理；神明在下界禁用神力，不把神格写入常态攻防。",
      highRisk: ["Falna 等级", "魔剑", "等级提升", "神格禁用", "美神魅惑", "异端儿生命结构", "阿斯泰里俄斯决斗", "Monster Rex", "Juggernaut魔法反射"],
