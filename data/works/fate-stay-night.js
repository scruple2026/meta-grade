(function () {
  ...
  registerWorkSource(WORK, {
    ...
    scaleNotes: {
      scope: "当前收录命运之夜 worldbook 索引字段中的 Fate/stay night 本篇核心角色：卫宫士郎、阿尔托莉雅、远坂凛、间桐樱、伊莉雅、言峰绮礼、间桐慎二、间桐脏砚、葛木宗一郎，以及 Archer、Lancer、Rider、Caster、Assassin、Berserker 和吉尔伽美什。",
      versionPolicy: "按第五次圣杯战争记录；Fate/Zero、FGO、二世事件簿等时间线不并入本作品面板。黑化、圣杯泥、HF影、投影过载、令咒和宝具真名解放均作为条件峰值或特殊项处理。",
      highRisk: ["宝具", "固有结界", "王之财宝", "Ea", "Excalibur", "令咒", "圣杯泥", "影", "十二试炼", "破万符"],
