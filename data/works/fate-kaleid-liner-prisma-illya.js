(function () {
  ...
  registerWorkSource(WORK, {
    ...
    scaleNotes: {
      scope: "当前收录伊莉雅、美游、克洛伊、巴泽特、安洁莉卡、贝阿朵莉丝和达利乌斯；凛、露维亚、美游世界士郎、朱利安、田中、吉尔等长尾或篇章重点角色后续按需求补。",
      ...
      conservativeNotes: "Nasuverse英灵设定、宝具等级、圣杯许愿、世界救济、空间置换、因果反击和无限供魔不直接换算主面板。当前初稿把大多数稳定战斗限制在墙级至楼级，把宝具/结界/短时峰值保守放在街区级并标注争议或条件。"
    },
