(function () {
  ...
  registerWorkSource(WORK, {
    ...
    scaleNotes: {
      scope: "当前收录伊莉雅、美游、克洛伊、巴泽特、远坂凛、露维亚、安洁莉卡、贝阿朵莉丝、达利乌斯和朱利安；职阶卡影像、魔杖、同学、普通支援者和变体形态不再按 worldbook 名字池扩入。",
      ...
      conservativeNotes: "Nasuverse英灵设定、宝具等级、圣杯许愿、世界救济、空间置换、因果反击、万花筒魔杖供魔和Class Card敌人不直接换算主面板。当前初稿把大多数稳定战斗限制在墙体级至楼宇级，把宝具/结界/短时峰值保守放在街区级并标注争议或条件。"
    },
