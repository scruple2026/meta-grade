(function () {
  ...
  registerWorkSource(WORK, {
    ...
    scaleEvidenceLinks: [],
    scaleNotes: {
      scope: "当前先收录命运之夜酒馆助手与型月 DLC worldbook key/comment 中明确出现的 FGO 核心角色首批：藤丸立香、玛修、梅林、斯卡哈、阿尔托莉雅Caster、摩根；其他英灵和型月作品角色后续分批补入。",
      versionPolicy: "按 Fate/Grand Order 游戏/主线语境记录；FSN、FZ、魔伊、月姬、空境、魔法使之夜等作品不并入本作品面板。灵基、宝具、圣杯、Lostbelt 和临时支援均作为时间线、条件峰值或特殊权能处理。",
      highRisk: ["灵基", "宝具", "圣杯", "Lostbelt", "妖精国", "冠位候补", "召唤契约", "令咒", "防御宝具"],
