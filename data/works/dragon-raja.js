(function () {
  ...
  registerWorkSource(WORK, {
    ...
    scaleEvidenceLinks: [],
    scaleNotes: {
      scope: "当前收录龙族 worldbook 索引字段中的原作核心人物与高战力条目：路明非、路鸣泽、楚子航、恺撒、陈墨瞳、上杉绘梨衣、昂热、赫尔佐格、夏弥、诺顿、康斯坦丁、芬里厄、奥丁、尼德霍格、白王、源稚生、源稚女、上杉越、零、芬格尔、酒德麻衣、犬山贺、矢吹樱、楚天骄。跳过 OC、性转版本、修仙 DLC、地点、势力和规则条目。",
