(function () {
  ...
  registerWorkSource(WORK, {
    ...
    scaleEvidenceLinks: [],
    scaleNotes: {
      scope: "当前收录龙族 worldbook key/comment 中的主角团与终局/龙王侧核心：路明非、路鸣泽、楚子航、恺撒、陈墨瞳、零/雷娜塔、上杉绘梨衣、赫尔佐格、夏弥、诺顿、康斯坦丁、芬里厄、奥丁、尼德霍格、白王、利维坦和贝希摩斯/黑蛇；跳过支援人员、普通学院/蛇岐八家成员、OC、性转版本、修仙 DLC、地点、势力和规则条目。",
