(function () {
  ...
  registerWorkSource(WORK, {
    ...
    scaleNotes: {
      scope: "当前收录少室山大会及金庸共通 worldbook key/comment 中符合主角团口径的核心人物：萧峰、段誉、虚竹、王语嫣和阿紫；少室山阶段性反派、亲属、前辈和支线高手不再扩入。",
      ...
      conservativeNotes: "金庸武侠以人体、兵刃、内力和局部环境破坏为主；缺少明确大范围破坏时，高端人物也保守停留在墙体级到房屋级附近，极少数气墙/内力峰值才写更高条件峰值。"
    },
