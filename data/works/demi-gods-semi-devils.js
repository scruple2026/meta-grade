(function () {
  ...
  registerWorkSource(WORK, {
    ...
    scaleNotes: {
      scope: "当前收录少室山大会及金庸共通 worldbook 索引字段中的主要角色：萧峰、段誉、虚竹、慕容复、游坦之、丁春秋、鸠摩智、玄慈、叶二娘、萧远山、慕容博、扫地僧、王语嫣、阿紫、天山童姥、李秋水和无崖子。",
      versionPolicy: "按少室山大会前后与逍遥派相关时间线记录。内力、轻功、毒功、六脉神剑、降龙十八掌、气墙、逍遥派武学和武学见识分开，不把江湖名望或门派地位直接折算为破坏档。",
      highRisk: ["降龙十八掌", "六脉神剑", "北冥神功", "小无相功", "天山六阳掌", "天山折梅手", "生死符", "冰蚕寒毒", "化功大法", "三尺气墙", "少林七十二绝技"],
