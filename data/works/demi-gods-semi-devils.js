(function () {
  ...
  registerWorkSource(WORK, {
    ...
    scaleNotes: {
      scope: "当前收录少室山大会 worldbook 索引字段中的主要角色：萧峰、段誉、虚竹、慕容复、游坦之、丁春秋、鸠摩智、玄慈、叶二娘、萧远山、慕容博、扫地僧、王语嫣和阿紫。",
      versionPolicy: "按少室山大会前后记录。内力、轻功、毒功、六脉神剑、降龙十八掌、气墙和武学见识分开，不把江湖名望或门派地位直接折算为破坏档。",
      highRisk: ["降龙十八掌", "六脉神剑", "北冥神功", "小无相功", "冰蚕寒毒", "化功大法", "三尺气墙", "少林七十二绝技"],
