(function () {
  ...
  registerWorkSource(WORK, {
    ...
    scaleEvidenceLinks: [],
    scaleNotes: {
      scope: "当前收录金庸共通 worldbook key/comment 中明确出现的射雕角色：黄蓉、洪七公、黄药师、梅超风、陈玄风、欧阳克、侯通海；郭靖、欧阳锋等未在本次名字字段命中，暂不越界添加。",
      versionPolicy: "按《射雕英雄传》原作主线记录；不把《神雕侠侣》后续年龄、身份和武学状态并入本作品面板。",
      highRisk: ["降龙十八掌", "打狗棒法", "弹指神通", "九阴白骨爪", "桃花岛武学", "丐帮帮主", "白驼山庄毒术", "蛇阵", "黄河帮", "三股钢叉"],
