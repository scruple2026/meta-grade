(function () {
  ...
  registerWorkSource(WORK, {
    ...
    scaleEvidenceLinks: [],
    scaleNotes: {
      scope: "当前收录金庸共通 worldbook key/comment 中明确出现的倚天角色：张无忌、周芷若、殷天正、殷素素、殷野王、张三丰、灭绝师太、何太冲、班淑娴、何足道；未在名字字段出现的角色后续按同规则补入。",
      versionPolicy: "按《倚天屠龙记》原作主线记录；少年期、光明顶、屠狮大会、太极拳剑、九阴白骨爪和倚天剑/屠龙刀峰值需按时间线或峰值标签区分。",
      highRisk: ["九阳神功", "乾坤大挪移", "太极拳剑", "九阴白骨爪", "倚天剑", "屠龙刀", "明教教主", "天鹰教", "昆仑派", "两仪剑法", "迅雷剑", "峨嵋掌门", "武当宗师"],
