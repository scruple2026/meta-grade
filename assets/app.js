(function () {
  ...
  const rankOrders = {
    attack: ["昆虫级", "凡人级", "砖块级", "墙体级", "房屋级", "楼宇级", "街区级", "城市级", "国家级", "大陆级", "地表级", "行星级", "恒星级", "星系级", "超星系团级", "可观测宇宙级", "无限级"],
    defense: ["昆虫级", "凡人级", "砖块级", "墙体级", "房屋级", "楼宇级", "街区级", "城市级", "国家级", "大陆级", "地表级", "行星级", "恒星级", "星系级", "超星系团级", "可观测宇宙级", "无限级"],
    movement: ["凡人速", "亚音速", "音速", "超音速", "高超音速", "宇宙速度级", "超第三宇宙速度级", "亚光速", "光速", "超光速", "高倍超光速", "恒星际超光速", "星系尺度超光速", "星系际超光速", "超星系团尺度超光速", "可观测宇宙尺度超光速", "无限速"],
    reaction: ["凡人速", "亚音速", "音速", "超音速", "高超音速", "宇宙速度级", "超第三宇宙速度级", "亚光速", "光速", "超光速", "高倍超光速", "恒星际超光速", "星系尺度超光速", "星系际超光速", "超星系团尺度超光速", "可观测宇宙尺度超光速", "无限速"],
    vitality: ["昆虫级生命阈值", "凡人肉身", "强化凡体", "精锐韧体", "房屋级生命阈值", "楼宇级生命阈值", "街区级生命阈值", "城市级生命阈值", "国家级生命阈值", "大陆级生命阈值", "地表级生命阈值", "行星级生命结构", "恒星级生命结构", "星系级生命结构", "超星系团级生命结构", "可观测宇宙级生命结构", "无限级生命结构"],
    healing: ["无自愈", "缓慢自愈", "中速自愈", "快速自愈", "极速自愈", "瞬愈"],
    energy: ["昆虫级能量", "凡人能量", "砖块级能量", "墙体级能量", "房屋级能量", "楼宇级能量", "街区级能量", "城市级能量", "国家级能量", "大陆级能量", "地表级能量", "行星级能量", "恒星级能量", "星系级能量", "超星系团级能量", "可观测宇宙级能量", "无限级能量"],
